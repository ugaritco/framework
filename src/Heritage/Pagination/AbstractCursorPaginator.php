 ...
 *
 * @mixin \Heritage\Support\Collection<TKey, TValue>
 */
abstract class AbstractCursorPaginator implements Htmlable, Stringable
{
     ...
     *
     * @var \Heritage\Support\Collection<TKey, TValue>
     */
    protected $items;
     ...
     * The current cursor.
     *
     * @var \Heritage\Pagination\Cursor|null
     */
    protected $cursor;
     ...
     * @param  bool  $isNext
     * @return \Heritage\Pagination\Cursor
     */
     ...
     * @param  \Heritage\Pagination\Cursor|null  $default
     * @return \Heritage\Pagination\Cursor|null
     */
     ...
     *
     * @return \Heritage\Contracts\View\Factory
     */
     ...
     * @template TSetValue
     *
     * @param  \Heritage\Support\Collection<TSetKey, TSetValue>  $collection
     * @return $this
     *
