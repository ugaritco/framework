...
class ParallelTesting
{
     ...
     *
     * @param  \Heritage\Foundation\Testing\TestCase  $testCase
     * @return void
     */
    ...
    public function option($option)
    {
        $optionsResolver = $this->optionsResolver ?: function ($option) {
            $option = 'UGARIT_PARALLEL_TESTING_'.Str::upper($option);
    ...
    {
        return ! empty($_SERVER['UGARIT_PARALLEL_TESTING']) && $this->token();
    }
}
