...
use Ugarit\Prompts\Note as PromptsNote;
use Ugarit\Prompts\Prompt as BasePrompt;
use Ugarit\Prompts\Table as PromptsTable;
use Mockery;
...
class PendingCommand
{
     ...
     * The test being run.
     *
     * @var \Heritage\Foundation\Testing\TestCase
     */
    public $test;
