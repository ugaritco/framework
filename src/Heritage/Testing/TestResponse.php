...
use ArrayAccess;
use Closure;
use Heritage\Contracts\Support\MessageBag;
...
use Heritage\Testing\Constraints\SeeInHtml;
use Heritage\Testing\Constraints\SeeInOrder;
use Heritage\Testing\Fluent\AssertableJson;
use Heritage\Testing\TestResponseAssert as PHPUnit;
use LogicException;
...
class TestResponse implements ArrayAccess
{
     ...
     *
     * @var \Heritage\Http\Request|null
     */
    public $baseRequest;
     ...
     *
     * @var \Heritage\Testing\AssertableJsonString|null
     */
     ...
     *
     * @return \Heritage\Testing\AssertableJsonString
     *
     * @throws \Throwable
     */
     ...
     *
     * @param  \Heritage\Support\Collection  $exceptions
     * @return $this
     */
