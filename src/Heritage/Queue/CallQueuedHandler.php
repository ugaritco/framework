...
use Heritage\Queue\Events\JobDebounced;
...
class CallQueuedHandler
{
     ...
     *
     * @param  \Heritage\Contracts\Bus\Dispatcher  $dispatcher
    ...
    protected function ensureUniqueJobLockIsReleasedViaContext()
    {
        ...
        [$store, $key, $owner] = [
            $context->getHidden('ugarit_unique_job_cache_store'),
            $context->getHidden('ugarit_unique_job_key'),
            $context->getHidden('ugarit_unique_job_lock_owner'),
        ];
