...
use Heritage\Queue\Jobs\DatabaseJob;
use Heritage\Queue\Jobs\DatabaseJobRecord;
...
class DatabaseQueue extends Queue implements QueueContract, ClearableQueue
{
     ...
     *
     * @param  \Heritage\Database\Connection  $database
     * @param  string  $table
     ...
     *
     * @param  string|null  $queue
     * @return \Heritage\Queue\Jobs\DatabaseJobRecord|null
     */
     ...
     * @param  string  $queue
     * @param  \Heritage\Queue\Jobs\DatabaseJobRecord  $job
     * @return \Heritage\Queue\Jobs\DatabaseJob
     */
     ...
     *
     * @param  string  $queue
     * @param  \Heritage\Queue\Jobs\DatabaseJob  $job
     * @param  int  $delay
     * @return void
     */
