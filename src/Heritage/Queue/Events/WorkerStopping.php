...
class WorkerStopping
{
     ...
     * @param  \Heritage\Queue\WorkerOptions|null  $workerOptions  The worker options.
     * @param  \Heritage\Queue\WorkerStopReason|null  $reason  The reason why the worker is stopping.
