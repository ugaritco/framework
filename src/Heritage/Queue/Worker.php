...
use Heritage\Contracts\Cache\Repository as CacheContract;
use Heritage\Contracts\Debug\ExceptionHandler;
use Heritage\Contracts\Events\Dispatcher;
use Heritage\Contracts\Queue\Factory as QueueManager;
use Heritage\Contracts\Queue\Interruptible;
use Heritage\Database\DetectsLostConnections;
use Heritage\Queue\Events\JobAttempted;
use Heritage\Queue\Events\JobExceptionOccurred;
use Heritage\Queue\Events\JobInterrupted;
use Heritage\Queue\Events\JobPopped;
use Heritage\Queue\Events\JobPopping;
use Heritage\Queue\Events\JobProcessed;
use Heritage\Queue\Events\JobProcessing;
use Heritage\Queue\Events\JobReleased;
use Heritage\Queue\Events\JobReleasedAfterException;
use Heritage\Queue\Events\JobTimedOut;
use Heritage\Queue\Events\Looping;
use Heritage\Queue\Events\WorkerIdle;
use Heritage\Queue\Events\WorkerInterrupted;
use Heritage\Queue\Events\WorkerPausing;
use Heritage\Queue\Events\WorkerQueuePaused;
use Heritage\Queue\Events\WorkerQueueResumed;
use Heritage\Queue\Events\WorkerResuming;
use Heritage\Queue\Events\WorkerStarting;
...
class Worker
{
     ...
     *
     * @var \Heritage\Contracts\Debug\ExceptionHandler
     */
     ...
     * @param  \Heritage\Contracts\Debug\ExceptionHandler  $exceptions
     ...
     * @param  string  $queue
     * @param  \Heritage\Queue\WorkerOptions  $options
     * @return int
     */
     ...
     * @param  \Heritage\Contracts\Queue\Job|null  $job
     * @param  \Heritage\Queue\WorkerOptions  $options
     * @return void
     */
     ...
     *
     * @param  \Heritage\Contracts\Queue\Queue  $connection
     * @param  string  $queue
    ...
    protected function getTimestampOfLastQueueRestart()
    {
        ...
        if ($this->cache) {
            return $this->cache->get('heritage:queue:restart');
        }
    }
     ...
     * @param  string|null  $connectionName
     * @param  string|null  $queue
     * @param  \Heritage\Queue\WorkerOptions|null  $options
     * @return void
     */
     ...
     * @param  int  $status
     * @param  \Heritage\Queue\WorkerOptions|null  $options
     * @param  \Heritage\Queue\WorkerStopReason|null  $reason
     * @param  string|null  $connectionName
     * @param  string|null  $queue
     * @return never
     */
     ...
     *
     * @param  \Heritage\Contracts\Queue\Job  $job
     * @return \Heritage\Queue\MaxAttemptsExceededException
     */
     ...
     *
     * @param  \Heritage\Contracts\Queue\Job  $job
     * @return \Heritage\Queue\TimeoutExceededException
     */
     ...
     *
     * @return \Heritage\Contracts\Queue\Factory
     */
