...
use Heritage\Contracts\Events\Dispatcher as EventDispatcher;
use Heritage\Contracts\Support\DeferrableProvider;
use Heritage\Queue\Connectors\BackgroundConnector;
use Heritage\Queue\Connectors\BeanstalkdConnector;
use Heritage\Queue\Connectors\DatabaseConnector;
use Heritage\Queue\Connectors\DeferredConnector;
use Heritage\Queue\Connectors\FailoverConnector;
use Heritage\Queue\Connectors\NullConnector;
use Heritage\Queue\Connectors\RedisConnector;
use Heritage\Queue\Connectors\SqsConnector;
use Heritage\Queue\Connectors\SyncConnector;
use Heritage\Queue\Failed\DatabaseFailedJobProvider;
use Heritage\Queue\Failed\DatabaseUuidFailedJobProvider;
use Heritage\Queue\Failed\DynamoDbFailedJobProvider;
use Heritage\Queue\Failed\FileFailedJobProvider;
use Heritage\Queue\Failed\NullFailedJobProvider;
...
class QueueServiceProvider extends ServiceProvider implements DeferrableProvider
{
     ...
     *
     * @param  \Heritage\Queue\QueueManager  $manager
     * @return void
     */
     ...
     *
     * @param  array  $config
     * @return \Heritage\Queue\Failed\DatabaseFailedJobProvider
     */
     ...
     *
     * @param  array  $config
     * @return \Heritage\Queue\Failed\DatabaseUuidFailedJobProvider
     */
     ...
     *
     * @param  array  $config
     * @return \Heritage\Queue\Failed\DynamoDbFailedJobProvider
     */
