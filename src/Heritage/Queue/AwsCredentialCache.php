...
class AwsCredentialCache
{
     ...
     *
     * @var \Closure(): \Heritage\Contracts\Cache\Repository
     */
     ...
     *
     * @var \Closure(): \Heritage\Contracts\Cache\Repository|null
     */
    protected $fallback;
     ...
     *
     * @param  \Closure(): \Heritage\Contracts\Cache\Repository  $repository
     * @param  \Closure(): \Heritage\Contracts\Cache\Repository|null  $fallback
     */
     ...
     * @param  string  $key
     * @param  callable  $provider
     * @param  \Heritage\Contracts\Cache\Lock|null  $lock
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
     ...
     *
     * @return array<int, \Closure(): \Heritage\Contracts\Cache\Repository>
     */
