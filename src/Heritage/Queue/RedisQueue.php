...
use Heritage\Contracts\Redis\Factory as Redis;
use Heritage\Queue\Attributes\Delay;
use Heritage\Queue\Jobs\InspectedJob;
use Heritage\Queue\Jobs\RedisJob;
use Heritage\Redis\Connections\Connection;
use Heritage\Redis\Connections\PhpRedisClusterConnection;
use Heritage\Redis\Connections\PredisClusterConnection;
...
class RedisQueue extends Queue implements QueueContract, ClearableQueue
{
     ...
     *
     * @var \Heritage\Contracts\Redis\Factory
     */
    protected $redis;
     ...
     *
     * @param  \Heritage\Contracts\Redis\Factory  $redis
     ...
     *
     * @param  string  $queue
     * @param  \Heritage\Queue\Jobs\RedisJob  $job
     * @return void
     */
     ...
     *
     * @return \Heritage\Contracts\Redis\Factory
     */
