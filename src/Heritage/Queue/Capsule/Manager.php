...
class Manager
{
     ...
     *
     * @var \Heritage\Queue\QueueManager
     */
    protected $manager;
     ...
     *
     * @return \Heritage\Queue\QueueManager
     */
