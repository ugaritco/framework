...
class ListenCommand extends Command
{
     ...
     *
     * @param  \Heritage\Queue\Listener  $listener
     */
    ...
    {
        $connection = $connection ?: $this->ugarit['config']['queue.default'];

        return $this->input->getOption('queue') ?: $this->ugarit['config']->get(
     ...
     *
     * @return \Heritage\Queue\ListenerOptions
     */
