...
use Heritage\Support\Traits\EnumeratesValues;
use Heritage\Support\Traits\Macroable;
use Heritage\Support\Traits\TransformsToResourceCollection;
 ...
 * @implements \Heritage\Support\Enumerable<TKey, TValue>
 */
class Collection implements ArrayAccess, CanBeEscapedWhenCastToString, Enumerable
{
    /**
     * @use \Heritage\Support\Traits\EnumeratesValues<TKey, TValue>
     */
     ...
     *
     * @param  \Heritage\Contracts\Support\Arrayable<TKey, TValue>|iterable<TKey, TValue>|null  $items
     */
     ...
     *
     * @return \Heritage\Support\LazyCollection<TKey, TValue>
     */
     ...
     *
     * @param  \Heritage\Contracts\Support\Arrayable<TCrossJoinKey, TCrossJoinValue>|iterable<TCrossJoinKey, TCrossJoinValue>  ...$lists
     ...
     *
     * @param  \Heritage\Contracts\Support\Arrayable<array-key, TValue>|iterable<array-key, TValue>  $items
     * @return static
     */
     ...
     *
     * @param  \Heritage\Contracts\Support\Arrayable<TKey, TValue>|iterable<TKey, TValue>  $items
     * @return static
     */
     ...
     *
     * @param  \Heritage\Contracts\Support\Arrayable<TKey, mixed>|iterable<TKey, mixed>  $items
     * @return static
     */
     ...
     *
     * @param  \Heritage\Support\Enumerable<array-key, TKey>|array<array-key, TKey>|string  $keys
     * @return static
     */
     ...
     *
     * @param  \Heritage\Contracts\Support\Arrayable<array-key, TValue>|iterable<array-key, TKey>|TKey  $keys
     * @return $this
     */
     ...
     *
     * @param  \Heritage\Contracts\Support\Arrayable<TKey, TMergeValue>|iterable<TKey, TMergeValue>  $items
     ...
     *
     * @param  \Heritage\Contracts\Support\Arrayable<TKey, TMergeRecursiveValue>|iterable<TKey, TMergeRecursiveValue>  $items
     ...
     *
     * @param  \Heritage\Contracts\Support\Arrayable<array-key, TCombineValue>|iterable<array-key, TCombineValue>  $values
     ...
     *
     * @param  \Heritage\Support\Enumerable<array-key, TKey>|array<array-key, TKey>|string|null  $keys
     * @return static
     */
     ...
     *
     * @param  \Heritage\Support\Enumerable<int, string>|list<string>|string|null  $keys
     * @return static
     */
     ...
     * @return TValue
     *
     * @throws \Heritage\Support\ItemNotFoundException
     * @throws \Heritage\Support\MultipleItemsFoundException
     */
     ...
     * @template TZipValue
     *
     * @param  \Heritage\Contracts\Support\Arrayable<array-key, TZipValue>|iterable<array-key, TZipValue>  ...$items
     ...
     *
     * @return \Heritage\Support\Collection<TKey, TValue>
     */
