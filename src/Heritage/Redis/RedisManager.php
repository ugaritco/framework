...
namespace Heritage\Redis;

use Closure;
use Heritage\Contracts\Redis\Factory;
use Heritage\Redis\Connections\Connection;
use Heritage\Redis\Connectors\PhpRedisConnector;
use Heritage\Redis\Connectors\PredisConnector;
...
/**
 * @mixin \Heritage\Redis\Connections\Connection
 */
class RedisManager implements Factory
{
     ...
     *
     * @return \Heritage\Contracts\Redis\Connector|null
     */
