...
namespace Heritage\Redis\Connectors;

use Heritage\Contracts\Redis\Connector;
...
use Heritage\Support\Facades\Redis as RedisFacade;
...
class PhpRedisConnector implements Connector
{
     ...
     * @param  array  $config
     * @param  array  $options
     * @return \Heritage\Redis\Connections\PhpRedisConnection
     */
     ...
     * @param  array  $options
     * @return \Heritage\Redis\Connections\PhpRedisClusterConnection
     */
