...
namespace Heritage\Redis\Connections;

use Closure;
use Heritage\Contracts\Events\Dispatcher;
use Heritage\Redis\Events\CommandExecuted;
use Heritage\Redis\Events\CommandFailed;
use Heritage\Redis\Limiters\ConcurrencyLimiterBuilder;
use Heritage\Redis\Limiters\DurationLimiterBuilder;
...
abstract class Connection
{
     ...
     *
     * @param  string  $name
     * @return \Heritage\Redis\Limiters\ConcurrencyLimiterBuilder
     */
     ...
     *
     * @param  string  $name
     * @return \Heritage\Redis\Limiters\DurationLimiterBuilder
     */
