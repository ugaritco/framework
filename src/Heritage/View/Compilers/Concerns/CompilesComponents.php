...
trait CompilesComponents
{
    ...
    public static function compileClassComponentOpening(string $component, string $alias, string $data, string $hash)
    {
        return implode("\n", [
            ...
            '<?php $component = '.$component.'::resolve('.($data ?: '[]').' + (isset($attributes) && $attributes instanceof Heritage\View\ComponentAttributeBag ? $attributes->all() : [])); ?>',
    ...
    {
        return "<?php \$attributes ??= new \\Heritage\\View\\ComponentAttributeBag;

\$__newAttributes = [];
\$__propNames = \Heritage\View\ComponentAttributeBag::extractPropNames({$expression});
...
\$attributes = new \Heritage\View\ComponentAttributeBag(\$__newAttributes);
