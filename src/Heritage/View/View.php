...
class View implements ArrayAccess, Htmlable, Stringable, ViewContract
{
     ...
     *
     * @var \Heritage\Contracts\View\Engine
     */
    protected $engine;
     ...
     *
     * @param  \Heritage\View\Factory  $factory
     * @param  \Heritage\Contracts\View\Engine  $engine
     * @param  string  $view
     * @param  string  $path
     * @param  mixed  $data
     */
     ...
     *
     * @param  \Heritage\Contracts\Support\MessageProvider|array|string  $provider
     * @param  string  $bag
     * @return $this
     */
     ...
     *
     * @return \Heritage\Contracts\View\Engine
     */
