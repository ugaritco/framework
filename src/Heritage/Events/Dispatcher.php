...
use Heritage\Contracts\Container\Container as ContainerContract;
...
use Heritage\Support\Traits\ReadsClassAttributes;
...
class Dispatcher implements DispatcherContract
{
     ...
     *
     * @var callable(): \Heritage\Contracts\Queue\Queue
     */
     ...
     *
     * @param  \Heritage\Events\QueuedClosure|callable|array|class-string|string  $events
     * @param  \Heritage\Events\QueuedClosure|callable|array|class-string|null  $listener
     * @return void
     */
     ...
     *
     * @param  \Heritage\Contracts\Broadcasting\ShouldBroadcast  $event
     * @return void
     */
     ...
     * @return bool
     *
     * @phpstan-assert-if-true class-string<\Heritage\Contracts\Queue\ShouldQueue> $class
     */
     ...
     *
     * @param  mixed  $listener
     * @param  \Heritage\Events\CallQueuedListener  $job
     * @return \Heritage\Events\CallQueuedListener
     */
     ...
     *
     * @param  callable(): \Heritage\Contracts\Queue\Queue  $resolver
     * @return $this
     */
     ...
     *
     * @return \Heritage\Database\DatabaseTransactionsManager|null
     */
     ...
     *
     * @param  (callable(): (\Heritage\Database\DatabaseTransactionsManager|null))  $resolver
     * @return $this
     */
