...
use Heritage\Broadcasting\Broadcasters\LogBroadcaster;
use Heritage\Broadcasting\Broadcasters\NullBroadcaster;
use Heritage\Broadcasting\Broadcasters\PusherBroadcaster;
use Heritage\Broadcasting\Broadcasters\RedisBroadcaster;
use Heritage\Broadcasting\Mercure\CreatesMercureDrivers;
use Heritage\Bus\UniqueLock;
use Heritage\Contracts\Broadcasting\Factory as FactoryContract;
...
use Heritage\Queue\Attributes\Connection as ConnectionAttribute;
...
/**
 * @mixin \Heritage\Contracts\Broadcasting\Broadcaster
 */
class BroadcastManager implements FactoryContract
{
     ...
     *
     * @param  \Heritage\Contracts\Container\Container  $app
     */
    ...
    public function routes(?array $attributes = null)
    {
        ...
        $this->app['router']->group($attributes, function ($router) {
            ...
            )->withoutMiddleware([\Heritage\Foundation\Http\Middleware\PreventRequestForgery::class]);
        });
    }
     ...
     *
     * @param  \Heritage\Http\Request|null  $request
     * @return string|null
     */
     ...
     *
     * @param  mixed  $event
     * @return \Heritage\Broadcasting\PendingBroadcast
     */
