...
namespace Heritage\Broadcasting\Mercure;
...
trait CreatesMercureDrivers
{
    ...
    protected function createMercureDriver(array $config)
    {
        ...
        return new MercureBroadcaster(
            ...
            (string) (($config['topic_prefix'] ?? null) ?: 'https://ugarit.alt/echo/'),
     ...
     *
     * @param  array  $config
     * @return \Heritage\Broadcasting\Mercure\ChannelEncrypter|null
     */
