...
namespace Heritage\Broadcasting\Broadcasters;
...
class MercureBroadcaster extends Broadcaster
{
     ...
     *
     * The topic prefix namespaces every hub topic: it keeps Ugarit topics
     ...
     * default is a "ugarit.alt" URL: ".alt" is reserved outside the DNS
     ...
     * @param  \Heritage\Broadcasting\Mercure\ChannelEncrypter|null  $encrypter
    ...
    public function __construct(
        ...
        protected string $topicPrefix = 'https://ugarit.alt/echo/',
     ...
     *
     * @param  array<int, \Heritage\Broadcasting\Channel|string>  $channels
     * @param  string  $event
