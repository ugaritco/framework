...
use Closure;
use Heritage\Bus\Events\BatchDispatched;
...
class PendingBatch
{
     ...
     *
     * @phpstan-type TParam (Closure(\Heritage\Bus\Batch, \Throwable|null): mixed)|(callable(\Heritage\Bus\Batch, \Throwable|null): mixed)
     *
     ...
     *
     * @param  \Heritage\Bus\Batch  $batch
     * @return void
     *
     * @throws \Throwable
     */
     ...
     *
     * @param  \Heritage\Bus\BatchRepository  $repository
     * @return \Heritage\Bus\Batch
     */
