...
class ConcurrencyLimiter
{
     ...
     *
     * @var \Heritage\Contracts\Cache\LockProvider
     */
    protected $store;
     ...
     *
     * @param  \Heritage\Contracts\Cache\LockProvider  $store
     * @param  string  $name
     * @param  int  $maxLocks
     ...
     * @return mixed
     *
     * @throws \Heritage\Cache\Limiters\LimiterTimeoutException
     * @throws \Throwable
     */
     ...
     *
     * @param  string  $id
     * @return \Heritage\Contracts\Cache\Lock|false
     */
     ...
     * Release the lock.
     *
     * @param  \Heritage\Contracts\Cache\Lock  $lock
     * @return void
     */
