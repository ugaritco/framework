...
use Heritage\Http\Resources\JsonApi\Exceptions\ResourceIdentificationException;
...
trait ResolvesJsonApiElements
{
     ...
     *
     * @var array<int, array{0: \Heritage\Http\Resources\JsonApi\JsonApiResource, 1: string, 2: string, 3: bool}>|null
     */
