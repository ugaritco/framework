...
use Heritage\Session\SymfonySessionDecorator;
...
class Request extends SymfonyRequest implements Arrayable, ArrayAccess
{
     ...
     *
     * @var array<int, \Heritage\Http\UploadedFile|\Heritage\Http\UploadedFile[]>
     */
    ...
    /**
     * Create a new Heritage HTTP request from server variables.
     *
     * @return static
     */
    ...
    /**
     * This method belongs to Symfony HttpFoundation and is not usually needed when using Ugarit.
     *
    ...
    /**
     * Create a new request instance from the given Ugarit request.
     *
     * @param  \Heritage\Http\Request  $from
     * @param  \Heritage\Http\Request|null  $to
     * @return static
     */
    ...
    /**
     * Create an Heritage request from a Symfony instance.
     *
     ...
     * @return void
     */
    public function setUgaritSession($session)
    {
     ...
     * @param  mixed  $default
     * @return ($param is null ? \Heritage\Routing\Route : object|string|null)
     */
