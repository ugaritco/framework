...
namespace Heritage\Http\Concerns;
...
trait InteractsWithInput
{
     ...
     *
     * @return array<string, \Heritage\Http\UploadedFile|\Heritage\Http\UploadedFile[]>
     */
    ...
    /**
     * Convert the given array of Symfony UploadedFiles to custom Ugarit UploadedFiles.
     *
     ...
     * @param  string|null  $key
     * @param  mixed  $default
     * @return ($key is null ? array<string, \Heritage\Http\UploadedFile|\Heritage\Http\UploadedFile[]> : \Heritage\Http\UploadedFile|\Heritage\Http\UploadedFile[]|null)
     */
