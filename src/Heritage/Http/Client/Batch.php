...
/**
 * @mixin \Heritage\Http\Client\Factory
 */
class Batch
{
    /**
     ...
     *
     * @var array<array-key, \Heritage\Http\Client\PendingRequest>
     */
    protected $requests = [];
     ...
     *
     * @var (\Closure($this, int|string, \Heritage\Http\Client\Response): void)|null
     */
     ...
     *
     * @var (\Closure($this, int|string, \Heritage\Http\Client\Response|\Heritage\Http\Client\RequestException|\Heritage\Http\Client\ConnectionException): void)|null
     */
     ...
     *
     * @var (\Closure($this, array<int|string, \Heritage\Http\Client\Response>): void)|null
     */
     ...
     *
     * @throws \Heritage\Http\Client\BatchInProgressException
     */
     ...
     *
     * @return \Heritage\Http\Client\PendingRequest|\GuzzleHttp\Promise\Promise
     *
     * @throws \Heritage\Http\Client\BatchInProgressException
     */
     ...
     *
     * @param  (\Closure($this, int|string, \Heritage\Http\Client\Response): void)  $callback
     * @return Batch
     */
     ...
     *
     * @param  (\Closure($this, int|string, \Heritage\Http\Client\Response|\Heritage\Http\Client\RequestException|\Heritage\Http\Client\ConnectionException): void)  $callback
     * @return Batch
     */
     ...
     *
     * @param  (\Closure($this, array<int|string, \Heritage\Http\Client\Response>): void)  $callback
     * @return Batch
     */
     ...
     *
     * @return \Heritage\Support\Defer\DeferredCallback
     */
     ...
     *
     * @return array<int|string, \Heritage\Http\Client\Response|\Heritage\Http\Client\RequestException>
     */
     ...
     *
     * @return array<array-key, \Heritage\Http\Client\PendingRequest>
     */
