...
/**
 * @mixin \Heritage\Http\Client\PendingRequest
 */
class Factory
{
    use Macroable {
     ...
     *
     * @var list<array{0: \Heritage\Http\Client\Request, 1: \Heritage\Http\Client\Response|null}>
     */
    protected $recorded = [];
     ...
     *
     * @var list<\Heritage\Http\Client\ResponseSequence>
     */
     ...
     *
     * @param  \Heritage\Contracts\Events\Dispatcher|null  $dispatcher
     */
            ...
            if (is_array($value)) {
                ...
                foreach ($value as $key => $item) {
                    $value[$key] = match (true) {
                        ...
                        default => throw new InvalidArgumentException('HTTP fake response header values must be scalar, null, Ugarit Stringable, or arrays of scalar, null, or Ugarit Stringable values.'),
                    };
                }
     ...
     * @param  int  $status
     * @param  array  $headers
     * @return \Heritage\Http\Client\RequestException
     */
     ...
     * @return \Closure(\Heritage\Http\Client\Request): \GuzzleHttp\Promise\PromiseInterface
     */
     ...
     *
     * @param  string  $url
     * @param  \Heritage\Http\Client\Response|\GuzzleHttp\Promise\PromiseInterface|callable|int|string|array|\Heritage\Http\Client\ResponseSequence  $callback
     * @return $this
     *
     * @throws \InvalidArgumentException
     */
     ...
     * @param  \Heritage\Http\Client\Response|null  $response
     * @return void
     */
     ...
     *
     * @param  callable|(\Closure(\Heritage\Http\Client\Request, \Heritage\Http\Client\Response|null): bool)  $callback
     * @return void
     */
     ...
     *
     * @param  list<string|(\Closure(\Heritage\Http\Client\Request, \Heritage\Http\Client\Response|null): bool)|callable>  $callbacks
     * @return void
     */
     ...
     *
     * @param  (\Closure(\Heritage\Http\Client\Request, \Heritage\Http\Client\Response|null): bool)|callable  $callback
     * @return \Heritage\Support\Collection<int, array{0: \Heritage\Http\Client\Request, 1: \Heritage\Http\Client\Response|null}>
     */
     ...
     *
     * @return \Heritage\Http\Client\PendingRequest
     */
