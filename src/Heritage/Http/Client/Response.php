...
class Response implements ArrayAccess, Stringable
{
     ...
     *
     * @param  callable|(\Closure(\Heritage\Http\Client\Response): mixed)  $callback
     * @return $this
     */
     ...
     *
     * @return \Heritage\Http\Client\RequestException|null
     */
     ...
     *
     * @param  null|(\Closure(\Heritage\Http\Client\Response, \Heritage\Http\Client\RequestException): mixed)  $callback
     * @return $this
     *
     ...
     *
     * @param  int|(\Closure(int, \Heritage\Http\Client\Response): bool)|callable  $statusCode
     * @return $this
     *
     * @throws \Heritage\Http\Client\RequestException
     */
