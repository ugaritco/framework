...
use Heritage\Database\Schema\Grammars\MySqlGrammar;
...
class Blueprint
{
     ...
     *
     * @var \Heritage\Database\Schema\ColumnDefinition[]
     */
    protected $columns = [];
     ...
     *
     * @var \Heritage\Database\Schema\BlueprintState|null
     */
    protected $state;
     ...
     *
     * @return \Heritage\Support\Fluent
     */
     ...
     * Indicate that the given foreign key should be dropped.
     *
     * @param  \Heritage\Database\Eloquent\Model|string  $model
     ...
     * @return \Heritage\Database\Schema\IndexDefinition
     */
     ...
     * @param  string|array  $columns
     * @param  string|null  $name
     * @return \Heritage\Database\Schema\ForeignKeyDefinition
     */
     ...
     *
     * @param  string  $column
     * @return \Heritage\Database\Schema\ForeignIdColumnDefinition
     */
     ...
     *
     * @param  int|null  $precision
     * @return \Heritage\Support\Collection<int, \Heritage\Database\Schema\ColumnDefinition>
     */
     ...
     *
     * @return \Heritage\Database\Schema\BlueprintState
     */
