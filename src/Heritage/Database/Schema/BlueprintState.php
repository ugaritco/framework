...
class BlueprintState
{
     ...
     *
     * @var \Heritage\Database\Schema\Blueprint
     */
    protected $blueprint;
     ...
     * The primary key.
     *
     * @var \Heritage\Database\Schema\IndexDefinition|null
     */
    private $primaryKey;
     ...
     * The indexes.
     *
     * @var \Heritage\Database\Schema\IndexDefinition[]
     */
    private $indexes;
     ...
     * The foreign keys.
     *
     * @var \Heritage\Database\Schema\ForeignKeyDefinition[]
     */
    private $foreignKeys;
     ...
     *
     * @param  \Heritage\Database\Schema\Blueprint  $blueprint
     ...
     * Get the primary key.
     *
     * @return \Heritage\Database\Schema\IndexDefinition|null
     */
     ...
     *
     * @param  \Heritage\Support\Fluent  $command
     * @return void
     */
