...
namespace Heritage\Database\Schema\Grammars;
...
abstract class Grammar extends BaseGrammar
{
     ...
     *
     * @param  \Heritage\Database\Schema\Blueprint  $blueprint
     * @param  \Heritage\Database\Schema\ColumnDefinition  $column
     * @return string
     */
     ...
     *
     * @param  \Heritage\Support\Fluent  $column
     * @return string
     */
     ...
     * @param  \Heritage\Database\Schema\Blueprint  $blueprint
     * @param  string  $name
     * @return \Heritage\Support\Fluent|null
     */
     ...
     *
     * @param  \Heritage\Support\Fluent|\Heritage\Contracts\Database\Query\Expression|string  $value
     * @return string
     */
