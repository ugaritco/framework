...
use Heritage\Database\Schema\IndexDefinition;
...
class SQLiteGrammar extends Grammar
{
     ...
     *
     * @param  \Heritage\Database\Schema\ForeignKeyDefinition[]  $foreignKeys
     * @return string|null
     */
     ...
     *
     * @param  \Heritage\Support\Fluent  $foreign
     * @return string
     */
     ...
     *
     * @param  \Heritage\Support\Fluent|null  $primary
     * @return string|null
     */
