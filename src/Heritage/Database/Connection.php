...
use Heritage\Database\Events\StatementPrepared;
use Heritage\Database\Events\TransactionBeginning;
use Heritage\Database\Events\TransactionCommitted;
use Heritage\Database\Events\TransactionCommitting;
use Heritage\Database\Events\TransactionRolledBack;
use Heritage\Database\Query\Builder as QueryBuilder;
use Heritage\Database\Query\Expression;
use Heritage\Database\Query\Grammars\Grammar as QueryGrammar;
use Heritage\Database\Query\Processors\Processor;
use Heritage\Database\Schema\Builder as SchemaBuilder;
...
class Connection implements ConnectionInterface
{
     ...
     *
     * @var (callable(\Heritage\Database\Connection): mixed)
     */
     ...
     *
     * @var \Heritage\Database\Schema\Grammars\Grammar
     */
     ...
     *
     * @var \Heritage\Database\DatabaseTransactionsManager|null
     */
     ...
     *
     * @var array{has_run: bool, handler: (callable(\Heritage\Database\Connection, class-string<\Heritage\Database\Events\QueryExecuted>): mixed)}[]
     */
     ...
     *
     * @var (\Closure(string, array, \Heritage\Database\Connection): mixed)[]
     */
     ...
     *
     * @return \Heritage\Database\Schema\Grammars\Grammar|null
     */
     ...
     *
     * @param  \Closure|\Heritage\Database\Query\Builder|\Heritage\Contracts\Database\Query\Expression|\UnitEnum|string  $table
     ...
     * @return mixed
     *
     * @throws \Heritage\Database\MultipleColumnsSelectedException
     */
     ...
     *
     * @param  (\Closure(\Heritage\Database\Connection): mixed)  $callback
     ...
     * @return mixed
     *
     * @throws \Heritage\Database\QueryException
     */
     ...
     * @param  (callable(\Heritage\Database\Connection, \Heritage\Database\Events\QueryExecuted): mixed)  $handler
     * @return void
     */
     ...
     *
     * @param  \Heritage\Database\QueryException  $e
     * @param  string  $query
     * @param  array  $bindings
     * @param  \Closure  $callback
     * @return mixed
     ...
     * @return mixed|false
     *
     * @throws \Heritage\Database\LostConnectionException
     */
     ...
     *
     * @param  \Closure(\Heritage\Database\Events\QueryExecuted)  $callback
     * @return void
     */
     ...
     *
     * @param  (callable(\Heritage\Database\Connection): mixed)  $reconnector
     * @return $this
     */
     ...
     *
     * @param  \Heritage\Database\Query\Grammars\Grammar  $grammar
     * @return $this
     */
     ...
     *
     * @return \Heritage\Database\Schema\Grammars\Grammar
     */
     ...
     *
     * @param  \Heritage\Database\Schema\Grammars\Grammar  $grammar
     * @return $this
     */
     ...
     *
     * @param  \Heritage\Database\Query\Processors\Processor  $processor
     * @return $this
     */
     ...
     *
     * @return \Heritage\Contracts\Events\Dispatcher|null
     */
     ...
     *
     * @param  \Heritage\Database\DatabaseTransactionsManager  $manager
     * @return $this
     */
