...
abstract class Grammar
{
     ...
     *
     * @param  array<\Heritage\Contracts\Database\Query\Expression|string>  $values
     * @return array<string>
     */
     ...
     *
     * @param  \Heritage\Contracts\Database\Query\Expression|string  $value
     * @return string
     */
     ...
     *
     * @param  \Heritage\Contracts\Database\Query\Expression|string|int|float  $expression
