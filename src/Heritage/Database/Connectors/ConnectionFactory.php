...
namespace Heritage\Database\Connectors;

use Heritage\Contracts\Container\Container;
use Heritage\Database\Connection;
use Heritage\Database\Connectors\Concerns\ConfiguresPooledConnections;
...
class ConnectionFactory
{
     ...
     *
     * @param  array  $config
     * @return \Heritage\Database\Connectors\ConnectorInterface
     *
     * @throws \InvalidArgumentException
     */
