...
trait BuildsQueries
{
     ...
     *
     * @param  int  $count
     * @param  callable(\Heritage\Support\Collection<int, TValue>, int): mixed  $callback
     * @return bool
     */
     ...
     * @param  int  $count
     * @return \Heritage\Support\Collection<int, TReturn>
     */
     ...
     *
     * @param  int  $chunkSize
     * @return \Heritage\Support\LazyCollection<int, TValue>
     *
     ...
     * @return TValue
     *
     * @throws \Heritage\Database\RecordNotFoundException
     */
     ...
     *
     * @param  \Heritage\Database\Query\Builder|\Heritage\Database\Eloquent\Builder<*>  $builder
     ...
     * @param  int  $currentPage
     * @param  array  $options
     * @return \Heritage\Pagination\Paginator
     */
     ...
     * @param  \Heritage\Support\Collection  $items
     * @param  int  $perPage
     * @param  \Heritage\Pagination\Cursor  $cursor
     * @param  array  $options
     * @return \Heritage\Pagination\CursorPaginator
     */
