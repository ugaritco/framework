...
use Heritage\Console\View\Components\Info;
use Heritage\Console\View\Components\Task;
...
class Migrator
{
     ...
     *
     * @var (\Closure(\Heritage\Database\ConnectionResolverInterface, ?string): \Heritage\Database\Connection)|null
     */
     ...
     *
     * @var array<string, \Heritage\Database\Migrations\Migration|null>
     */
     ...
     *
     * @param  \Closure(\Heritage\Database\ConnectionResolverInterface, ?string): \Heritage\Database\Connection  $callback
     * @return void
     */
     ...
     *
     * @return \Heritage\Database\Migrations\MigrationRepositoryInterface
     */
     ...
     *
     * @return \Heritage\Filesystem\Filesystem
     */
     ...
     *
     * @param  \Heritage\Contracts\Database\Events\MigrationEvent  $event
     * @return void
     */
