 ...
 *
 * @implements \Heritage\Database\Eloquent\Scope<TModel>
 */
class SoftDeletingScope implements Scope
{
     ...
     *
     * @param  \Heritage\Database\Eloquent\Builder<TModel>  $builder
     * @param  TModel  $model
     * @return void
     */
     ...
     *
     * @param  \Heritage\Database\Eloquent\Builder<*>  $builder
     * @return void
     */
