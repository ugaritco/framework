...
use Heritage\Support\Enumerable;
...
abstract class Factory
{
     ...
     * @param  \Heritage\Support\Collection|null  $states
     * @param  \Heritage\Support\Collection|null  $has
     * @param  \Heritage\Support\Collection|null  $for
     * @param  \Heritage\Support\Collection|null  $afterMaking
     * @param  \Heritage\Support\Collection|null  $afterCreating
     * @param  \UnitEnum|string|null  $connection
     * @param  \Heritage\Support\Collection|null  $recycle
     ...
     *
     * @param  (callable(array<string, mixed>): array<string, mixed>)|array<string, mixed>  $attributes
     * @param  \Heritage\Database\Eloquent\Model|null  $parent
     ...
     * @param  (callable(array<string, mixed>): array<string, mixed>)|array<string, mixed>  $attributes
     * @param  \Heritage\Database\Eloquent\Model|null  $parent
     * @return \Heritage\Database\Eloquent\Collection<int, TModel>|TModel
     */
     ...
     * @param  \Heritage\Database\Eloquent\Model|null  $parent
     * @return \Closure(): (\Heritage\Database\Eloquent\Collection<int, TModel>|TModel)
     */
     ...
     *
     * @param  \Heritage\Support\Collection<int, TModel>  $results
     * @return void
     */
     ...
     *
     * @param  \Heritage\Database\Eloquent\Factories\Factory|\Heritage\Database\Eloquent\Model  $factory
     * @param  string|null  $relationship
     * @return static
     */
     ...
     *
     * @param  \Heritage\Database\Eloquent\Model|\Heritage\Support\Collection|array  $model
     * @return static
     */
     ...
     *
     * @template TClass of \Heritage\Database\Eloquent\Model
     *
     ...
     *
     * @param  \Closure(TModel, \Heritage\Database\Eloquent\Model|null): mixed  $callback
     * @return static
     */
     ...
     *
     * @param  \Heritage\Support\Collection  $instances
     * @return void
     */
     ...
     * @return \Heritage\Database\Eloquent\Factories\Factory<TClass>
     */
     ...
     *
     * @param  callable(class-string<\Heritage\Database\Eloquent\Model>): class-string<\Heritage\Database\Eloquent\Factories\Factory>  $callback
     * @return void
     */
     ...
     *
     * @param  class-string<TClass>  $modelName
     * @return class-string<\Heritage\Database\Eloquent\Factories\Factory<TClass>>
     */
