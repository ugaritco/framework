...
use Heritage\Database\Eloquent\Attributes\Initialize;
...
use Heritage\Database\Eloquent\PendingHasThroughRelationship;
...
trait HasRelationships
{
     ...
     * @return \Heritage\Database\Eloquent\Relations\HasOne<TRelatedModel, $this>
     */
     ...
     *
     * @param  \Heritage\Database\Eloquent\Builder<TRelatedModel>  $query
     ...
     * @return \Heritage\Database\Eloquent\Relations\HasOneThrough<TRelatedModel, TIntermediateModel, $this>
     */
     ...
     * @return \Heritage\Database\Eloquent\Relations\HasOneThrough<TRelatedModel, TIntermediateModel, TDeclaringModel>
     */
     ...
     * @param  string|null  $localKey
     * @return \Heritage\Database\Eloquent\Relations\MorphOne<TRelatedModel, $this>
     */
     ...
     * @param  string  $id
     * @param  string  $localKey
     * @return \Heritage\Database\Eloquent\Relations\MorphOne<TRelatedModel, TDeclaringModel>
     */
     ...
     * @return \Heritage\Database\Eloquent\Relations\BelongsTo<TRelatedModel, $this>
     */
     ...
     * @return \Heritage\Database\Eloquent\Relations\BelongsTo<TRelatedModel, TDeclaringModel>
     */
     ...
     * @param  string  $type
     * @param  string  $relation
     * @return \Heritage\Database\Eloquent\Relations\MorphTo<TRelatedModel, TDeclaringModel>
     */
     ...
     * @template TIntermediateModel of \Heritage\Database\Eloquent\Model
     *
     * @param  string|\Heritage\Database\Eloquent\Relations\HasMany<TIntermediateModel, covariant $this>|\Heritage\Database\Eloquent\Relations\HasOne<TIntermediateModel, covariant $this>  $relationship
     * @return (
     *     $relationship is string
     *     ? \Heritage\Database\Eloquent\PendingHasThroughRelationship<\Heritage\Database\Eloquent\Model, $this>
     *     : (
     *          $relationship is \Heritage\Database\Eloquent\Relations\HasMany<TIntermediateModel, $this>
     *          ? \Heritage\Database\Eloquent\PendingHasThroughRelationship<TIntermediateModel, $this, \Heritage\Database\Eloquent\Relations\HasMany<TIntermediateModel, $this>>
     *          : \Heritage\Database\Eloquent\PendingHasThroughRelationship<TIntermediateModel, $this, \Heritage\Database\Eloquent\Relations\HasOne<TIntermediateModel, $this>>
     *     )
     * )
     */
     ...
     * @param  string|null  $foreignKey
     * @param  string|null  $localKey
     * @return \Heritage\Database\Eloquent\Relations\HasMany<TRelatedModel, $this>
     */
     ...
     * @param  string  $foreignKey
     * @param  string  $localKey
     * @return \Heritage\Database\Eloquent\Relations\HasMany<TRelatedModel, TDeclaringModel>
     */
     ...
     * @param  string|null  $localKey
     * @param  string|null  $secondLocalKey
     * @return \Heritage\Database\Eloquent\Relations\HasManyThrough<TRelatedModel, TIntermediateModel, $this>
     */
     ...
     * @param  string  $localKey
     * @param  string  $secondLocalKey
     * @return \Heritage\Database\Eloquent\Relations\HasManyThrough<TRelatedModel, TIntermediateModel, TDeclaringModel>
     */
     ...
     * @param  string|null  $id
     * @param  string|null  $localKey
     * @return \Heritage\Database\Eloquent\Relations\MorphMany<TRelatedModel, $this>
     */
     ...
     * @param  string  $id
     * @param  string  $localKey
     * @return \Heritage\Database\Eloquent\Relations\MorphMany<TRelatedModel, TDeclaringModel>
     */
     ...
     *
     * @template TRelatedModel of \Heritage\Database\Eloquent\Model
     * @template TPivotModel of \Heritage\Database\Eloquent\Relations\Pivot = \Heritage\Database\Eloquent\Relations\Pivot
     ...
     * @param  string|null  $relation
     * @return \Heritage\Database\Eloquent\Relations\BelongsToMany<TRelatedModel, $this, TPivotModel>
     */
     ...
     * @param  \Heritage\Database\Eloquent\Builder<TRelatedModel>  $query
     * @param  TDeclaringModel  $parent
     * @param  string|class-string<\Heritage\Database\Eloquent\Model>  $table
     * @param  string  $foreignPivotKey
     * @param  string  $relatedPivotKey
     * @param  string  $parentKey
     * @param  string  $relatedKey
     * @param  string|null  $relationName
     * @return \Heritage\Database\Eloquent\Relations\BelongsToMany<TRelatedModel, TDeclaringModel, \Heritage\Database\Eloquent\Relations\Pivot>
     */
     ...
     * @param  string|null  $relation
     * @param  bool  $inverse
     * @return \Heritage\Database\Eloquent\Relations\MorphToMany<TRelatedModel, $this>
     */
     ...
     * @param  string|null  $relationName
     * @param  bool  $inverse
     * @return \Heritage\Database\Eloquent\Relations\MorphToMany<TRelatedModel, TDeclaringModel>
     */
     ...
     * @param  \Heritage\Database\Eloquent\Model|null  $instance
     * @return string
     */
     ...
     * @return string
     *
     * @throws \Heritage\Database\ClassMorphViolationException
     */
