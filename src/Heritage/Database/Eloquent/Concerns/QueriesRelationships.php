...
use Heritage\Database\Eloquent\RelationNotFoundException;
...
/** @mixin \Heritage\Database\Eloquent\Builder */
trait QueriesRelationships
{
     ...
     *
     * @param  \Heritage\Database\Eloquent\Relations\Relation<TRelatedModel, *, *>|string  $relation
     * @param  string  $operator
     * @param  \Heritage\Contracts\Database\Query\Expression|int  $count
     * @param  string  $boolean
     * @param  (\Closure(\Heritage\Database\Eloquent\Builder<TRelatedModel>): mixed)|null  $callback
     * @return $this
     *
     ...
     * @param  \Heritage\Contracts\Database\Query\Expression|int  $count
     * @param  string  $boolean
     * @param  (\Closure(\Heritage\Database\Eloquent\Builder<*>): mixed)|null  $callback
     * @return $this
     */
     ...
     *
     * @param  \Heritage\Database\Eloquent\Relations\Relation<*, *, *>|string  $relation
     * @param  string  $operator
     * @param  \Heritage\Contracts\Database\Query\Expression|int  $count
     * @return $this
     */
     ...
     * @param  (\Closure(\Heritage\Database\Eloquent\Builder<*>|\Heritage\Database\Eloquent\Relations\Relation<*, *, *>): mixed)|null  $callback
     * @param  string  $operator
     * @param  \Heritage\Contracts\Database\Query\Expression|int  $count
     * @return $this
     */
     ...
     * @template TRelatedModel of \Heritage\Database\Eloquent\Model
     *
     * @param  \Heritage\Database\Eloquent\Relations\MorphTo<TRelatedModel, *>|string  $relation
     * @param  string|array<int, string>  $types
     * @param  string  $operator
     * @param  \Heritage\Contracts\Database\Query\Expression|int  $count
     * @param  string  $boolean
     * @param  (\Closure(\Heritage\Database\Eloquent\Builder<TRelatedModel>, string): mixed)|null  $callback
     * @return $this
     */
     ...
     *
     * @param  \Heritage\Database\Eloquent\Relations\MorphTo<*, TDeclaringModel>  $relation
     ...
     *
     * @param  \Heritage\Database\Eloquent\Relations\MorphTo<*, *>|string  $relation
     * @param  string|array<int, string>  $types
     * @param  string  $operator
     * @param  \Heritage\Contracts\Database\Query\Expression|int  $count
     * @return $this
     ...
     *
     * @param  \Heritage\Database\Eloquent\Relations\Relation<TRelatedModel, *, *>|string  $relation
     * @param  (\Closure(\Heritage\Database\Eloquent\Builder<TRelatedModel>): mixed)|string|array|\Heritage\Contracts\Database\Query\Expression  $column
     ...
     *
     * @param  \Heritage\Database\Eloquent\Relations\MorphTo<*, *>|string  $relation
     * @param  \Heritage\Database\Eloquent\Model|iterable<int, \Heritage\Database\Eloquent\Model>|string|null  $model
     * @return $this
     *
     ...
     *
     * @param  \Heritage\Database\Eloquent\Relations\MorphTo<*, *>|string  $relation
     * @param  \Heritage\Database\Eloquent\Model|iterable<int, \Heritage\Database\Eloquent\Model>|string  $model
     * @return $this
     *
     * @throws \InvalidArgumentException
     */
     ...
     *
     * @param  \Heritage\Database\Eloquent\Model|\Heritage\Database\Eloquent\Collection<int, \Heritage\Database\Eloquent\Model>  $related
     * @param  string|null  $relationshipName
     * @param  string  $boolean
     * @return $this
     *
     * @throws \InvalidArgumentException
     * @throws \Heritage\Database\Eloquent\RelationNotFoundException
     */
     ...
     *
     * @param  \Heritage\Database\Eloquent\Model  $related
     * @param  string|null  $relationshipName
     * @return $this
     */
     ...
     *
     * @param  string  $column
     * @param  \Heritage\Database\Eloquent\Relations\Relation<*, *, *>  $relation
     * @return string
     */
     ...
     *
     * @param  \Heritage\Database\Eloquent\Builder<*>  $hasQuery
     * @param  \Heritage\Database\Eloquent\Relations\Relation<*, *, *>  $relation
     * @param  string  $operator
     * @param  \Heritage\Contracts\Database\Query\Expression|int  $count
     * @param  string  $boolean
     ...
     *
     * @param  \Heritage\Database\Eloquent\Builder<*>  $from
     * @return $this
     */
     ...
     *
     * @param  string  $relation
     * @return \Heritage\Database\Eloquent\Relations\Relation<*, *, *>
     */
