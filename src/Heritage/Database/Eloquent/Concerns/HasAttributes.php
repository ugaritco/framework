...
use Heritage\Database\Eloquent\Casts\Json;
use Heritage\Database\Eloquent\InvalidCastException;
...
use Heritage\Database\LazyLoadingViolationException;
...
use Heritage\Support\Exceptions\MathException;
...
trait HasAttributes
{
     ...
     * @return null
     *
     * @throws \Heritage\Database\Eloquent\MissingAttributeException
     */
     ...
     * @return mixed
     *
     * @throws \Heritage\Database\LazyLoadingViolationException
     */
     ...
     * @return string
     *
     * @throws \Heritage\Support\Exceptions\MathException
     */
     ...
     * @return bool
     *
     * @throws \Heritage\Database\Eloquent\InvalidCastException
     */
