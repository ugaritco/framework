...
use Heritage\Contracts\Queue\QueueableCollection;
...
use Heritage\Contracts\Support\CanBeEscapedWhenCastToString;
...
use Heritage\Database\Eloquent\Attributes\Scope as LocalScope;
use Heritage\Database\Eloquent\Attributes\Table;
use Heritage\Database\Eloquent\Attributes\UseEloquentBuilder;
...
abstract class Model implements Arrayable, ArrayAccess, CanBeEscapedWhenCastToString, HasBroadcastChannel, Jsonable, JsonSerializable, QueueableEntity, Stringable, UrlRoutable
{
    use Concerns\HasAttributes,
        ...
        ForwardsCalls;
    /** @use HasCollection<\Heritage\Database\Eloquent\Collection<array-key, static & self>> */
    use HasCollection;
     ...
     *
     * @var \Heritage\Contracts\Events\Dispatcher|null
     */
     ...
     *
     * @var class-string<\Heritage\Database\Eloquent\Builder<*>>
     */
     ...
     *
     * @var class-string<\Heritage\Database\Eloquent\Collection<*, *>>
     */
     ...
     *
     * @param  (callable(self, string, \Heritage\Database\LazyLoadingViolationException): mixed)|null  $callback
     * @return void
     */
     ...
     *
     * @param  (callable(self, array, \Heritage\Database\Eloquent\MassAssignmentException): mixed)|null  $callback
     * @return void
     */
     ...
     *
     * @param  (callable(self, string, \Heritage\Database\Eloquent\MissingAttributeException): mixed)|null  $callback
     * @return void
     */
     ...
     * @return $this
     *
     * @throws \Heritage\Database\Eloquent\MassAssignmentException
     */
     ...
     * @return \Heritage\Database\Eloquent\Collection<int, static>
     */
     ...
     *
     * @param  \Heritage\Support\Collection|array|int|string  $ids
     * @return int
     */
     ...
     *
     * @param  \Heritage\Database\Eloquent\Builder<static>  $builder
     * @return \Heritage\Database\Eloquent\Builder<static>
     */
     ...
     *
     * @return class-string<\Heritage\Database\Eloquent\Builder>|false
     */
     ...
     * @return \Heritage\Database\Eloquent\Relations\Pivot
     */
     ...
     * @return string
     *
     * @throws \Heritage\Database\Eloquent\JsonEncodingException
     */
     ...
     *
     * @param  \Heritage\Database\Eloquent\Model|null  $model
     * @return bool
     */
     ...
     *
     * @return \Heritage\Database\ConnectionResolverInterface|null
     */
     ...
     *
     * @param  \Heritage\Database\ConnectionResolverInterface  $resolver
     * @return void
     */
     ...
     * @param  mixed  $value
     * @param  string|null  $field
     * @return \Heritage\Database\Eloquent\Relations\Relation<\Heritage\Database\Eloquent\Model, $this, *>
     */
     ...
     * Retrieve the model for a bound value.
     *
     * @param  \Heritage\Database\Eloquent\Model|\Heritage\Contracts\Database\Eloquent\Builder|\Heritage\Database\Eloquent\Relations\Relation  $query
     * @param  mixed  $value
     * @param  string|null  $field
     * @return \Heritage\Contracts\Database\Eloquent\Builder
     */
