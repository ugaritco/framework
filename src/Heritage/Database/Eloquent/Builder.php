...
use Closure;
use Exception;
use Heritage\Contracts\Database\Eloquent\Builder as BuilderContract;
use Heritage\Contracts\Database\Query\Expression;
use Heritage\Contracts\Support\Arrayable;
use Heritage\Database\Concerns\BuildsQueries;
use Heritage\Database\Eloquent\Concerns\QueriesRelationships;
 ...
 *
 * @mixin \Heritage\Database\Query\Builder
 */
class Builder implements BuilderContract
{
    /** @use \Heritage\Database\Concerns\BuildsQueries<TModel> */
     ...
     *
     * @var \Heritage\Database\Query\Builder
     */
    protected $query;
     ...
     * @param  \Heritage\Database\Eloquent\Scope|\Closure  $scope
     * @return $this
     */
     ...
     *
     * @param  (\Closure(static): mixed)|string|array|\Heritage\Contracts\Database\Query\Expression  $column
     ...
     *
     * @param  (\Closure(static): mixed)|array|string|\Heritage\Contracts\Database\Query\Expression  $column
     * @param  mixed  $operator
     * @param  mixed  $value
     * @return $this
     */
     ...
     *
     * @param  array  $items
     * @return \Heritage\Database\Eloquent\Collection<int, TModel>
     */
     ...
     * @return ($id is (\Heritage\Contracts\Support\Arrayable<array-key, mixed>|array<mixed>) ? \Heritage\Database\Eloquent\Collection<int, TModel> : TModel|null)
     */
     ...
     * @return TModel
     *
     * @throws \Heritage\Database\Eloquent\ModelNotFoundException<TModel>
     ...
     * @param  mixed  $id
     * @param  array|string  $columns
     * @return ($id is (\Heritage\Contracts\Support\Arrayable<array-key, mixed>|array<mixed>) ? \Heritage\Database\Eloquent\Collection<int, TModel> : TModel)
     *
     * @throws \Heritage\Database\Eloquent\ModelNotFoundException<TModel>
     */
     ...
     *     ? \Heritage\Database\Eloquent\Collection<int, TModel>
     *     : TModel|TValue
     * )
     */
     ...
     *
     * @param  string  $name
     * @return \Heritage\Database\Eloquent\Relations\Relation<\Heritage\Database\Eloquent\Model, TModel, *>
     */
     ...
     *
     * @return \Heritage\Support\LazyCollection<int, TModel>
     */
     ...
     * @return \Heritage\Pagination\LengthAwarePaginator<int, TModel>
     *
     ...
     * @param  string  $pageName
     * @param  int|null  $page
     * @return \Heritage\Pagination\Paginator<int, TModel>
     */
     ...
     * @return \Heritage\Pagination\CursorPaginator<int, TModel>
     */
     ...
     *
     * @param  array<array-key, array|(\Closure(\Heritage\Database\Eloquent\Relations\Relation<*,*,*>): mixed)|string>|string  $relations
     * @param  (\Closure(\Heritage\Database\Eloquent\Relations\Relation<*,*,*>): mixed)|string|null  $callback
     * @return $this
     */
     ...
     *
     * @param  \Heritage\Contracts\Database\Query\Expression|array|string  $attributes
     * @param  mixed  $value
     ...
     *
     * @template TModelNew of \Heritage\Database\Eloquent\Model
     *
     ...
     *
     * @param  array|\Heritage\Contracts\Database\Query\Expression  $columns
     * @return array
     */
