 ...
 *
 * @extends \Heritage\Database\Eloquent\Relations\HasOneOrManyThrough<TRelatedModel, TIntermediateModel, TDeclaringModel, \Heritage\Database\Eloquent\Collection<int, TRelatedModel>>
 */
