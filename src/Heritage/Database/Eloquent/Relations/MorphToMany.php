 ...
 * @template TPivotModel of \Heritage\Database\Eloquent\Relations\Pivot = \Heritage\Database\Eloquent\Relations\MorphPivot
 * @template TAccessor of string = 'pivot'
 *
 * @extends \Heritage\Database\Eloquent\Relations\BelongsToMany<TRelatedModel, TDeclaringModel, TPivotModel, TAccessor>
 */
class MorphToMany extends BelongsToMany
{
     ...
     *
     * @param  mixed  $ids
     * @return \Heritage\Support\Collection<int, TPivotModel>
     */
