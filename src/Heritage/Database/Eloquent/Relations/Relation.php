 ...
 * @template TResult
 *
 * @mixin \Heritage\Database\Eloquent\Builder<TRelatedModel>
 */
abstract class Relation implements BuilderContract
{
     ...
     *
     * @var \Heritage\Database\Eloquent\Builder<TRelatedModel>
     */
    protected $query;
     ...
     *
     * @var array<string, class-string<\Heritage\Database\Eloquent\Model>>
     */
    ...
    {
        return 'ugarit_reserved_'.($incrementJoinCount ? static::$selfJoinCount++ : static::$selfJoinCount);
    }
     ...
     *
     * @param  array<array-key, class-string<\Heritage\Database\Eloquent\Model>>  $map
     * @param  bool  $merge
     * @return array
     */
     ...
     *
     * @param  array<array-key, class-string<\Heritage\Database\Eloquent\Model>>|null  $map
     * @param  bool  $merge
     * @return array<string, class-string<\Heritage\Database\Eloquent\Model>>
     */
     ...
     *
     * @param  array<array-key, class-string<\Heritage\Database\Eloquent\Model>>|null  $models
     * @return array<string, class-string<\Heritage\Database\Eloquent\Model>>|null
     */
     ...
     *
     * @param  class-string<\Heritage\Database\Eloquent\Model>  $className
     * @return int|string
     */
