...
namespace Heritage\Database\Eloquent\Relations\Concerns;
...
trait InteractsWithPivotTable
{
     ...
     *
     * @param  \Heritage\Support\Collection|\Heritage\Database\Eloquent\Model|array|int|string  $ids
     ...
     *
     * @param  \Heritage\Support\Collection|\Heritage\Database\Eloquent\Model|array  $ids
     * @param  bool  $detaching
     * @return array{attached: array, detached: array, updated: array}
     *
     * @throws \Throwable
