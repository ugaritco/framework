...
trait CanBeOneOfMany
{
     ...
     *
     * @var \Heritage\Database\Eloquent\Builder<*>|null
     */
     ...
     *
     * @param  \Heritage\Database\Query\JoinClause  $join
     * @return void
     */
     ...
     *
     * @param  \Heritage\Database\Eloquent\Builder<*>  $parent
     * @param  \Heritage\Database\Eloquent\Builder<*>  $subQuery
