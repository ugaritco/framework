...
use Heritage\Database\Eloquent\Relations\Concerns\AsPivot;
use Heritage\Database\Eloquent\Relations\Concerns\InteractsWithDictionary;
use Heritage\Database\Eloquent\Relations\Concerns\InteractsWithPivotTable;
use Heritage\Database\Eloquent\Relations\Concerns\SupportsPivotInverseRelations;
use Heritage\Database\Query\Grammars\MySqlGrammar;
use Heritage\Database\UniqueConstraintViolationException;
 ...
 *
 * @extends \Heritage\Database\Eloquent\Relations\Relation<TRelatedModel, TDeclaringModel, \Heritage\Database\Eloquent\Collection<int, TRelatedModel&object{pivot: TPivotModel}>>
 *
...
class BelongsToMany extends Relation
{
     ...
     *
     * @var array<string|\Heritage\Contracts\Database\Query\Expression>
     */
     ...
     *
     * @param  \Heritage\Database\Eloquent\Builder<TRelatedModel>|null  $query
     * @return $this
     */
     ...
     *
     * @param  \Heritage\Database\Eloquent\Collection<int, TRelatedModel>  $results
     ...
     *
     * @template TNewPivotModel of \Heritage\Database\Eloquent\Relations\Pivot
     *
     ...
     *
     * @param  (\Closure(\Heritage\Database\Eloquent\Builder<TPivotModel>): mixed)|string|\Heritage\Contracts\Database\Query\Expression  $column
     ...
     *
     * @param  string|\Heritage\Contracts\Database\Query\Expression  $column
     * @param  array  $values
     * @param  string  $boolean
     * @param  bool  $not
     * @return $this
     ...
     *
     * @param  string|\Heritage\Contracts\Database\Query\Expression|array<string, string>  $column
     * @param  mixed  $value
     * @return $this
     *
     ...
     * @param  array  $columns
     * @return (
     *     $id is (\Heritage\Contracts\Support\Arrayable<array-key, mixed>|array<mixed>)
     *     ? \Heritage\Database\Eloquent\Collection<int, TRelatedModel&object{pivot: TPivotModel}>
     ...
     * @return TRelatedModel&object{pivot: TPivotModel}
     *
     * @throws \Heritage\Database\UniqueConstraintViolationException
     */
     ...
     * @return TRelatedModel&object{pivot: TPivotModel}
     *
     * @throws \Heritage\Database\Eloquent\ModelNotFoundException<TRelatedModel>
     ...
     *
     * @param  \Heritage\Contracts\Support\Arrayable|array  $ids
     * @param  array  $columns
     * @return \Heritage\Database\Eloquent\Collection<int, TRelatedModel&object{pivot: TPivotModel}>
     */
     ...
     * @return (
     *     $id is (\Heritage\Contracts\Support\Arrayable<array-key, mixed>|array<mixed>)
     *     ? \Heritage\Database\Eloquent\Collection<int, TRelatedModel&object{pivot: TPivotModel}>|TValue
     ...
     * @param  int|null  $page
     * @return \Heritage\Pagination\LengthAwarePaginator<int, TRelatedModel&object{pivot: TPivotModel}>
     */
     ...
     * @param  string  $pageName
     * @param  int|null  $page
     * @return \Heritage\Contracts\Pagination\Paginator<int, TRelatedModel&object{pivot: TPivotModel}>
     */
     ...
     * @return \Heritage\Contracts\Pagination\CursorPaginator<int, TRelatedModel&object{pivot: TPivotModel}>
     */
     ...
     *
     * @param  int  $chunkSize
     * @return \Heritage\Support\LazyCollection<int, TRelatedModel&object{pivot: TPivotModel}>
     */
     ...
     *
     * @return \Heritage\Database\Eloquent\Builder<TRelatedModel>
     */
     ...
     *
     * @return \Heritage\Support\Collection<int, int|string>
     */
     ...
     *
     * @template TContainer of \Heritage\Support\Collection<array-key, TRelatedModel>|array<array-key, TRelatedModel>
     *
     ...
     *
     * @param  \Heritage\Database\Eloquent\Builder<TRelatedModel>  $query
     * @param  \Heritage\Database\Eloquent\Builder<TDeclaringModel>  $parentQuery
     * @param  mixed  $columns
     * @return \Heritage\Database\Eloquent\Builder<TRelatedModel>
     */
     ...
     *
     * @param  string|\Heritage\Contracts\Database\Query\Expression  $column
     * @return string|\Heritage\Contracts\Database\Query\Expression
     */
