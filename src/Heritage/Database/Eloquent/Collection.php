 ...
 *
 * @extends \Heritage\Support\Collection<TKey, TModel>
 */
class Collection extends BaseCollection implements QueueableCollection
{
     ...
     * @return ($key is (\Heritage\Contracts\Support\Arrayable<array-key, mixed>|array<mixed>) ? static : TModel|TFindDefault)
     */
     ...
     *
     * @param  array<array-key, array|(callable(\Heritage\Database\Eloquent\Relations\Relation<*, *, *>): mixed)|string>|string  $relations
     * @return $this
     */
     ...
     *
     * @param  \Heritage\Database\Eloquent\Collection<int, TModel>  $models
     * @param  array  $path
     * @return void
     */
     ...
     * @param  array<array-key, array|(callable(\Heritage\Database\Eloquent\Relations\Relation<*, *, *>): mixed)|string>  $relations
     * @return $this
     */
     ...
     * @return \Heritage\Support\Collection<TKey, TMapValue>|static<TKey, TMapValue>
     */
     ...
     * @return \Heritage\Support\Collection<TMapWithKeysKey, TMapWithKeysValue>|static<TMapWithKeysKey, TMapWithKeysValue>
     */
     ...
     * {@inheritDoc}
     *
     * @return \Heritage\Support\Collection<array-key, int>
     */
    #[\Override]
     ...
     * {@inheritDoc}
     *
     * @return \Heritage\Support\Collection<int, mixed>
     */
    #[\Override]
     ...
     * {@inheritDoc}
     *
     * @return \Heritage\Support\Collection<TModel, TKey>
     */
    #[\Override]
     ...
     * {@inheritDoc}
     *
     * @return \Heritage\Support\Collection<int, TKey>
     */
    #[\Override]
     ...
     * @template TPadValue
     *
     * @return \Heritage\Support\Collection<int, TModel|TPadValue>
     */
    #[\Override]
     ...
     * {@inheritDoc}
     *
     * @return \Heritage\Support\Collection<int<0, 1>, static<TKey, TModel>>
     */
    #[\Override]
     ...
     * @template TZipValue
     *
     * @return \Heritage\Support\Collection<int, \Heritage\Support\Collection<int, TModel|TZipValue>>
     */
    #[\Override]
     ...
     *
     * @return \Heritage\Database\Eloquent\Builder<TModel>
     *
     * @throws \LogicException
     */
