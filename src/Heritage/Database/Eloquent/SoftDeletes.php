...
/**
 * @method static \Heritage\Database\Eloquent\Builder<static> withTrashed(bool $withTrashed = true)
 * @method static \Heritage\Database\Eloquent\Builder<static> onlyTrashed()
 * @method static \Heritage\Database\Eloquent\Builder<static> withoutTrashed()
...
trait SoftDeletes
{
     ...
     *
     * @param  \Heritage\Events\QueuedClosure|callable|class-string  $callback
     * @return void
     */
