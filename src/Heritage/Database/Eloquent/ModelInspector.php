...
class ModelInspector
{
     ...
     *
     * @param  \Heritage\Contracts\Foundation\Application  $app  The Ugarit application instance.
     */
     ...
     *
     * @param  class-string<\Heritage\Database\Eloquent\Model>|string  $model
     * @param  string|null  $connection
     * @return \Heritage\Database\Eloquent\ModelInfo
     *
    ...
    public function inspect($model, $connection = null)
    {
        ...
        /** @var \Heritage\Database\Eloquent\Model $model */
     ...
     * @return \Heritage\Support\Collection<int, array<string, mixed>>
     */
     ...
     *
     * @param  \Heritage\Database\Eloquent\Model  $model
     * @return class-string<\Heritage\Database\Eloquent\Collection>
     */
     ...
     *
     * @param  TModel  $model
     * @return class-string<\Heritage\Database\Eloquent\Builder<TModel>>
     */
     ...
     *
     * @param  \Heritage\Database\Eloquent\Model  $model
     * @return \Heritage\Http\Resources\Json\JsonResource|null
     */
     ...
     *
     * @see \Heritage\Console\GeneratorCommand
     */
