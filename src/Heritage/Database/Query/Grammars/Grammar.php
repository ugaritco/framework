...
use Heritage\Database\Concerns\CompilesJsonPaths;
use Heritage\Database\Grammar as BaseGrammar;
...
class Grammar extends BaseGrammar
{
     ...
     *
     * @param  \Heritage\Database\Query\Builder  $query
     * @param  array{function: string, columns: array<\Heritage\Contracts\Database\Query\Expression|string>}  $aggregate
     * @return string
     */
    ...
    protected function compileGroupLimit(Builder $query)
    {
        ...
        $table = $this->wrap('ugarit_table');
        $row = $this->wrap('ugarit_row');
    ...
    protected function compileRowNumber($partition, $orders)
    {
        ...
        return ', row_number() over ('.$over.') as '.$this->wrap('ugarit_row');
    }
