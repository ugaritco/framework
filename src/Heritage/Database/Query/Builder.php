...
use Heritage\Contracts\Database\Query\Builder as BuilderContract;
use Heritage\Contracts\Database\Query\ConditionExpression;
...
use Heritage\Database\Concerns\BuildsWhereDateClauses;
use Heritage\Database\Concerns\ExplainsQueries;
use Heritage\Database\ConnectionInterface;
use Heritage\Database\Eloquent\Builder as EloquentBuilder;
use Heritage\Database\Eloquent\Relations\Relation;
use Heritage\Database\Query\Grammars\Grammar;
...
{
    /** @use \Heritage\Database\Concerns\BuildsQueries<\stdClass> */
     ...
     *
     * @var \Heritage\Database\ConnectionInterface
     */
    public $connection;
     ...
     *
     * @var \Heritage\Database\Query\Grammars\Grammar
     */
    public $grammar;
     ...
     *
     * @var \Heritage\Database\Query\Processors\Processor
     */
    public $processor;
     ...
     * @var array{
     *     function: string,
     *     columns: array<\Heritage\Contracts\Database\Query\Expression|string>
     * }|null
     */
    public $aggregate;
     ...
     *
     * @var array<string|\Heritage\Contracts\Database\Query\Expression>|null
     */
    public $columns;
     ...
     *
     * @var \Heritage\Database\Query\Expression|string
     */
    public $from;
     ...
     *
     * @var \Heritage\Database\Query\IndexHint|null
     */
    public $indexHint;
     ...
     *
     * @param  \Closure|\Heritage\Database\Query\Builder|\Heritage\Database\Eloquent\Builder<*>|string  $query
     * @param  string  $as
     * @return $this
     *
     ...
     *
     * @param  \Heritage\Contracts\Database\Query\Expression|literal-string  $expression
     * @param  string  $as
     * @return $this
     */
     ...
     *
     * @param  \Heritage\Contracts\Database\Query\Expression|string  $column
     * @param  \Heritage\Support\Collection<int, float>|\Heritage\Contracts\Support\Arrayable|array<int, float>|string  $vector
     ...
     *
     * @param  \Closure|\Heritage\Database\Query\Builder|\Heritage\Database\Eloquent\Builder<*>|\Heritage\Contracts\Database\Query\Expression|string  $table
     * @param  string|null  $as
     * @return $this
     */
     ...
     *
     * @param  \Heritage\Contracts\Database\Query\Expression|string  $table
     * @param  \Closure|\Heritage\Contracts\Database\Query\Expression|string  $first
     * @param  string|null  $operator
     * @param  \Heritage\Contracts\Database\Query\Expression|string|null  $second
     * @param  string  $type
     * @param  bool  $where
     * @return $this
     */
     ...
     * @param  \Heritage\Contracts\Database\Query\Expression|string  $second
     * @param  string  $type
     * @return $this
     */
     ...
     *
     * @param  \Heritage\Contracts\Database\Query\Expression|string  $table
     * @param  \Closure|\Heritage\Contracts\Database\Query\Expression|string|null  $first
     * @param  string|null  $operator
     * @param  \Heritage\Contracts\Database\Query\Expression|string|null  $second
     * @return $this
     */
     ...
     * @param  string  $type
     * @param  \Heritage\Contracts\Database\Query\Expression|string  $table
     * @return \Heritage\Database\Query\JoinClause
     */
     ...
     * @param  string  $type
     * @param  \Heritage\Contracts\Database\Query\Expression|string  $table
     * @return \Heritage\Database\Query\JoinLateralClause
     */
     ...
     *
     * @param  \Closure|string|array|\Heritage\Contracts\Database\Query\Expression  $column
     ...
     *
     * @param  \Heritage\Contracts\Database\Query\Expression|string|array  $first
     * @param  string|null  $operator
     ...
     *
     * @param  \Heritage\Contracts\Database\Query\Expression|literal-string  $sql
     * @param  mixed  $bindings
     * @param  string  $boolean
     * @return $this
     */
     ...
     *
     * @param  string  $column
     * @param  \Heritage\Contracts\Support\Arrayable|array  $values
     * @param  string  $boolean
     * @param  bool  $not
     * @return $this
     */
     ...
     *
     * @param  string|array|\Heritage\Contracts\Database\Query\Expression  $columns
     * @param  string  $boolean
     * @param  bool  $not
     * @return $this
     */
     ...
     *
     * @param  string|array|\Heritage\Contracts\Database\Query\Expression  $column
     * @return $this
     */
     ...
     *
     * @param  \Heritage\Database\Query\Builder|\Heritage\Database\Eloquent\Builder<*>|\Heritage\Contracts\Database\Query\Expression|string  $column
     * @param  string  $boolean
     * @param  bool  $not
     * @return $this
     */
     ...
     *
     * @param  mixed  $value
     * @param  array{\Heritage\Contracts\Database\Query\Expression|string, \Heritage\Contracts\Database\Query\Expression|string}  $columns
     * @param  string  $boolean
     * @param  bool  $not
     * @return $this
     */
     ...
     *
     * @return \Heritage\Database\Query\Builder
     */
     ...
     *
     * @param  \Heritage\Database\Query\Builder  $query
     * @param  string  $boolean
     * @return $this
     */
     ...
     * @param  \Heritage\Contracts\Database\Query\Expression|string  $column
     * @param  string  $operator
     * @param  \Closure|\Heritage\Database\Query\Builder|\Heritage\Database\Eloquent\Builder<*>  $callback
     * @param  string  $boolean
     * @return $this
     */
     ...
     *
     * @param  \Heritage\Contracts\Database\Query\Expression[]|\Closure[]|string[]  $columns
     * @param  mixed  $operator
     * @param  mixed  $value
     * @param  string  $boolean
     * @return $this
     ...
     *
     * @param  array|\Heritage\Contracts\Database\Query\Expression|string  ...$groups
     * @return $this
     */
     ...
     *
     * @param  \Heritage\Contracts\Database\Query\Expression|\Closure|string  $column
     * @param  \DateTimeInterface|string|int|float|null  $operator
     * @param  \Heritage\Contracts\Database\Query\Expression|\DateTimeInterface|string|int|float|null  $value
     * @param  string  $boolean
     * @return $this
     */
     ...
     *
     * @param  \Closure|\Heritage\Database\Query\Builder|\Heritage\Database\Eloquent\Builder<*>|\Heritage\Contracts\Database\Query\Expression|string  $column
     ...
     *
     * @param  \Closure|\Heritage\Database\Query\Builder|\Heritage\Contracts\Database\Query\Expression|string  $column
     * @return $this
     */
     ...
     *
     * @param  \Heritage\Contracts\Database\Query\Expression|string  $column
     * @param  \Heritage\Support\Collection<int, float>|\Heritage\Contracts\Support\Arrayable|array<int, float>  $vector
     * @return $this
     *
     * @throws \JsonException
     */
     ...
     *
     * @param  \Heritage\Contracts\Database\Query\Expression|string  $column
     * @param  \Heritage\Contracts\Support\Arrayable|array<\UnitEnum|string|int|float|bool>  $values
     * @return $this
     */
     ...
     *
     * @param  \Closure|\Heritage\Database\Query\Builder|\Heritage\Contracts\Database\Query\Expression|string|null  $column
     * @param  SortDirection|'asc'|'desc'  $direction
     * @return $this
     */
     ...
     *
     * @param  \Closure|\Heritage\Database\Query\Builder|\Heritage\Database\Eloquent\Builder<*>  $query
     * @param  bool  $all
     * @return $this
     */
     ...
     *
     * @param  int|string  $id
     * @param  string|\Heritage\Contracts\Database\Query\Expression|array<string|\Heritage\Contracts\Database\Query\Expression>  $columns
     ...
     *
     * @param  mixed  $id
     * @param  (\Closure(): TValue)|string|\Heritage\Contracts\Database\Query\Expression|array<string|\Heritage\Contracts\Database\Query\Expression>  $columns
     ...
     * @return mixed
     *
     * @throws \Heritage\Database\RecordsNotFoundException
     * @throws \Heritage\Database\MultipleRecordsFoundException
     */
     ...
     *
     * @param  string|\Heritage\Contracts\Database\Query\Expression|array<string|\Heritage\Contracts\Database\Query\Expression>  $columns
     * @return \Heritage\Support\Collection<int, \stdClass>
     */
     ...
     *
     * @param  \Heritage\Support\Collection  $items
     * @return \Heritage\Support\Collection
     */
    protected function withoutGroupLimitKeys($items)
    {
        $keysToRemove = ['ugarit_row'];

        if (is_string($this->groupLimit['column'])) {
            $column = last(explode('.', $this->groupLimit['column']));

            $keysToRemove[] = '@ugarit_group := '.$this->grammar->wrap($column);
            $keysToRemove[] = '@ugarit_group := '.$this->grammar->wrap('pivot_'.$column);
        }
     ...
     * @return \Heritage\Pagination\LengthAwarePaginator
     */
     ...
     * @param  string  $pageName
     * @param  int|null  $page
     * @return \Heritage\Contracts\Pagination\Paginator
     */
     ...
     * @param  \Heritage\Pagination\Cursor|string|null  $cursor
     * @return \Heritage\Contracts\Pagination\CursorPaginator
     */
     ...
     *
     * @param  array<string|\Heritage\Contracts\Database\Query\Expression>  $columns
     * @return int<0, max>
     */
     ...
     *
     * @param  array<string|\Heritage\Contracts\Database\Query\Expression>  $columns
     * @return array<string|\Heritage\Contracts\Database\Query\Expression>
     */
     ...
     *
     * @return \Heritage\Support\LazyCollection<int, \stdClass>
     */
     ...
     * @return \Heritage\Support\Collection<array-key, mixed>
     */
     ...
     *
     * @param  \Heritage\Contracts\Database\Query\Expression|string  $columns
     * @return int<0, max>
     */
     ...
     *
     * @param  string  $function
     * @param  array<\Heritage\Contracts\Database\Query\Expression|string>  $columns
     * @return $this
     */
     ...
     *
     * @return \Heritage\Database\ConnectionInterface
     */
     ...
     *
     * @return \Heritage\Database\Query\Processors\Processor
     */
     ...
     *
     * @return \Heritage\Database\Query\Grammars\Grammar
     */
