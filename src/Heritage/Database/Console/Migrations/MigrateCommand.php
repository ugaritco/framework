...
use Heritage\Database\Events\SchemaLoaded;
use Heritage\Database\Migrations\Migrator;
use Heritage\Database\SQLiteDatabaseDoesNotExistException;
...
class MigrateCommand extends BaseCommand implements Isolatable
{
    ...
    protected function createMissingMySqlOrPgsqlDatabase($connection)
    {
        ...
        if ($this->ugarit['config']->get("{$configKey}.database") !==
        ...
        try {
            ...
            $this->ugarit['config']->set("{$configKey}.database", $connection->getDatabaseName());
        }
    }
