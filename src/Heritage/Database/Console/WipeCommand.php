...
use Heritage\Database\Console\Concerns\InteractsWithPooledConnections;
...
class WipeCommand extends Command
{
    ...
    {
        $this->resolveDirectConnectionIfPossible($this->ugarit['db'], $database)
            ->getSchemaBuilder()
            ->dropAllTables();
    }
    ...
    {
        $this->resolveDirectConnectionIfPossible($this->ugarit['db'], $database)->disconnect();
    }
}
