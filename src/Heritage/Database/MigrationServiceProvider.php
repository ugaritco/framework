...
use Heritage\Database\Console\Migrations\InstallCommand;
use Heritage\Database\Console\Migrations\MigrateCommand;
...
use Heritage\Database\Console\Migrations\StatusCommand;
use Heritage\Database\Migrations\DatabaseMigrationRepository;
