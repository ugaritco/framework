...
use Closure;
use Heritage\Contracts\Routing\ResponseFactory as FactoryContract;
...
use Heritage\Routing\Exceptions\StreamedResponseException;
...
class ResponseFactory implements FactoryContract
{
     ...
     *
     * @param  \Heritage\Contracts\View\Factory  $view
    ...
    public function stream($callback, $status = 200, array $headers = [])
    {
        if (! is_null($callback) && (new ReflectionFunction($callback))->isGenerator()) {
            if (isset($_SERVER['UGARIT_OCTANE'])) {
     ...
     * @return \Symfony\Component\HttpFoundation\StreamedResponse
     *
     * @throws \Heritage\Routing\Exceptions\StreamedResponseException
     */
