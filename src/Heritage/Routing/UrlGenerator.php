...
use BackedEnum;
use Closure;
use Heritage\Contracts\Routing\UrlGenerator as UrlGeneratorContract;
...
class UrlGenerator implements UrlGeneratorContract
{
     ...
     *
     * @var \Heritage\Routing\RouteUrlGenerator|null
     */
     ...
     *
     * @param  \Heritage\Routing\RouteCollectionInterface  $routes
     ...
     * @return string
     *
     * @throws \Heritage\Routing\Exceptions\UrlGenerationException
     */
     ...
     * @param  string  $root
     * @param  string  $path
     * @param  \Heritage\Routing\Route|null  $route
     * @return string
     */
     ...
     *
     * @return \Heritage\Routing\RouteUrlGenerator
     */
     ...
     *
     * @return \Heritage\Session\Store|null
     */
