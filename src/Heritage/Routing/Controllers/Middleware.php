...
/**
 * @phpstan-type NextClosure \Closure(\Heritage\Http\Request): \Symfony\Component\HttpFoundation\Response
 */
class Middleware
{
    /**
     ...
     *
     * @param  (\Closure(\Heritage\Http\Request, NextClosure): \Symfony\Component\HttpFoundation\Response)|string|array  $middleware
