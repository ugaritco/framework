...
use Heritage\Routing\Attributes\Controllers\Middleware as MiddlewareAttribute;
use Heritage\Routing\Attributes\Controllers\WithoutMiddleware;
use Heritage\Routing\Contracts\CallableDispatcher;
...
use Heritage\Routing\Matching\HostValidator;
use Heritage\Routing\Matching\MethodValidator;
use Heritage\Routing\Matching\SchemeValidator;
use Heritage\Routing\Matching\UriValidator;
...
class Route
{
    ...
    public function getMissing()
    {
        ...
        return is_string($missing) &&
            Str::startsWith($missing, [
                'O:47:"Ugarit\\SerializableClosure\\SerializableClosure',
                'O:55:"Ugarit\\SerializableClosure\\UnsignedSerializableClosure',
     ...
     *
     * @return \Heritage\Routing\Contracts\ControllerDispatcher
     *
     * @throws \Heritage\Contracts\Container\BindingResolutionException
     */
