...
use Heritage\Contracts\Routing\BindingRegistrar;
use Heritage\Contracts\Routing\Registrar as RegistrarContract;
...
use Heritage\Routing\Events\RouteMatched;
...
/**
 * @mixin \Heritage\Routing\RouteRegistrar
 */
class Router implements BindingRegistrar, RegistrarContract
{
     ...
     *
     * @var \Heritage\Routing\RouteCollectionInterface
     */
    protected $routes;
     ...
     *
     * @var \Heritage\Routing\Route|null
     */
    protected $current;
     ...
     * @param  \Heritage\Container\Container|null  $container
     */
    ...
    {
        return $this->any($uri, '\Heritage\Routing\RedirectController')
    ...
    {
        return $this->match(['GET', 'HEAD'], $uri, '\Heritage\Routing\ViewController')
            ->setDefaults([
                'view' => $view,
                'data' => $data,
     ...
     *
     * @param  \Heritage\Support\Collection  $middlewares
     * @return array
     */
     ...
     *
     * @return \Heritage\Routing\Route|null
     */
     ...
     *
     * @return \Heritage\Routing\RouteCollectionInterface
     */
     ...
     *
     * @param  \Heritage\Routing\RouteCollection  $routes
     * @return void
     */
