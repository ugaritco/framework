...
trait InteractsWithTime
{
     ...
     * Freeze time.
     *
     * @param  (callable(\Heritage\Support\Carbon): TReturn)|null  $callback
     * @return ($callback is null ? \Heritage\Support\Carbon : TReturn)
     */
     ...
     *
     * @param  int  $value
     * @return \Heritage\Foundation\Testing\Wormhole
     */
    ...
    /**
     * @template TReturn of mixed
     * @template TDate of \DateTimeInterface|\Closure|\Heritage\Support\Carbon|string|bool|null
     *
