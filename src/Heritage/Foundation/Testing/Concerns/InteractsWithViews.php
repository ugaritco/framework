...
use Heritage\Support\Facades\View as ViewFacade;
use Heritage\Support\MessageBag;
use Heritage\Support\ViewErrorBag;
use Heritage\Testing\TestComponent;
use Heritage\Testing\TestView;
...
trait InteractsWithViews
{
     ...
     * @return \Heritage\Testing\TestView
     */
    ...
    protected function blade(string $template, $data = [])
    {
        ...
        $tempFileInfo = pathinfo(tempnam($tempDirectory, 'ugarit-blade'));
     ...
     * @param  \Heritage\Contracts\Support\Arrayable|array  $data
     * @return \Heritage\Testing\TestComponent
     */
