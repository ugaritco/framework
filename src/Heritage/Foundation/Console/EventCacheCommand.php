...
use Heritage\Foundation\Support\Providers\EventServiceProvider;
...
class EventCacheCommand extends Command
{
    ...
    public function handle()
    {
        ...
        file_put_contents(
            $this->ugarit->getCachedEventsPath(),
    ...
    protected function getEvents()
    {
        ...
        foreach ($this->ugarit->getProviders(EventServiceProvider::class) as $provider) {
