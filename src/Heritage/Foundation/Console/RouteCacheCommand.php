...
class RouteCacheCommand extends Command
{
    ...
    public function handle()
    {
        ...
        $this->files->put(
            $this->ugarit->getCachedRoutesPath(), $this->buildRouteCacheFile($routes)
        );
     ...
     *
     * @return \Heritage\Routing\RouteCollection
     */
    ...
    {
        return tap(require $this->ugarit->bootstrapPath('app.php'), function ($app) {
            $app->make(ConsoleKernelContract::class)->bootstrap();

            Facade::clearResolvedInstances();

            Facade::setFacadeApplication($this->ugarit);
            Container::setInstance($this->ugarit);
        });
    }
