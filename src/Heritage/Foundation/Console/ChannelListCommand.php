...
class ChannelListCommand extends Command
{
     ...
     *
     * @param  \Heritage\Contracts\Broadcasting\Broadcaster  $broadcaster
     * @return void
     */
    public function handle(Broadcaster $broadcaster)
    {
        ...
        if (! $this->ugarit->providerIsLoaded('App\Providers\BroadcastServiceProvider') &&
            file_exists($this->ugarit->path('Providers/BroadcastServiceProvider.php'))) {
     ...
     *
     * @param  \Heritage\Support\Collection  $channels
     * @return array
     */
