...
class ViewCacheCommand extends Command
{
     ...
     *
     * @param  \Heritage\Support\Collection  $views
     * @return void
     */
    protected function compileViews(Collection $views)
    {
        $compiler = $this->ugarit['view']->getEngineResolver()->resolve('blade')->getCompiler();
    ...
    {
        $extensions = (new Collection($this->ugarit['view']->getExtensions()))
    ...
    {
        $finder = $this->ugarit['view']->getFinder();
