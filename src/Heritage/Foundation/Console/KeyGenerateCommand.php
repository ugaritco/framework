...
class KeyGenerateCommand extends Command
{
    ...
    public function handle()
    {
        ...
        $this->ugarit['config']['app.key'] = $key;
    ...
    protected function generateRandomKey()
    {
        return 'base64:'.base64_encode(
            Encrypter::generateKey($this->ugarit['config']['app.cipher'])
        );
    }
    ...
    {
        $currentKey = $this->ugarit['config']['app.key'];
    ...
    protected function writeNewEnvironmentFileWith($key)
    {
        $replaced = preg_replace(
            ...
            'APP_KEY='.$key,
            $input = file_get_contents($this->ugarit->environmentFilePath())
        );
        ...
        file_put_contents($this->ugarit->environmentFilePath(), $replaced);
    ...
    {
        $escaped = preg_quote('='.$this->ugarit['config']['app.key'], '/');
