...
use Heritage\Foundation\Events\PublishingStubs;
...
class StubPublishCommand extends Command
{
    ...
    {
        if (! is_dir($stubsPath = $this->ugarit->basePath('stubs'))) {
        ...
        $this->ugarit['events']->dispatch($event = new PublishingStubs($stubs));
