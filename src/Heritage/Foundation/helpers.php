...
use Heritage\Broadcasting\FakePendingBroadcast;
use Heritage\Broadcasting\PendingBroadcast;
...
use Heritage\Contracts\Broadcasting\Factory as BroadcastFactory;
use Heritage\Contracts\Bus\Dispatcher;
use Heritage\Contracts\Cookie\Factory as CookieFactory;
...
use Heritage\Contracts\Translation\Translator;
use Heritage\Contracts\Validation\Factory as ValidationFactory;
use Heritage\Contracts\Validation\Validator as ValidatorContract;
use Heritage\Contracts\View\Factory as ViewFactory;
use Heritage\Contracts\View\View as ViewContract;
use Heritage\Cookie\CookieJar;
use Heritage\Foundation\Bus\PendingClosureDispatch;
use Heritage\Foundation\Bus\PendingDispatch;
use Heritage\Foundation\Mix;
use Heritage\Http\Exceptions\HttpResponseException;
use Heritage\Http\RedirectResponse;
use Heritage\Http\Response as HeritageResponse;
...
if (! function_exists('abort')) {
     ...
     *
     * @param  \Symfony\Component\HttpFoundation\Response|\Heritage\Contracts\Support\Responsable|int  $code
     * @param  string  $message
     * @return never
     *
     * @throws \Symfony\Component\HttpKernel\Exception\HttpException
     * @throws \Symfony\Component\HttpKernel\Exception\NotFoundHttpException
     * @throws \Heritage\Http\Exceptions\HttpResponseException
     */
...
if (! function_exists('app')) {
     ...
     * @return ($abstract is class-string<TClass> ? TClass : ($abstract is null ? \Heritage\Foundation\Application : mixed))
     */
...
if (! function_exists('auth')) {
     ...
     * @return ($guard is null ? \Heritage\Contracts\Auth\Factory : \Heritage\Contracts\Auth\Guard)
     */
...
if (! function_exists('cache')) {
     ...
     * @return ($key is null ? \Heritage\Cache\CacheManager : ($key is string ? mixed : bool))
     *
...
if (! function_exists('config')) {
     ...
     * @param  mixed  $default
     * @return ($key is null ? \Heritage\Config\Repository : ($key is string ? mixed : null))
     */
...
if (! function_exists('context')) {
     ...
     * @param  mixed  $default
     * @return ($key is string ? mixed : \Heritage\Log\Context\Repository)
     */
...
if (! function_exists('cookie')) {
     ...
     * @return ($name is null ? \Heritage\Cookie\CookieJar : \Symfony\Component\HttpFoundation\Cookie)
     */
...
if (! function_exists('defer')) {
    ...
    {
        return \Heritage\Support\defer($callback, $name, $always);
    }
}
...
if (! function_exists('dispatch')) {
     ...
     *
     * @param  mixed  $job
     * @return ($job is \Closure ? \Heritage\Foundation\Bus\PendingClosureDispatch : \Heritage\Foundation\Bus\PendingDispatch)
     */
...
if (! function_exists('logs')) {
     ...
     * @return ($driver is null ? \Heritage\Log\LogManager : \Psr\Log\LoggerInterface)
     */
...
if (! function_exists('old')) {
     ...
     * @param  \Heritage\Database\Eloquent\Model|string|array|null  $default
...
if (! function_exists('redirect')) {
     ...
     * @param  array  $headers
     * @param  bool|null  $secure
     * @return ($to is null ? \Heritage\Routing\Redirector : \Heritage\Http\RedirectResponse)
     */
...
if (! function_exists('request')) {
     ...
     * @param  mixed  $default
     * @return ($key is null ? \Heritage\Http\Request : ($key is string ? mixed : array<string, mixed>))
     */
...
if (! function_exists('response')) {
     ...
     *
     * @param  \Heritage\Contracts\View\View|string|array|null  $content
     * @param  int  $status
     * @return ($content is null ? \Heritage\Contracts\Routing\ResponseFactory : \Heritage\Http\Response)
     */
    function response($content = null, $status = 200, array $headers = []): ResponseFactory|HeritageResponse
    {
...
if (! function_exists('session')) {
     ...
     * @param  array<string, mixed>|string|null  $key
     * @param  mixed  $default
     * @return ($key is null ? \Heritage\Session\SessionManager : ($key is string ? mixed : null))
     */
...
if (! function_exists('trans')) {
     ...
     * @param  array  $replace
     * @param  string|null  $locale
     * @return ($key is null ? \Heritage\Contracts\Translation\Translator : array|string)
     */
...
if (! function_exists('url')) {
     ...
     * @param  mixed  $parameters
     * @param  bool|null  $secure
     * @return ($path is null ? \Heritage\Contracts\Routing\UrlGenerator : string)
     */
...
if (! function_exists('validator')) {
     ...
     *
     * @return ($data is null ? \Heritage\Contracts\Validation\Factory : \Heritage\Contracts\Validation\Validator)
     */
...
if (! function_exists('view')) {
     ...
     * @return ($view is null ? \Heritage\Contracts\View\Factory : \Heritage\Contracts\View\View)
     */
