...
class PreventRequestForgery
{
     ...
     *
     * @var \Heritage\Contracts\Encryption\Encrypter
     */
    protected $encrypter;
     ...
     * @param  \Heritage\Contracts\Encryption\Encrypter  $encrypter
     */
     ...
     * @return mixed
     *
     * @throws \Heritage\Session\TokenMismatchException
     * @throws \Heritage\Http\Exceptions\OriginMismatchException
     */
