...
>
    <div class="flex items-center gap-3 w-full">
        ...
        <x-ugarit-exceptions-renderer::http-method method="{{ $request->method() }}" />
        ...
        >
            <x-ugarit-exceptions-renderer::icons.copy class="w-3 h-3 text-neutral-400" x-show="!copied" />
            <x-ugarit-exceptions-renderer::icons.check class="w-3 h-3 text-emerald-500" x-show="copied" />
        </button>
    </div>
</div>
