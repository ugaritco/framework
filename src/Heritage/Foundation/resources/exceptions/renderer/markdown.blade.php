...
## Previous {{ \Heritage\Support\Str::plural('exception', $exception->previousExceptions()->count()) }}
...
{{ $exception->request()->method() }} {{ \Heritage\Support\Str::start($exception->request()->path(), '/') }}
