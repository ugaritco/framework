...
use Heritage\Cache\RateLimiting\Unlimited;
use Heritage\Console\View\Components\BulletList;
use Heritage\Console\View\Components\Error;
...
use Heritage\Http\Exceptions\OriginMismatchException;
...
use Heritage\Support\ViewErrorBag;
...
class Handler implements ExceptionHandlerContract
{
     ...
     *
     * @var \Heritage\Foundation\Exceptions\ReportableHandler[]
     */
     ...
     * @return \Heritage\Foundation\Exceptions\ReportableHandler
     */
    ...
    protected function shouldntReport(Throwable $e)
    {
        ...
        return rescue(fn () => with($this->throttle($e), function ($throttle) use ($e) {
            ...
            return ! $this->container->make(RateLimiter::class)->attempt(
                with($throttle->key ?: 'heritage:foundation:exceptions:'.$e::class, fn ($key) => $this->hashThrottleKeys ? hash('xxh128', $key) : $key),
     ...
     *
     * @param  \Throwable  $e
     * @return \Heritage\Support\Lottery|\Heritage\Cache\RateLimiting\Limit|null
     */
     ...
     * @param  \Heritage\Http\Request  $request
     * @param  \Throwable  $e
     * @return \Heritage\Http\Response|\Heritage\Http\JsonResponse|\Heritage\Http\RedirectResponse
     */
     ...
     *
     * @param  \Heritage\Http\Request  $request
     * @param  \Heritage\Auth\AuthenticationException  $exception
     * @return \Heritage\Http\Response|\Heritage\Http\JsonResponse|\Heritage\Http\RedirectResponse
     */
     ...
     *
     * @param  \Heritage\Validation\ValidationException  $e
     * @param  \Heritage\Http\Request  $request
     * @return \Symfony\Component\HttpFoundation\Response
     */
     ...
     *
     * @param  \Heritage\Http\Request  $request
     * @param  \Heritage\Validation\ValidationException  $exception
     * @return \Heritage\Http\Response|\Heritage\Http\JsonResponse|\Heritage\Http\RedirectResponse
     */
     ...
     *
     * @param  callable(\Heritage\Http\Request $request, \Throwable): bool  $callback
     * @return $this
     */
    ...
    protected function prepareResponse($request, Throwable $e)
    {
        if (! $this->isHttpException($e) && config('app.debug')) {
            return $this->toHeritageResponse($this->convertExceptionToResponse($e), $e)->prepare($request);
        }
        ...
        return $this->toHeritageResponse(
    ...
    /**
     * Map the given exception into an Heritage response.
     *
     * @param  \Symfony\Component\HttpFoundation\Response  $response
     * @param  \Throwable  $e
     * @return \Heritage\Http\Response|\Heritage\Http\RedirectResponse
     */
    protected function toHeritageResponse($response, Throwable $e)
    {
