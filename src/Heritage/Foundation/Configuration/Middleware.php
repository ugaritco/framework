...
namespace Heritage\Foundation\Configuration;
...
use Heritage\Routing\Middleware\ValidateSignature;
...
class Middleware
{
    ...
    public function getGlobalMiddleware()
    {
        $middleware = $this->global ?: array_values(array_filter([
            \Heritage\Http\Middleware\ValidatePathEncoding::class,
            \Heritage\Foundation\Http\Middleware\InvokeDeferredCallbacks::class,
            $this->trustHosts ? \Heritage\Http\Middleware\TrustHosts::class : null,
    ...
    public function getMiddlewareGroups()
    {
        $middleware = [
            ...
            'api' => array_values(array_filter([
                $this->statefulApi ? \Ugarit\Sanctum\Http\Middleware\EnsureFrontendRequestsAreStateful::class : null,
     ...
     *
     * @param  array<int, (\Closure(\Heritage\Http\Request): bool)>  $except
     * @return $this
     */
     ...
     *
     * @param  array<int, (\Closure(\Heritage\Http\Request): bool)|string>  $except
     * @return $this
     */
    ...
    /**
     * Indicate that Ugarit's throttling middleware should use Redis.
     *
     * @return $this
     */
    ...
    {
        $aliases = [
            'auth' => \Heritage\Auth\Middleware\Authenticate::class,
            'auth.basic' => \Heritage\Auth\Middleware\AuthenticateWithBasicAuth::class,
            'auth.session' => \Heritage\Session\Middleware\AuthenticateSession::class,
            'cache.headers' => \Heritage\Http\Middleware\SetCacheHeaders::class,
            'can' => \Heritage\Auth\Middleware\Authorize::class,
            'guest' => \Heritage\Auth\Middleware\RedirectIfAuthenticated::class,
            'password.confirm' => \Heritage\Auth\Middleware\RequirePassword::class,
            'precognitive' => \Heritage\Foundation\Http\Middleware\HandlePrecognitiveRequests::class,
            'signed' => \Heritage\Routing\Middleware\ValidateSignature::class,
            ...
            'verified' => \Heritage\Auth\Middleware\EnsureEmailIsVerified::class,
        ];
