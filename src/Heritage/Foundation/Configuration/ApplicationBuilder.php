...
use Heritage\Foundation\Events\DiagnosingHealth;
use Heritage\Foundation\Http\Middleware\PreventRequestsDuringMaintenance;
use Heritage\Foundation\Support\Providers\EventServiceProvider as AppEventServiceProvider;
use Heritage\Foundation\Support\Providers\RouteServiceProvider as AppRouteServiceProvider;
use Heritage\Http\Middleware\PrefersJsonResponses;
...
class ApplicationBuilder
{
    ...
    {
        $this->app->singleton(
            \Heritage\Contracts\Http\Kernel::class,
            \Heritage\Foundation\Http\Kernel::class,
        );

        $this->app->singleton(
            \Heritage\Contracts\Console\Kernel::class,
            \Heritage\Foundation\Console\Kernel::class,
        );
    ...
    /**
     * Register additional Scribe commands with the application.
     *
    ...
    /**
     * Register additional Scribe route paths.
     *
     * @param  array  $paths
     * @return $this
     */
     ...
     *
     * @param  callable(\Heritage\Console\Scheduling\Schedule $schedule): void  $callback
     * @return $this
     */
    public function withSchedule(callable $callback)
    {
        Scribe::starting(function () use ($callback) {
     ...
     *
     * @param  (callable(\Heritage\Foundation\Configuration\Exceptions): mixed)|null  $using
     * @return $this
     */
    public function withExceptions(?callable $using = null)
    {
        $this->app->singleton(
            \Heritage\Contracts\Debug\ExceptionHandler::class,
            \Heritage\Foundation\Exceptions\Handler::class
        );
     ...
     *
     * @return \Heritage\Foundation\Application
     */
