...
use Heritage\Contracts\Encryption\StringEncrypter;
use Heritage\Http\Client\ConnectionException;
use Heritage\Queue\Failed\CountableFailedJobProvider;
use Heritage\Queue\Failed\FailedJobProviderInterface;
use Heritage\Queue\Failed\PrunableFailedJobProvider;
...
class FailedJobProvider implements FailedJobProviderInterface, CountableFailedJobProvider, PrunableFailedJobProvider
{
     ...
     *
     * @var ?\Heritage\Foundation\Cloud\Queue
     */
     ...
     *
     * @param  \Heritage\Foundation\Cloud\Queue  $queue
     * @return $this
     */
