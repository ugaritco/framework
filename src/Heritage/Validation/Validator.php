...
use Heritage\Contracts\Validation\Rule as RuleContract;
...
use Heritage\Support\ValidatedInput;
...
class Validator implements ValidatorContract
{
     ...
     *
     * @var \Heritage\Contracts\Translation\Translator
     */
     ...
     *
     * @var \Heritage\Validation\PresenceVerifierInterface
     */
     ...
     *
     * @var \Heritage\Support\MessageBag
     */
    protected $messages;
     ...
     *
     * @var class-string<\Heritage\Validation\ValidationException>
     */
     ...
     *
     * @param  \Heritage\Contracts\Translation\Translator  $translator
     * @param  array  $data
     * @param  array  $rules
     ...
     * @return ($keys is array ? array<string, mixed> : \Heritage\Support\ValidatedInput)
     *
     * @throws \Heritage\Validation\ValidationException
     */
     ...
     * @param  string  $attribute
     * @param  mixed  $value
     * @param  \Heritage\Contracts\Validation\Rule  $rule
     * @return void
     */
     ...
     * @return \Heritage\Support\Fluent|mixed
     */
     ...
     * @return \Heritage\Validation\PresenceVerifierInterface
     *
     ...
     *
     * @param  \Heritage\Validation\PresenceVerifierInterface  $presenceVerifier
     * @return void
     */
     ...
     *
     * @return class-string<\Heritage\Validation\ValidationException>
     */
     ...
     *
     * @param  class-string<\Heritage\Validation\ValidationException>  $exception
     * @return $this
     *
     ...
     *
     * @return \Heritage\Contracts\Translation\Translator
     */
