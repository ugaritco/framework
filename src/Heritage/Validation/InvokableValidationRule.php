...
use Heritage\Contracts\Validation\InvokableRule;
...
use Heritage\Translation\CreatesPotentiallyTranslatedStrings;
...
class InvokableValidationRule implements Rule, ValidatorAwareRule
{
     ...
     *
     * @var \Heritage\Contracts\Validation\ValidationRule|\Heritage\Contracts\Validation\InvokableRule
     */
    protected $invokable;
     ...
     *
     * @param  \Heritage\Contracts\Validation\ValidationRule|\Heritage\Contracts\Validation\InvokableRule  $invokable
     */
     ...
     *
     * @param  \Heritage\Contracts\Validation\ValidationRule|\Heritage\Contracts\Validation\InvokableRule  $invokable
     * @return \Heritage\Validation\InvokableValidationRule
     */
     ...
     *
     * @return \Heritage\Contracts\Validation\ValidationRule|\Heritage\Contracts\Validation\InvokableRule
     */
