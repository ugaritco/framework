...
/**
 * @mixin \Heritage\Console\Scheduling\PendingEventAttributes
 */
class Schedule
{
    use Macroable {
     ...
     *
     * @var \Heritage\Console\Scheduling\Event[]
     */
    protected $events = [];
     ...
     *
     * @var \Heritage\Console\Scheduling\EventMutex
     */
     ...
     *
     * @var \Heritage\Console\Scheduling\SchedulingMutex
     */
     ...
     *
     * @var \Heritage\Contracts\Bus\Dispatcher
     */
     ...
     *
     * @var \Heritage\Console\Scheduling\PendingEventAttributes|null
     */
    ...
    public function __construct($timezone = null)
    {
        ...
        if (! class_exists(Container::class)) {
            throw new RuntimeException(
                'A container implementation is required to use the scheduler. Please install the heritage/container package.'
            );
        }
     ...
     * @return \Heritage\Console\Scheduling\CallbackEvent
     */
    ...
    /**
     * Add a new Scribe command event to the schedule.
     *
     * @param  \Symfony\Component\Console\Command\Command|string  $command
     * @param  array  $parameters
     * @return \Heritage\Console\Scheduling\Event
     */
    ...
    protected function dispatchToQueue($job, $queue, $connection)
    {
        if ($job instanceof Closure) {
            if (! class_exists(CallQueuedClosure::class)) {
                throw new RuntimeException(
                    'To enable support for closure jobs, please install the heritage/queue package.'
                );
            }
     ...
     *
     * @return \Heritage\Contracts\Bus\Dispatcher
     *
     * @throws \RuntimeException
     */
    protected function getDispatcher()
    {
        if ($this->dispatcher === null) {
            try {
                ...
                throw new RuntimeException(
                    'Unable to resolve the dispatcher from the service container. Please bind it or install the heritage/bus package.',
