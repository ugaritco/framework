...
class Event
{
     ...
     *
     * @param  \Heritage\Console\Scheduling\EventMutex  $mutex
    ...
    protected function execute($container)
    {
        ...
        return Process::fromShellCommandline(
            $this->buildCommand(), base_path(), ['__UGARIT_CONTEXT' => $context], null, null
        )->run(
            ugarit_cloud()
     ...
     *
     * @param  \Heritage\Contracts\Mail\Mailer  $mailer
    ...
    public static function normalizeCommand($command)
    {
        return str_replace([
            ...
            Application::scribeBinary(),
        ], [
            'php',
            preg_replace("#['\"]#", '', Application::scribeBinary()),
        ], $command);
    }
}
