...
use Heritage\Contracts\Process\InvokedProcess as InvokedProcessContract;
...
class FakeInvokedProcess implements InvokedProcessContract
{
     ...
     *
     * @var \Heritage\Process\FakeProcessDescription
     */
    protected $process;
     ...
     * @param  \Heritage\Process\FakeProcessDescription  $process
     */
