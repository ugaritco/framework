...
class FakeProcessSequence
{
     ...
     *
     * @var \Heritage\Contracts\Process\ProcessResult|\Heritage\Process\FakeProcessDescription
     */
     ...
     *
     * @param  \Heritage\Contracts\Process\ProcessResult|\Heritage\Process\FakeProcessDescription|array|string  $process
     * @return $this
     */
     ...
     *
     * @param  \Heritage\Contracts\Process\ProcessResult|\Heritage\Process\FakeProcessDescription|array|string  $process
     * @return \Heritage\Contracts\Process\ProcessResult|\Heritage\Process\FakeProcessDescription
     */
