...
namespace Heritage\Process;

use Closure;
use Heritage\Contracts\Process\ProcessResult as ProcessResultContract;
...
class Factory
{
     ...
     * @param  int  $exitCode
     * @return \Heritage\Process\FakeProcessResult
     */
     ...
     *
     * @return \Heritage\Process\FakeProcessDescription
     */
     ...
     * @return \Heritage\Process\FakeProcessSequence
     */
     ...
     *
     * @param  \Heritage\Process\PendingProcess  $process
     * @param  \Heritage\Contracts\Process\ProcessResult  $result
     * @return $this
     */
     ...
     * @return \Heritage\Contracts\Process\ProcessResult
     */
     ...
     * @return \Heritage\Process\ProcessPoolResults
     */
     ...
     *
     * @return \Heritage\Process\PendingProcess
     */
