...
class MailChannel
{
     ...
     *
     * @var \Heritage\Contracts\Mail\Factory
     */
    protected $mailer;
     ...
     *
     * @param  \Heritage\Contracts\Mail\Factory  $mailer
     * @param  \Heritage\Mail\Markdown  $markdown
     */
     ...
     * @param  mixed  $notifiable
     * @param  \Heritage\Notifications\Notification  $notification
     * @param  \Heritage\Notifications\Messages\MailMessage  $message
     * @return \Closure
     */
    ...
    {
        return [
            '__ugarit_notification_id' => $notification->id,
            '__ugarit_notification' => get_class($notification),
            '__ugarit_notification_queued' => in_array(
                ShouldQueue::class,
     ...
     *
     * @param  \Heritage\Mail\Message  $mailMessage
     * @param  mixed  $notifiable
     * @param  \Heritage\Notifications\Notification  $notification
     * @param  \Heritage\Notifications\Messages\MailMessage  $message
     * @return void
