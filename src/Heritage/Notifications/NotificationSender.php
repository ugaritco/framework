...
use Heritage\Notifications\Events\NotificationFailed;
use Heritage\Notifications\Events\NotificationSending;
use Heritage\Notifications\Events\NotificationSent;
use Heritage\Notifications\Events\NotificationSkipped;
...
class NotificationSender
{
     ...
     *
     * @var \Heritage\Notifications\ChannelManager
     */
    protected $manager;
     ...
     * @param  \Heritage\Contracts\Bus\Dispatcher  $bus
     ...
     *
     * @param  mixed  $notifiables
     * @return \Heritage\Database\Eloquent\Collection|array
     */
