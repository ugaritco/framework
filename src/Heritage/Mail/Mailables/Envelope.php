...
class Envelope
{
     ...
     *
     * @var \Heritage\Mail\Mailables\Address|string|null
     */
    public $from;
     ...
     *
     * @param  \Heritage\Mail\Mailables\Address|string|null  $from
     * @param  array<int, \Heritage\Mail\Mailables\Address|string>  $to
     * @param  array<int, \Heritage\Mail\Mailables\Address|string>  $cc
     * @param  array<int, \Heritage\Mail\Mailables\Address|string>  $bcc
     * @param  array<int, \Heritage\Mail\Mailables\Address|string>  $replyTo
     ...
     *
     * @param  array<int, \Heritage\Mail\Mailables\Address|string>  $addresses
     * @return array<int, \Heritage\Mail\Mailables\Address>
     */
     ...
     *
     * @param  \Heritage\Mail\Mailables\Address|string  $address
     ...
     *
     * @param  \Heritage\Mail\Mailables\Address|array<int, \Heritage\Mail\Mailables\Address|string>|string  $address
     * @param  string|null  $name
     * @return $this
     */
