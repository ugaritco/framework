...
use Heritage\Contracts\Mail\Mailer as MailerContract;
use Heritage\Contracts\Mail\MailQueue as MailQueueContract;
...
class Mailer implements MailerContract, MailQueueContract
{
     ...
     *
     * @param  string  $name
     * @param  \Heritage\Contracts\View\Factory  $views
     * @param  \Symfony\Component\Mailer\Transport\TransportInterface  $transport
     * @param  \Heritage\Contracts\Events\Dispatcher|null  $events
     */
     ...
     *
     * @param  \Heritage\Mail\SentMessage  $message
     * @param  array  $data
     * @return void
     */
