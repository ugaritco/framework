...
use Closure;
use Heritage\Contracts\Mail\Factory as FactoryContract;
use Heritage\Log\LogManager;
use Heritage\Mail\Transport\ArrayTransport;
use Heritage\Mail\Transport\CloudflareTransport;
use Heritage\Mail\Transport\LogTransport;
use Heritage\Mail\Transport\ResendTransport;
use Heritage\Mail\Transport\SesTransport;
use Heritage\Mail\Transport\SesV2Transport;
use Heritage\Support\Arr;
use Heritage\Support\ConfigurationUrlParser;
...
class MailManager implements FactoryContract
{
     ...
     *
     * @param  array  $config
     * @return \Heritage\Mail\Transport\SesTransport
     */
     ...
     *
     * @param  array  $config
     * @return \Heritage\Mail\Transport\SesV2Transport
     */
     ...
     *
     * @param  array  $config
     * @return \Heritage\Mail\Transport\ResendTransport
     */
     ...
     *
     * @param  array  $config
     * @return \Heritage\Mail\Transport\CloudflareTransport
     */
    ...
    protected function createRoundrobinTransportOfClass(array $config, string $class)
    {
        ...
        foreach ($config['mailers'] as $name) {
            ...
            // with any Ugarit <= 6.x application style mail configuration files.
     ...
     *
     * @param  array  $config
     * @return \Heritage\Mail\Transport\LogTransport
     */
     ...
     *
     * @return \Heritage\Mail\Transport\ArrayTransport
     */
     ...
     *
     * @param  \Heritage\Mail\Mailer  $mailer
     * @param  array  $config
     * @param  string  $type
     * @return void
     */
    ...
    protected function getConfig(string $name)
    {
        ...
        // provide "BC" for any Ugarit <= 6.x style mail configuration files.
    ...
    public function getDefaultDriver()
    {
        ...
        // of the Ugarit mail configuration file for backwards compatibility.
