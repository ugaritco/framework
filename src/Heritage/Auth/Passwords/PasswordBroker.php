...
namespace Heritage\Auth\Passwords;

use Closure;
use Heritage\Auth\Events\PasswordResetLinkSent;
use Heritage\Contracts\Auth\CanResetPassword as CanResetPasswordContract;
use Heritage\Contracts\Auth\PasswordBroker as PasswordBrokerContract;
...
class PasswordBroker implements PasswordBrokerContract
{
     ...
     *
     * @var \Heritage\Auth\Passwords\TokenRepositoryInterface
     */
    protected $tokens;
     ...
     *
     * @var \Heritage\Contracts\Auth\UserProvider
     */
    protected $users;
     ...
     *
     * @param  \Heritage\Auth\Passwords\TokenRepositoryInterface  $tokens
     * @param  \Heritage\Contracts\Auth\UserProvider  $users
     ...
     *
     * @param  array  $credentials
     * @return \Heritage\Contracts\Auth\CanResetPassword|string
     */
     ...
     *
     * @param  array  $credentials
     * @return \Heritage\Contracts\Auth\CanResetPassword|null
     *
     ...
     *
     * @param  \Heritage\Contracts\Auth\CanResetPassword  $user
     * @return string
     */
     ...
     *
     * @return \Heritage\Auth\Passwords\TokenRepositoryInterface
     */
