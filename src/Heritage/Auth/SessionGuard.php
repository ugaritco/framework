...
use Heritage\Auth\Events\Attempting;
use Heritage\Auth\Events\Authenticated;
use Heritage\Auth\Events\CurrentDeviceLogout;
use Heritage\Auth\Events\Failed;
use Heritage\Auth\Events\Login;
use Heritage\Auth\Events\Logout;
use Heritage\Auth\Events\OtherDeviceLogout;
use Heritage\Auth\Events\Validated;
use Heritage\Contracts\Auth\Authenticatable as AuthenticatableContract;
use Heritage\Contracts\Auth\StatefulGuard;
use Heritage\Contracts\Auth\SupportsBasicAuth;
use Heritage\Contracts\Auth\UserProvider;
use Heritage\Contracts\Cookie\QueueingFactory as CookieJar;
use Heritage\Contracts\Events\Dispatcher;
use Heritage\Contracts\Session\Session;
...
class SessionGuard implements StatefulGuard, SupportsBasicAuth
{
     ...
     *
     * @var \Heritage\Contracts\Session\Session
     */
    protected $session;

    /**
     * The Heritage cookie creator service.
     *
     * @var \Heritage\Contracts\Cookie\QueueingFactory
     */
    protected $cookie;
     ...
     *
     * @param  string  $name
     * @param  \Heritage\Contracts\Auth\UserProvider  $provider
     * @param  \Heritage\Contracts\Session\Session  $session
     * @param  \Symfony\Component\HttpFoundation\Request|null  $request
     * @param  \Heritage\Support\Timebox|null  $timebox
     ...
     *
     * @param  \Heritage\Auth\Recaller  $recaller
     * @return mixed
     */
     ...
     *
     * @return \Heritage\Auth\Recaller|null
     */
     ...
     *
     * @return \Heritage\Contracts\Cookie\QueueingFactory
     *
     ...
     *
     * @param  \Heritage\Contracts\Cookie\QueueingFactory  $cookie
     * @return void
     */
     ...
     *
     * @return \Heritage\Contracts\Events\Dispatcher
     */
     ...
     *
     * @return \Heritage\Contracts\Session\Session
     */
     ...
     *
     * @return \Heritage\Support\Timebox
     */
