...
use Closure;
use Heritage\Contracts\Auth\Factory as FactoryContract;
...
/**
 * @mixin \Heritage\Contracts\Auth\Guard
 * @mixin \Heritage\Contracts\Auth\StatefulGuard
 */
class AuthManager implements FactoryContract
{
     ...
     * @param  string  $name
     * @param  array  $config
     * @return \Heritage\Auth\SessionGuard
     */
     ...
     * @param  string  $name
     * @param  array  $config
     * @return \Heritage\Auth\TokenGuard
     */
