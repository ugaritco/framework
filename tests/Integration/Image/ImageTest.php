...
namespace Heritage\Tests\Integration\Image;
...
class ImageTest extends TestCase
{
    ...
    public function test_from_path_facade_creates_image()
    {
        ...
        $image = \Heritage\Support\Facades\Image::fromPath($file->getRealPath());
    ...
    public function test_from_bytes_facade_creates_image()
    {
        ...
        $image = \Heritage\Support\Facades\Image::fromBytes($contents);
    ...
    public function test_from_base64_facade_creates_image()
    {
        ...
        $image = \Heritage\Support\Facades\Image::fromBase64(base64_encode($contents));
