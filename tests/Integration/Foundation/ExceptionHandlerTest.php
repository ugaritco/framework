...
class ExceptionHandlerTest extends TestCase
{
    ...
    {
        $app->singleton('Heritage\Contracts\Debug\ExceptionHandler', 'Heritage\Foundation\Exceptions\Handler');
    }
...
\$ugarit = Orchestra\Testbench\Foundation\Application::create(basePath: '$basePath', options: ['extra' => ['providers' => $providers]]);
\$ugarit->singleton('Heritage\Contracts\Debug\ExceptionHandler', 'Heritage\Foundation\Exceptions\Handler');

\$kernel = \$ugarit[Heritage\Contracts\Console\Kernel::class];
...
EOF, __DIR__.'/../../../', ['APP_RUNNING_IN_CONSOLE' => true]);
    ...
    public function test_it_reports_request_exceptions()
    {
        ...
        try {
            Http::throw()->get('http://ugarit.test');
