...
class RenderBladeFilesTest extends TestCase
{
    ...
    public function testFormattedSourceTooltipRendersMultilineSafely(): void
    {
        ...
        $path = package_path('src/Heritage/Foundation/resources/exceptions/renderer/components/formatted-source.blade.php');
    ...
    public function testQueryTooltipRendersMultilineSafely(): void
    {
        ...
        $path = package_path('src/Heritage/Foundation/resources/exceptions/renderer/components/query.blade.php');
    ...
    public function testRequestHeaderTooltipRendersMultilineSafely(): void
    {
        ...
        $path = package_path('src/Heritage/Foundation/resources/exceptions/renderer/components/request-header.blade.php');
    ...
    public function testRoutingTooltipRendersMultilineSafely(): void
    {
        ...
        $path = package_path('src/Heritage/Foundation/resources/exceptions/renderer/components/routing.blade.php');
