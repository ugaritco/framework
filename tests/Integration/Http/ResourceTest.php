...
use Heritage\Foundation\Http\Middleware\ValidatePostSize;
use Heritage\Http\Exceptions\PostTooLargeException;
use Heritage\Http\Request;
use Heritage\Http\Resources\ConditionallyLoadsAttributes;
use Heritage\Http\Resources\Json\JsonResource;
use Heritage\Http\Resources\Json\ResourceCollection;
use Heritage\Http\Resources\JsonApi\AnonymousResourceCollection;
use Heritage\Http\Resources\MergeValue;
use Heritage\Http\Resources\MissingValue;
use Heritage\Pagination\Cursor;
...
use Heritage\Tests\Integration\Http\Fixtures\Author;
use Heritage\Tests\Integration\Http\Fixtures\AuthorResourceWithOptionalRelationship;
use Heritage\Tests\Integration\Http\Fixtures\EmptyPostCollectionResource;
use Heritage\Tests\Integration\Http\Fixtures\ObjectResource;
use Heritage\Tests\Integration\Http\Fixtures\Post;
use Heritage\Tests\Integration\Http\Fixtures\PostCollectionResource;
use Heritage\Tests\Integration\Http\Fixtures\PostCollectionResourceWithPaginationInformation;
use Heritage\Tests\Integration\Http\Fixtures\PostModelCollectionResource;
use Heritage\Tests\Integration\Http\Fixtures\PostResource;
use Heritage\Tests\Integration\Http\Fixtures\PostResourceWithAnonymousResourceCollectionWithPaginationInformation;
use Heritage\Tests\Integration\Http\Fixtures\PostResourceWithExtraData;
use Heritage\Tests\Integration\Http\Fixtures\PostResourceWithJsonOptions;
use Heritage\Tests\Integration\Http\Fixtures\PostResourceWithJsonOptionsAndTypeHints;
use Heritage\Tests\Integration\Http\Fixtures\PostResourceWithOptionalAppendedAttributes;
use Heritage\Tests\Integration\Http\Fixtures\PostResourceWithOptionalAttributes;
use Heritage\Tests\Integration\Http\Fixtures\PostResourceWithOptionalData;
use Heritage\Tests\Integration\Http\Fixtures\PostResourceWithOptionalHasAttributes;
use Heritage\Tests\Integration\Http\Fixtures\PostResourceWithOptionalMerging;
use Heritage\Tests\Integration\Http\Fixtures\PostResourceWithOptionalPivotRelationship;
use Heritage\Tests\Integration\Http\Fixtures\PostResourceWithOptionalRelationship;
use Heritage\Tests\Integration\Http\Fixtures\PostResourceWithOptionalRelationshipAggregates;
use Heritage\Tests\Integration\Http\Fixtures\PostResourceWithOptionalRelationshipCounts;
use Heritage\Tests\Integration\Http\Fixtures\PostResourceWithOptionalRelationshipExists;
use Heritage\Tests\Integration\Http\Fixtures\PostResourceWithOptionalRelationshipUsingNamedParameters;
use Heritage\Tests\Integration\Http\Fixtures\PostResourceWithoutWrap;
use Heritage\Tests\Integration\Http\Fixtures\PostResourceWithUnlessOptionalData;
use Heritage\Tests\Integration\Http\Fixtures\ReallyEmptyPostResource;
use Heritage\Tests\Integration\Http\Fixtures\ResourceWithPreservedKeys;
use Heritage\Tests\Integration\Http\Fixtures\SerializablePostResource;
use Heritage\Tests\Integration\Http\Fixtures\Subscription;
use LogicException;
...
class ResourceTest extends TestCase
{
    ...
    {
        Route::get('/', function () {
            $collection = collect([new Post(['id' => 2, 'title' => 'Ugarit Nova'])]);
            $paginator = new LengthAwarePaginator(
                $collection, 3, 1, 2
            );
        ...
        $response = $this->withoutExceptionHandling()->get(
            '/?framework=ugarit&author=Otwell&page=2', ['Accept' => 'application/json']
        );
        ...
        $response->assertJson([
            ...
            'links' => [
                'first' => '/?framework=ugarit&author=Otwell&page=1',
                'last' => '/?framework=ugarit&author=Otwell&page=3',
                'prev' => '/?framework=ugarit&author=Otwell&page=1',
                'next' => '/?framework=ugarit&author=Otwell&page=3',
            ],
            'meta' => [
                'current_page' => 2,
                'from' => 2,
    ...
    public function testCursorPaginatorResourceCanPreserveQueryParameters()
    {
        ...
        $response = $this->withoutExceptionHandling()->get(
            '/?framework=ugarit&author=Otwell', ['Accept' => 'application/json']
        );
        ...
        $response->assertJson([
            ...
            'links' => [
                ...
                'last' => null,
                'prev' => null,
                'next' => '/?framework=ugarit&author=Otwell&cursor='.(new Cursor(['id' => 5]))->encode(),
            ],
            'meta' => [
                'path' => '/',
                'per_page' => 1,
