...
class CookieSessionHandlerTest extends TestCase
{
    public function testCookieSessionDriverCookiesCanExpireOnClose()
    {
        ...
        $response = $this->get('/');
        $sessionIdCookie = $response->getCookie('ugarit_session');
    ...
    public function testCookieSessionInheritsRequestSecureState()
    {
        ...
        $unsecureSessionIdCookie = $unsecureResponse->getCookie('ugarit_session');
        ...
        $secureSessionIdCookie = $secureResponse->getCookie('ugarit_session');
