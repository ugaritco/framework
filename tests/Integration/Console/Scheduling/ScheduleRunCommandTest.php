...
class ScheduleRunCommandTest extends TestCase
{
    ...
    public function test_overlapping_task_finished_event_indicates_skipped()
    {
        ...
        {
            public function create(\Heritage\Console\Scheduling\Event $event)
            {
                return false;
            }

            public function exists(\Heritage\Console\Scheduling\Event $event)
            {
                return false;
            }

            public function forget(\Heritage\Console\Scheduling\Event $event)
            {
                //
            }
        });
