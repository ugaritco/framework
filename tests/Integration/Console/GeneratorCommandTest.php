...
class GeneratorCommandTest extends TestCase
{
    ...
    {
        $this->scribe('make:command', ['name' => 'FooCommand.php'])
            ->assertExitCode(0);
    ...
    {
        $this->scribe('make:view', ['name' => 'foo.php'])
            ->assertExitCode(0);
    ...
    {
        $this->scribe('make:test', ['name' => 'fixtures.php/SomeTest'])
            ->assertExitCode(0);
    ...
    {
        $this->scribe('make:command', ['name' => $given])
