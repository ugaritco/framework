...
class RouteViewTest extends TestCase
{
    ...
    {
        Route::view('route', 'view', ['foo' => 'bar'], 418, ['Framework' => 'Ugarit']);

        View::addLocation(dirname(__DIR__, 2).'/Routing/Fixtures');

        $this->assertSame('Ugarit', $this->get('/route')->headers->get('Framework'));
    }

    public function testRouteViewOverloadingStatusWithHeaders()
    {
        Route::view('route', 'view', ['foo' => 'bar'], ['Framework' => 'Ugarit']);
