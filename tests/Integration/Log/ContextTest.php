...
use Heritage\Contracts\Log\ContextLogProcessor;
use Heritage\Database\Eloquent\Model;
use Heritage\Foundation\Testing\LazilyRefreshDatabase;
use Heritage\Log\Context\Events\ContextDehydrating as Dehydrating;
use Heritage\Log\Context\Events\ContextHydrated as Hydrated;
...
class ContextTest extends TestCase
{
    ...
    public function test_it_can_serialize_values()
    {
        ...
        $this->assertSame([
            'data' => [
                ...
                'enum' => 'E:43:"Heritage\Tests\Integration\Log\Suit:Clubs";',
                'backed_enum' => 'E:55:"Heritage\Tests\Integration\Log\StringBackedSuit:Clubs";',
            ],
            'hidden' => [
                'number' => 'i:55;',
            ],
    ...
    public function test_it_adds_context_to_logging()
    {
        ...
        $log = Str::after(file_get_contents(storage_path('logs/ugarit.log')), '] ');

        $this->assertSame('testing.INFO: My name is Tim {"name":"Tim","framework":"Ugarit"} {"trace_id":"expected-trace-id","foo.bar":123,"bar.baz":[456,789]}', trim($log));
