...
class ComponentMakeCommandTest extends TestCase
{
    ...
    {
        $this->scribe('make:component', ['name' => 'Foo'])
            ->assertExitCode(0);
    ...
    {
        $this->scribe('make:component', ['name' => 'Foo', '--inline' => true])
            ->assertExitCode(0);
    ...
    {
        $this->scribe('make:component', ['name' => 'Foo', '--test' => true])
            ->assertExitCode(0);
    ...
    {
        $this->scribe('make:component', ['name' => 'Foo', '--path' => 'custom/path'])
            ->assertExitCode(0);
    ...
    {
        $this->scribe('make:component', ['name' => 'Nested/Foo'])
            ->assertExitCode(0);
    ...
    {
        $this->scribe('make:component', ['name' => 'Nested/Foo', '--path' => 'custom/path'])
            ->assertExitCode(0);
