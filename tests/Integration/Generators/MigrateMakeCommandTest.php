...
class MigrateMakeCommandTest extends TestCase
{
    ...
    {
        $this->scribe('make:migration', ['name' => 'AddBarToFoosTable'])
            ->assertExitCode(0);
    ...
    {
        $this->scribe('make:migration', ['name' => 'AddBarToFoosTable', '--table' => 'foobar'])
            ->assertExitCode(0);
    ...
    {
        $this->scribe('make:migration', ['name' => 'CreateFoosTable'])
            ->assertExitCode(0);
    ...
    {
        $this->scribe('make:migration', ['name' => 'FoosTable', '--create' => 'foobar'])
            ->assertExitCode(0);
