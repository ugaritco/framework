...
class ControllerMakeCommandTest extends TestCase
{
    ...
    {
        $this->scribe('make:controller', ['name' => 'FooController'])
            ->assertExitCode(0);
    ...
    {
        $this->scribe('make:controller', ['name' => 'Controller'])
            ->assertExitCode(0);
    ...
    {
        $this->scribe('make:controller', ['name' => 'FooController', '--type' => 'invokable'])
            ->assertExitCode(0);
    ...
    {
        $this->scribe('make:controller', ['name' => 'FooController', '--invokable' => true])
            ->assertExitCode(0);
    ...
    {
        $this->scribe('make:controller', ['name' => 'FooController', '--model' => 'Foo'])
    ...
    {
        $this->scribe('make:controller', ['name' => 'FooController', '--model' => 'Bar', '--parent' => 'Foo'])
            ->expectsQuestion('A App\Models\Foo model does not exist. Do you want to generate it?', false)
    ...
    {
        $this->scribe('make:controller', ['name' => 'FooController', '--api' => true])
            ->assertExitCode(0);
    ...
    {
        $this->scribe('make:controller', ['name' => 'FooController', '--api' => true, '--invokable' => true])
            ->assertExitCode(0);
    ...
    {
        $this->scribe('make:controller', ['name' => 'FooController', '--model' => 'Foo', '--api' => true])
            ->expectsQuestion('A App\Models\Foo model does not exist. Do you want to generate it?', false)
            ->assertExitCode(0);
    ...
    {
        $this->scribe('make:controller', ['name' => 'FooController', '--test' => true])
            ->assertExitCode(0);
