...
class NotificationMakeCommandTest extends TestCase
{
    ...
    {
        $this->scribe('make:notification', ['name' => 'FooNotification'])
            ->assertExitCode(0);
    ...
    {
        $this->scribe('make:notification', ['name' => 'FooNotification', '--markdown' => 'foo-notification'])
            ->assertExitCode(0);
    ...
    {
        $this->scribe('make:notification', ['name' => 'FooNotification', '--test' => true])
            ->assertExitCode(0);
