...
class ModelMakeCommandTest extends TestCase
{
    ...
    {
        $this->scribe('make:model', ['name' => 'Foo'])
            ->assertExitCode(0);
    ...
    {
        $this->scribe('make:model', ['name' => 'Foo', '--pivot' => true])
            ->assertExitCode(0);
    ...
    {
        $this->scribe('make:model', ['name' => 'Foo', '--morph-pivot' => true])
            ->assertExitCode(0);
    ...
    {
        $this->scribe('make:model', ['name' => 'Foo', '--controller' => true])
            ->assertExitCode(0);
    ...
    {
        $this->scribe('make:model', ['name' => 'Foo', '--factory' => true])
            ->assertExitCode(0);
    ...
    {
        $this->scribe('make:model', ['name' => 'Foo/Bar', '--factory' => true])
            ->assertExitCode(0);
    ...
    {
        $this->scribe('make:model', ['name' => 'Foo', '--all' => true])
    ...
    {
        $this->scribe('make:model', ['name' => 'Foo', '--migration' => true])
            ->assertExitCode(0);
    ...
    public function testItPreservesMigrationGenerationOrderForModelsCreatedWithinTheSameSecond()
    {
        ...
        $this->scribe('make:model', ['name' => 'Xxx', '--migration' => true])
            ->assertExitCode(0);

        $this->scribe('make:model', ['name' => 'Aaa', '--migration' => true])
            ->assertExitCode(0);
    ...
    {
        $this->scribe('make:model', ['name' => 'Foo', '--seed' => true])
            ->assertExitCode(0);
    ...
    {
        $this->scribe('make:model', ['name' => 'Foo/Bar', '--controller' => true])
            ->assertExitCode(0);
    ...
    {
        $this->scribe('make:model', ['name' => 'Foo', '--test' => true])
            ->assertExitCode(0);
