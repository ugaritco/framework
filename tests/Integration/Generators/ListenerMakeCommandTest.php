...
class ListenerMakeCommandTest extends TestCase
{
    ...
    {
        $this->scribe('make:listener', ['name' => 'FooListener'])
            ->assertExitCode(0);
    ...
    {
        $this->scribe('make:listener', ['name' => 'FooListener', '--event' => 'FooListenerCreated'])
            ->assertExitCode(0);
    ...
    public function testItCanGenerateListenerFileForHeritageEvent()
    {
        $this->scribe('make:listener', ['name' => 'FooListener', '--event' => 'Heritage\Auth\Events\Login'])
            ->assertExitCode(0);
    ...
    {
        $this->scribe('make:listener', ['name' => 'FooListener', '--queued' => true])
            ->assertExitCode(0);
    ...
    {
        $this->scribe('make:listener', ['name' => 'FooListener', '--queued' => true, '--event' => 'FooListenerCreated'])
            ->assertExitCode(0);
    ...
    public function testItCanGenerateQueuedListenerFileForHeritageEvent()
    {
        $this->scribe('make:listener', ['name' => 'FooListener', '--queued' => true, '--event' => 'Heritage\Auth\Events\Login'])
            ->assertExitCode(0);
    ...
    {
        $this->scribe('make:listener', ['name' => 'FooListener', '--test' => true])
            ->assertExitCode(0);
