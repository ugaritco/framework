...
class MailMakeCommandTest extends TestCase
{
    ...
    {
        $this->scribe('make:mail', ['name' => 'FooMail'])
            ->assertExitCode(0);
    ...
    {
        $this->scribe('make:mail', ['name' => 'FooMail', '--markdown' => 'foo-mail'])
            ->assertExitCode(0);
    ...
    public function testErrorsWillBeDisplayedWhenMarkdownsAlreadyExist()
    {
        ...
        $this->scribe('make:mail', ['name' => 'FooMail', '--markdown' => 'existing-markdown'])
    ...
    {
        $this->scribe('make:mail', ['name' => 'FooMail', '--view' => 'foo-mail'])
            ->assertExitCode(0);
    ...
    public function testErrorsWillBeDisplayedWhenViewsAlreadyExist()
    {
        ...
        $this->scribe('make:mail', ['name' => 'FooMail', '--view' => 'existing-template'])
            ->expectsOutputToContain('already exists.')
            ->assertExitCode(0);
    ...
    {
        $this->scribe('make:mail', ['name' => 'FooMail', '--test' => true])
            ->assertExitCode(0);
