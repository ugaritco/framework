...
use Heritage\Contracts\Broadcasting\Broadcaster;
use Heritage\Contracts\Broadcasting\Factory as BroadcastingFactory;
...
class DatabaseEloquentBroadcastingTest extends DatabaseTestCase
{
    ...
    public function testBasicBroadcasting()
    {
        ...
        Event::assertDispatched(function (BroadcastableModelEventOccurred $event) {
            return $event->model instanceof TestEloquentBroadcastUser
                    ...
                    && $event->broadcastOn()[0]->name === "private-Heritage.Tests.Integration.Database.TestEloquentBroadcastUser.{$event->model->id}";
        });
    }
    ...
    public function testChannelRouteFormatting()
    {
        ...
        $this->assertSame('Heritage.Tests.Integration.Database.TestEloquentBroadcastUser.{testEloquentBroadcastUser}', $model->broadcastChannelRoute());
    }
    ...
    public function testBroadcastingOnModelTrashing()
    {
        ...
        Event::assertDispatched(function (BroadcastableModelEventOccurred $event) {
            return $event->model instanceof SoftDeletableTestEloquentBroadcastUser
                ...
                && $event->broadcastOn()[0]->name === "private-Heritage.Tests.Integration.Database.SoftDeletableTestEloquentBroadcastUser.{$event->model->id}";
        });
    }
    ...
    public function testBroadcastingForSpecificEventsOnly()
    {
        ...
        Event::assertDispatched(function (BroadcastableModelEventOccurred $event) {
            return $event->model instanceof TestEloquentBroadcastUserOnSpecificEventsOnly
                ...
                && $event->broadcastOn()[0]->name === "private-Heritage.Tests.Integration.Database.TestEloquentBroadcastUserOnSpecificEventsOnly.{$event->model->id}";
        });
