...
namespace Heritage\Tests\Integration\Database\EloquentBelongsToManyTest;
...
class EloquentBelongsToManyTest extends DatabaseTestCase
{
    ...
    {
        $this->expectExceptionObject(new ModelNotFoundException('No query results for model [Heritage\Tests\Integration\Database\EloquentBelongsToManyTest\Tag] 10'));
    ...
    {
        $this->expectExceptionObject(new ModelNotFoundException('No query results for model [Heritage\Tests\Integration\Database\EloquentBelongsToManyTest\Tag] 10, 11'));
    ...
    public function testChaperoneWithoutCustomPivotIsNoop()
    {
        ...
        $this->assertInstanceOf(\Heritage\Database\Eloquent\Relations\BelongsToMany::class, $relation);
    }
    ...
    {
        $this->expectException(\Heritage\Database\Eloquent\RelationNotFoundException::class);
