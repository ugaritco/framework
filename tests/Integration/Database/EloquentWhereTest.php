...
class EloquentWhereTest extends DatabaseTestCase
{
    ...
    {
        /** @var \Heritage\Tests\Integration\Database\UserWhereTest $firstUser */
        ...
        /** @var \Heritage\Tests\Integration\Database\UserWhereTest $secondUser */
    ...
    {
        /** @var \Heritage\Tests\Integration\Database\UserWhereTest $user1 */
        ...
        /** @var \Heritage\Tests\Integration\Database\UserWhereTest $user2 */
        ...
        /** @var \Heritage\Tests\Integration\Database\UserWhereTest $user3 */
