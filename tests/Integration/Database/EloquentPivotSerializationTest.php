...
use Heritage\Database\Eloquent\Collection as DatabaseCollection;
...
class EloquentPivotSerializationTest extends DatabaseTestCase
{
    ...
    {
        $user = PivotSerializationTestUser::forceCreate(['email' => 'taylor@ugarit.com']);
    ...
    {
        $user = PivotSerializationTestUser::forceCreate(['email' => 'taylor@ugarit.com']);
        $user2 = PivotSerializationTestUser::forceCreate(['email' => 'mohamed@ugarit.com']);
        $project = PivotSerializationTestProject::forceCreate(['name' => 'Test Project']);
