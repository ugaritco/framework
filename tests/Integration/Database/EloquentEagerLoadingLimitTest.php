...
namespace Heritage\Tests\Integration\Database\EloquentEagerLoadingLimitTest;
...
use Heritage\Tests\Database\Fixtures\Models\Guarded\Post;
...
class EloquentEagerLoadingLimitTest extends DatabaseTestCase
{
    ...
    public function testBelongsToMany(): void
    {
        ...
        $this->assertArrayNotHasKey('ugarit_row', $users[0]->roles[0]);
        $this->assertArrayNotHasKey('@ugarit_group := `user_id`', $users[0]->roles[0]);
    }
    ...
    public function testHasMany(): void
    {
        ...
        $this->assertArrayNotHasKey('ugarit_row', $users[0]->posts[0]);
        $this->assertArrayNotHasKey('@ugarit_group := `user_id`', $users[0]->posts[0]);
    }
    ...
    public function testHasManyThrough(): void
    {
        ...
        $this->assertArrayNotHasKey('ugarit_row', $users[0]->comments[0]);
        $this->assertArrayNotHasKey('@ugarit_group := `user_id`', $users[0]->comments[0]);
    }
