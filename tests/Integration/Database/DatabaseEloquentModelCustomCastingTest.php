...
use Heritage\Contracts\Database\Eloquent\DeviatesCastableAttributes;
...
class TestEloquentModelWithCustomCast extends Model
{
     ...
     */
    protected function addressString(): \Heritage\Database\Eloquent\Casts\Attribute
    {
        return \Heritage\Database\Eloquent\Casts\Attribute::get(function () {
