...
namespace Heritage\Tests\Integration\Database\EloquentModelJsonCastingTest;
...
class EloquentModelJsonCastingTest extends DatabaseTestCase
{
    ...
    {
        /** @var \Heritage\Tests\Integration\Database\EloquentModelJsonCastingTest\JsonCast $object */
    ...
    public function testObjectsAreCastable()
    {
        ...
        /** @var \Heritage\Tests\Integration\Database\EloquentModelJsonCastingTest\JsonCast $user */
