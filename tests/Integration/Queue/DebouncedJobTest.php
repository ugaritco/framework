...
use Heritage\Support\Facades\Cache as CacheFacade;
...
class DebouncedJobTest extends QueueTestCase
{
    ...
    public function testDebounceLockKeyFormat()
    {
        ...
        $this->assertStringStartsWith('ugarit_debounced_job:', $key);
...
class DebouncedWithCustomCacheJob implements ShouldQueue
{
    ...
    public function debounceVia(): \Heritage\Contracts\Cache\Repository
    {
        return \Heritage\Container\Container::getInstance()
            ->make(\Heritage\Contracts\Cache\Factory::class)
            ->store('array');
    }
