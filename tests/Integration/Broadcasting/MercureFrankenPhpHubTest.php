...
class MercureFrankenPhpHubTest extends TestCase
{
    ...
    public function testBroadcastingPublishesThroughTheBuiltInHub()
    {
        ...
        $this->assertSame(['https://ugarit.alt/echo/channel/orders'], $GLOBALS['mercure_published'][0]['topics']);
        $this->assertFalse($GLOBALS['mercure_published'][0]['private']);

        $this->assertSame(['https://ugarit.alt/echo/channel/private-orders.1'], $GLOBALS['mercure_published'][1]['topics']);
