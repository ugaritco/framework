...
class ForwardsCallsTest extends TestCase
{
    ...
    {
        $this->expectExceptionObject(new BadMethodCallException('Call to undefined method Heritage\Tests\Support\ForwardsCallsOne::missingMethod()'));
    ...
    {
        $this->expectExceptionObject(new BadMethodCallException('Call to undefined method Heritage\Tests\Support\ForwardsCallsOne::this1_shouldWork_too()'));
    ...
    public function testNonForwardedErrorIsNotTamperedWith()
    {
        ...
        $this->expectExceptionMessage('Call to undefined method Heritage\Tests\Support\ForwardsCallsBase::missingMethod()');
    ...
    {
        $this->expectExceptionObject(new BadMethodCallException('Call to undefined method Heritage\Tests\Support\ForwardsCallsOne::test()'));
