...
class ValidatedInputTest extends TestCase
{
    ...
    public function test_str_method()
    {
        ...
        $this->assertInstanceOf(\Heritage\Support\Stringable::class, $input->str('int'));
        $this->assertInstanceOf(\Heritage\Support\Stringable::class, $input->str('int'));
        $this->assertInstanceOf(\Heritage\Support\Stringable::class, $input->str('unknown_key'));
    ...
    public function test_string_method()
    {
        ...
        $this->assertInstanceOf(\Heritage\Support\Stringable::class, $input->string('int'));
        $this->assertInstanceOf(\Heritage\Support\Stringable::class, $input->string('int'));
        $this->assertInstanceOf(\Heritage\Support\Stringable::class, $input->string('unknown_key'));
