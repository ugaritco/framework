...
{
    /**
     * @var \Heritage\Support\Testing\Fakes\NotificationFake
     */
    private $fake;

    /**
     * @var \Heritage\Tests\Notifications\Fixtures\NotificationStub
     */
    private $notification;

    /**
     * @var \Heritage\Tests\Support\UserStub
     */
    private $user;
    ...
    public function testAssertSentTo()
    {
        try {
            ...
            $this->assertStringContainsString('The expected [Heritage\Tests\Notifications\Fixtures\NotificationStub] notification was not sent.', $e->getMessage());
        }
    ...
    public function testAssertNotSentTo()
    {
        ...
        try {
            ...
            $this->assertStringContainsString('The unexpected [Heritage\Tests\Notifications\Fixtures\NotificationStub] notification was sent.', $e->getMessage());
        }
    }
