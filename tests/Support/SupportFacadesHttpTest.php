...
class SupportFacadesHttpTest extends TestCase
{
    ...
    {
        Http::fake([
            'https://ugarit.com' => Http::response('OK!'),
        ]);

        $factory = $this->app->make(Factory::class);
        $this->assertSame('OK!', $factory->get('https://ugarit.com')->body());
    }

    public function testFacadeRootIsSharedWhenFakedWithSequence(): void
    {
        Http::fakeSequence('ugarit.com/*')->push('OK!');
    ...
    {
        Http::stubUrl('ugarit.com', Http::response('OK!'));
