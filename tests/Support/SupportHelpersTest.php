...
use Heritage\Tests\Support\Fixtures\IntBackedEnum;
use Heritage\Tests\Support\Fixtures\StringBackedEnum;
...
class SupportHelpersTest extends TestCase
{
    ...
    public function testDataHas()
    {
        ...
        $sameKeyMultiLevel = (object) ['name' => 'Taylor', 'company' => ['name' => 'Ugarit']];
        $plainArray = [1, 2, 3];
    ...
    public function testTraitUsesRecursive()
    {
        $this->assertSame(
            [
                'Heritage\Tests\Support\SupportTestTraitTwo' => 'Heritage\Tests\Support\SupportTestTraitTwo',
                'Heritage\Tests\Support\SupportTestTraitOne' => 'Heritage\Tests\Support\SupportTestTraitOne',
            ],
    ...
    public function testWriteVariableQuotesValuesWithSpecialCharacters()
    {
        $filesystem = new Filesystem;
        $path = __DIR__.'/tmp/env-test-file';
        $filesystem->put($path, 'APP_NAME=Ugarit'.PHP_EOL);
    ...
    public function testLazyThrowsExceptionWhenConstructorIsNotCalled(): void
    {
        ...
        $this->expectExceptionMessage('Typed property Heritage\Tests\Support\SupportLazyClass::$first must not be accessed before initialization');
    ...
    public function testProxyThrowsExceptionWhenObjectIsNotReturned(): void
    {
        ...
        $this->expectException(Error::class);
        $this->expectExceptionMessage('Lazy proxy factory must return an instance of a class compatible with Heritage\Tests\Support\SupportLazyClass, null returned');
