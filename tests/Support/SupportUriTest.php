...
class SupportUriTest extends TestCase
{
    public function test_can_build_special_urls()
    {
        ...
        $this->assertSame('https://ugarit.com/to', Uri::to('')->value());
        $this->assertSame('https://ugarit.com/route', Uri::route('')->value());
        $this->assertSame('https://ugarit.com/signed-route', Uri::signedRoute('')->value());
        $this->assertSame('https://ugarit.com/signed-route', Uri::temporarySignedRoute('', '')->value());
        $this->assertSame('https://ugarit.com/action', Uri::action('')->value());
    }

    public function test_basic_uri_interactions()
    {
        $uri = Uri::of($originalUri = 'https://ugarit.com/docs/installation');

        $this->assertSame('https', $uri->scheme());
        $this->assertNull($uri->user());
        $this->assertNull($uri->password());
        $this->assertSame('ugarit.com', $uri->host());
        ...
        $uri = Uri::of('https://taylor:password@ugarit.com/docs/installation?version=1#hello');
        ...
        $this->assertSame('taylor:password@ugarit.com', $uri->authority());
    }
    ...
    public function test_is_empty_and_is_not_empty()
    {
        ...
        $this->assertFalse(Uri::of('https://ugarit.com')->isEmpty());
        $this->assertTrue(Uri::of('https://ugarit.com')->isNotEmpty());
    }

    public function test_without_fragment()
    {
        $uri = Uri::of('https://ugarit.com/docs/installation#introduction');
        ...
        $this->assertSame('https://ugarit.com/docs/installation', $withoutFragment->value());
    ...
    {
        $uri = Uri::of('https://ugarit.com/docs');

        $withoutFragment = $uri->withoutFragment();

        $this->assertNull($withoutFragment->fragment());
        $this->assertSame('https://ugarit.com/docs', $withoutFragment->value());
    }
    ...
    public function test_uri_building()
    {
        ...
        $expected = 'https://taylor:password@ugarit.com:80/docs/installation?version=1#hello';
    ...
    public function test_complicated_query_string_manipulation()
    {
        ...
        $uri = Uri::of('https://ugarit.com?tags[]=foo');
        ...
        $uri = Uri::of('https://ugarit.com?tag=foo');
    ...
    {
        $uri = Uri::of('https://ugarit.com/?role=user&tenant=10');
        ...
        $uri = Uri::of('https://ugarit.com/?filter[name]=taylor&filter[role]=user');

        $this->assertEquals(['filter' => ['name' => 'taylor', 'role' => 'user', '*' => 'masked']], $uri->withQuery(['filter.*' => 'masked'])->query()->all());

        $uri = Uri::of('https://ugarit.com/?role=user');
    ...
    {
        $uri = Uri::of('https://ugarit.com/docs/11.x/installation')->withQuery(['tags' => ['first', 'second']]);

        $this->assertSame('https://ugarit.com/docs/11.x/installation?tags[0]=first&tags[1]=second', $uri->decode());
    }

    public function test_decoding_the_entire_uri_preserves_the_fragment()
    {
        $uri = Uri::of('https://ugarit.com/docs/11.x/routing?q=ugarit%20docs#route-model-binding');

        $this->assertSame('https://ugarit.com/docs/11.x/routing?q=ugarit docs#route-model-binding', $uri->decode());
    }

    public function test_with_query_if_missing()
    {
        // Test adding new parameters while preserving existing ones
        $uri = Uri::of('https://ugarit.com?existing=value');
        ...
        $uri = Uri::of('https://ugarit.com?name=Taylor&tags[0]=person');
        ...
        $uri = Uri::of('https://ugarit.com?user[name]=Taylor');
    ...
    public function test_with_query_prevents_empty_query_string()
    {
        ...
        $this->assertSame('https://ugarit.com', (string) $uri);
        $this->assertSame('https://ugarit.com', (string) $uri->withQuery([]));
    }
    ...
    public function test_macroable()
    {
        ...
        $uri = new Uri('https://ugarit.com/');

        $this->assertSame('https://ugarit.com/foobar', (string) $uri->myMacro());
    }
}
...
class CustomUrlGeneratorResolver implements UrlGenerator
{
    ...
    {
        return 'https://ugarit.com/current';
    }

    public function previous($fallback = false)
    {
        return 'https://ugarit.com/previous';
    }

    public function to($path, $extra = [], $secure = null)
    {
        return 'https://ugarit.com/to';
    }

    public function secure($path, $parameters = [])
    {
        return 'https://ugarit.com/secure';
    }

    public function asset($path, $secure = null)
    {
        return 'https://ugarit.com/asset';
    }

    public function route($name, $parameters = [], $absolute = true)
    {
        return 'https://ugarit.com/route';
    }

    public function signedRoute($name, $parameters = [], $expiration = null, $absolute = true)
    {
        return 'https://ugarit.com/signed-route';
    }

    public function temporarySignedRoute($name, $expiration, $parameters = [], $absolute = true)
    {
        return 'https://ugarit.com/temporary-signed-route';
    }

    public function query($path, $query = [], $extra = [], $secure = null)
    {
        return 'https://ugarit.com/query';
    }

    public function action($action, $parameters = [], $absolute = true)
    {
        return 'https://ugarit.com/action';
    }
