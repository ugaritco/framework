...
use Heritage\Tests\Support\Fixtures\StringableObjectStub;
...
class SupportStrTest extends TestCase
{
    ...
    public function testStringTitle()
    {
        ...
        $this->assertSame('123 Ugarit', Str::title('123 ugarit'));
        $this->assertSame('❤Ugarit', Str::title('❤ugarit'));
        $this->assertSame('Ugarit ❤', Str::title('ugarit ❤'));
        $this->assertSame('Ugarit123', Str::title('ugarit123'));
        $this->assertSame('Ugarit123', Str::title('Ugarit123'));
    ...
    public function testStringHeadline()
    {
        ...
        $this->assertSame('Jefferson Costella', Str::headline('jefFErson coSTella'));
        $this->assertSame('Jefferson Costella Uses Ugarit', Str::headline('jefferson_costella uses-_Ugarit'));
        $this->assertSame('Jefferson Costella Uses Ugarit', Str::headline('jefferson_costella uses__Ugarit'));

        $this->assertSame('Ugarit P H P Framework', Str::headline('ugarit_p_h_p_framework'));
        $this->assertSame('Ugarit P H P Framework', Str::headline('ugarit _p _h _p _framework'));
        $this->assertSame('Ugarit Php Framework', Str::headline('ugarit_php_framework'));
        $this->assertSame('Ugarit Ph P Framework', Str::headline('ugarit-phP-framework'));
        $this->assertSame('Ugarit Php Framework', Str::headline('ugarit  -_-  php   -_-   framework   '));
        ...
        $this->assertSame('Ugarit Rocks!', Str::headline('ugarit rocks!'));
    }
    ...
    public function testStringInitials()
    {
        ...
        $this->assertSame('JBLL', Str::initials('james bond loves ugarit', true));

        $this->assertSame('❤M☆', Str::initials('❤ MULTIByte ☆'));

        $this->assertSame('lr', Str::initials('ugarit rocks!'));
        $this->assertSame('LR', Str::initials('ugarit rocks!', true));
    }
    ...
    public function testStringApa()
    {
        ...
        $this->assertSame('Ugarit Rocks!', Str::apa('Ugarit Rocks!'));
        $this->assertSame('Ugarit Rocks!', Str::apa('Ugarit rocks!'));
        $this->assertSame('Ugarit Rocks!', Str::apa('UGARIT ROCKS!'));
    ...
    public function testStrBeforeLast(): void
    {
        ...
        $this->assertSame('ugarit', Str::beforeLast('ugarit framework', ' '));
    ...
    {
        $this->assertSame(' ugarit php framework ', Str::deduplicate(' ugarit   php  framework '));
        ...
        $this->assertSame(' ugarit forever ', Str::deduplicate(' ugaritl    foreverrr  ', [' ', 'l', 'r']));
    }
    ...
    public function testParseCallback()
    {
        ...
        $this->assertEquals(["Class@anonymous\0/ugarit/382.php:8$2ec", 'method'], Str::parseCallback("Class@anonymous\0/ugarit/382.php:8$2ec@method"));
        $this->assertEquals(["Class@anonymous\0/ugarit/382.php:8$2ec", 'method'], Str::parseCallback("Class@anonymous\0/ugarit/382.php:8$2ec@method", 'foo'));
        $this->assertEquals(["Class@anonymous\0/ugarit/382.php:8$2ec", 'foo'], Str::parseCallback("Class@anonymous\0/ugarit/382.php:8$2ec", 'foo'));
        $this->assertEquals(["Class@anonymous\0/ugarit/382.php:8$2ec", null], Str::parseCallback("Class@anonymous\0/ugarit/382.php:8$2ec"));
    }
    ...
    public function testIsWithMultilineStrings()
    {
        ...
        $this->assertTrue(Str::is("*namespace Heritage\Tests\*", $multilineValue));
        $this->assertFalse(Str::is("namespace Heritage\Tests\*", $multilineValue));
        $this->assertFalse(Str::is("*namespace Heritage\Tests", $multilineValue));
        $this->assertTrue(Str::is('<?php*', $multilineValue));
        $this->assertTrue(Str::is("<?php*namespace Heritage\Tests\*", $multilineValue));
        $this->assertFalse(Str::is('use Exception;', $multilineValue));
        $this->assertFalse(Str::is('use Exception;*', $multilineValue));
        $this->assertTrue(Str::is('*use Exception;', $multilineValue));

        $this->assertTrue(Str::is("<?php\n\nnamespace Heritage\Tests\*", $multilineValue));
    ...
    {
        $this->assertTrue(Str::isUrl('https://ugarit.com'));
    ...
    {
        $this->assertTrue(Str::isMatch('/.*,.*!/', 'Hello, Ugarit!'));
        $this->assertTrue(Str::isMatch('/^.*$(.*)/', 'Hello, Ugarit!'));
        $this->assertTrue(Str::isMatch('/ugarit/i', 'Hello, Ugarit!'));
        $this->assertTrue(Str::isMatch('/^(.*(.*(.*)))/', 'Hello, Ugarit!'));

        $this->assertFalse(Str::isMatch('/H.o/', 'Hello, Ugarit!'));
        $this->assertFalse(Str::isMatch('/^ugarit!/i', 'Hello, Ugarit!'));
        $this->assertFalse(Str::isMatch('/ugarit!(.*)/', 'Hello, Ugarit!'));
        $this->assertFalse(Str::isMatch('/^[a-zA-Z,!]+$/', 'Hello, Ugarit!'));

        $this->assertTrue(Str::isMatch(['/.*,.*!/', '/H.o/'], 'Hello, Ugarit!'));
        $this->assertTrue(Str::isMatch(['/^ugarit!/i', '/^.*$(.*)/'], 'Hello, Ugarit!'));
        $this->assertTrue(Str::isMatch(['/ugarit/i', '/ugarit!(.*)/'], 'Hello, Ugarit!'));
        $this->assertTrue(Str::isMatch(['/^[a-zA-Z,!]+$/', '/^(.*(.*(.*)))/'], 'Hello, Ugarit!'));
    }

    public function testKebab()
    {
        $this->assertSame('ugarit-php-framework', Str::kebab('UgaritPhpFramework'));
        $this->assertSame('ugarit-php-framework', Str::kebab('Ugarit Php Framework'));
        $this->assertSame('ugarit❤-php-framework', Str::kebab('Ugarit ❤ Php Framework'));
    ...
    public function testTransReturnsStringable()
    {
        ...
        $this->assertInstanceOf(\Heritage\Support\Stringable::class, $string);
    ...
    {
        $this->assertSame('Ugarit is...', Str::limit('Ugarit is a free, open source PHP web application framework.', 10));
        $this->assertSame('这是一...', Str::limit('这是一段中文', 6));
        $this->assertSame('Ugarit is a...', Str::limit('Ugarit is a free, open source PHP web application framework.', 15, preserveWords: true));

        $string = 'The PHP framework for web scribes.';
        ...
        $this->assertSame('The PHP framework for web scribes.', Str::limit($string, 100));
        $this->assertSame('The PHP framework for web scribes.', Str::limit($string, 100, preserveWords: true));
    ...
    public function testNumbers()
    {
        ...
        $this->assertSame('', Str::numbers('Ugarit!'));

        $arrayValue = ['(555) 123-4567', 'L4r4v3l', 'Ugarit!'];
    ...
    {
        $this->assertSame('foo bar ugarit', Str::replace('baz', 'ugarit', 'foo bar baz'));
        $this->assertSame('foo bar ugarit', Str::replace('baz', 'ugarit', 'foo bar Baz', false));
    ...
    {
        $this->assertSame('ugarit_p_h_p_framework', Str::snake('UgaritPHPFramework'));
        $this->assertSame('ugarit_php_framework', Str::snake('UgaritPhpFramework'));
        $this->assertSame('ugarit php framework', Str::snake('UgaritPhpFramework', ' '));
        $this->assertSame('ugarit_php_framework', Str::snake('Ugarit Php Framework'));
        $this->assertSame('ugarit_php_framework', Str::snake('Ugarit    Php      Framework   '));
        // ensure cache keys don't overlap
        $this->assertSame('ugarit__php__framework', Str::snake('UgaritPhpFramework', '__'));
        $this->assertSame('ugarit_php_framework_', Str::snake('UgaritPhpFramework_', '_'));
        $this->assertSame('ugarit_php_framework', Str::snake('ugarit php Framework'));
        $this->assertSame('ugarit_php_frame_work', Str::snake('ugarit php FrameWork'));
    ...
    {
        $this->assertSame('ugarit php framework', Str::squish(' ugarit   php  framework '));
        $this->assertSame('ugarit php framework', Str::squish("ugarit\t\tphp\n\nframework"));
        $this->assertSame('ugarit php framework', Str::squish('
            ugarit
            php
            framework
        '));
        ...
        $this->assertSame('だ', Str::squish('   だ    '));
        $this->assertSame('ム', Str::squish('   ム    '));
        $this->assertSame('ugarit php framework', Str::squish('ugaritㅤㅤㅤphpㅤframework'));
        $this->assertSame('ugarit php framework', Str::squish('ugaritᅠᅠᅠᅠᅠᅠᅠᅠᅠᅠphpᅠᅠframework'));
    }

    public function testStudly()
    {
        $this->assertSame('UgaritPHPFramework', Str::studly('ugarit_p_h_p_framework'));
        $this->assertSame('UgaritPhpFramework', Str::studly('ugarit_php_framework'));
        $this->assertSame('UgaritPhPFramework', Str::studly('ugarit-phP-framework'));
        $this->assertSame('UgaritPhpFramework', Str::studly('ugarit  -_-  php   -_-   framework   '));
        ...
        $this->assertSame('UgaritRocks!', Str::studly('ugarit rocks!'));
    ...
    {
        $this->assertSame('UgaritPhpFramework', Str::pascal('ugarit_php_framework'));
        $this->assertSame('UgaritPhpFramework', Str::pascal('ugarit-php-framework'));
        $this->assertSame('UgaritPhpFramework', Str::pascal('ugarit  -_-  php   -_-   framework   '));
    ...
    {
        $this->assertSame('ugaritPHPFramework', Str::camel('Ugarit_p_h_p_framework'));
        $this->assertSame('ugaritPhpFramework', Str::camel('Ugarit_php_framework'));
        $this->assertSame('ugaritPhPFramework', Str::camel('Ugarit-phP-framework'));
        $this->assertSame('ugaritPhpFramework', Str::camel('Ugarit  -_-  php   -_-   framework   '));
        ...
        $this->assertSame('lARAVELPHPFRAMEWORK', Str::camel('UGARIT_PHP_FRAMEWORK'));
        $this->assertSame('ugaritPhpFramework', Str::camel('   ugarit   php   framework   '));
    ...
    {
        $this->assertSame(3, Str::substrCount('ugaritPHPFramework', 'a'));
        $this->assertSame(0, Str::substrCount('ugaritPHPFramework', 'z'));
        $this->assertSame(1, Str::substrCount('ugaritPHPFramework', 'l', 2));
        $this->assertSame(0, Str::substrCount('ugaritPHPFramework', 'z', 2));
        $this->assertSame(1, Str::substrCount('ugaritPHPFramework', 'k', -1));
        $this->assertSame(1, Str::substrCount('ugaritPHPFramework', 'k', -1));
        $this->assertSame(1, Str::substrCount('ugaritPHPFramework', 'a', 1, 2));
        $this->assertSame(1, Str::substrCount('ugaritPHPFramework', 'a', 1, 2));
        $this->assertSame(3, Str::substrCount('ugaritPHPFramework', 'a', 1, -2));
        $this->assertSame(1, Str::substrCount('ugaritPHPFramework', 'a', -10, -3));
    }
    ...
    public function testSubstrReplace()
    {
        ...
        $this->assertSame('The Ugarit Framework', Str::substrReplace('The Framework', 'Ugarit ', 4, 0));
        $this->assertSame('Ugarit – The PHP Framework for Web Scribes', Str::substrReplace('Ugarit Framework', '– The PHP Framework for Web Scribes', 8));
    ...
    {
        $this->assertSame('ugarit', Str::lcfirst('Ugarit'));
        $this->assertSame('ugarit framework', Str::lcfirst('Ugarit framework'));
    ...
    {
        $this->assertSame('Ugarit', Str::ucfirst('ugarit'));
        $this->assertSame('Ugarit framework', Str::ucfirst('ugarit framework'));
    ...
    {
        $this->assertSame('Ugarit', Str::ucwords('ugarit'));
        $this->assertSame('Ugarit Framework', Str::ucwords('ugarit framework'));
        $this->assertSame('Ugarit-Framework', Str::ucwords('ugarit-framework', '-'));
    ...
    {
        $this->assertSame(['Ugarit_p_h_p_framework'], Str::ucsplit('Ugarit_p_h_p_framework'));
        $this->assertSame(['Ugarit_', 'P_h_p_framework'], Str::ucsplit('Ugarit_P_h_p_framework'));
        $this->assertSame(['ugarit', 'P', 'H', 'P', 'Framework'], Str::ucsplit('ugaritPHPFramework'));
        $this->assertSame(['Ugarit-ph', 'P-framework'], Str::ucsplit('Ugarit-phP-framework'));
    ...
    public function testWordCount()
    {
        ...
        $this->assertEquals(10, Str::wordCount('Hi, this is my first contribution to the Ugarit framework.'));
    ...
    public function testInlineMarkdown()
    {
        ...
        $this->assertSame("<a href=\"https://ugarit.com\"><strong>Ugarit</strong></a>\n", Str::inlineMarkdown('[**Ugarit**](https://ugarit.com)'));
    ...
    public static function dataProviderChopStart(): Generator
    {
        ...
        yield 'empty needle leaves subject' => ['Ugarit', '', 'Ugarit'];
        yield 'first matching needle from array is removed' => ['Ship it', ['', 'Ship '], 'it'];
        yield 'standard http prefix removed' => ['http://ugarit.com', 'http://', 'ugarit.com'];
        yield 'prefix only removed once at start' => ['http://-http://', 'http://', '-http://'];
        yield 'non-matching partial prefix is ignored' => ['http://ugarit.com', 'htp:/', 'http://ugarit.com'];
        yield 'different non-matching prefix is ignored' => ['http://ugarit.com', 'http://www.', 'http://ugarit.com'];
        yield 'prefix not at start is ignored' => ['http://ugarit.com', '-http://', 'http://ugarit.com'];
        yield 'matching prefix selected from array' => ['http://ugarit.com', ['https://', 'http://'], 'ugarit.com'];
        yield 'first matching prefix in ordered array used' => ['http://www.ugarit.com', ['http://', 'www.'], 'www.ugarit.com'];
        ...
        yield 'mixed emoji and ascii prefix removed' => ['🎉Ugarit', '🎉', 'Ugarit'];
    ...
    public static function dataProviderChopEnd(): Generator
    {
        ...
        yield 'empty needle leaves subject unchanged' => ['Ugarit', '', 'Ugarit'];
        ...
        yield 'mixed ascii and emoji suffix removed' => ['Ugarit🎉', '🎉', 'Ugarit'];
