...
{
    /**
     * @var \Heritage\Support\Testing\Fakes\QueueFake
     */
    private $fake;

    /**
     * @var \Heritage\Tests\Support\JobStub
     */
    private $job;
    ...
    public function testAssertPushed()
    {
        try {
            ...
            $this->assertStringContainsString('The expected [Heritage\Tests\Support\JobStub] job was not pushed.', $e->getMessage());
        }
    ...
    public function testAssertNotPushed()
    {
        ...
        try {
            ...
            $this->assertStringContainsString('The unexpected [Heritage\Tests\Support\JobStub] job was pushed.', $e->getMessage());
        }
    }
    ...
    public function testAssertPushedTimes()
    {
        ...
        try {
            ...
            $this->assertStringContainsString('The expected [Heritage\Tests\Support\JobStub] job was pushed 2 times instead of 1 time.', $e->getMessage());
        }
    ...
    public function testAssertPushedWithChainErrorHandling()
    {
        try {
            ...
            $this->assertStringContainsString('The expected [Heritage\Tests\Support\JobWithChainStub] job was not pushed.', $e->getMessage());
        }
