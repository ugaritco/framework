...
class SupportFluentTest extends TestCase
{
    ...
    public function testStringMethod()
    {
        ...
        $this->assertInstanceOf(\Heritage\Support\Stringable::class, $fluent->string('int'));
        $this->assertInstanceOf(\Heritage\Support\Stringable::class, $fluent->string('unknown_key'));
