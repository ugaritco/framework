    ...
    public static function databaseUrls()
    {
        return [
            ...
            'Standalone Microsoft SQL Server DSN strings are parsed' => [
                'sqlsrv:Database=ugarit;Encrypt=false;Server=localhost',
                [
                    'driver' => 'sqlsrv',
                    'database' => 'ugarit',
                    'host' => 'localhost',
            ...
            'Microsoft SQL Server database URL using Ugarit\'s database URL convention format' => [
