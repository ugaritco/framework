...
use Heritage\Support\Facades\ParallelTesting as ParallelTestingFacade;
use Heritage\Testing\Concerns\TestCaches;
use Heritage\Testing\ParallelTesting;
...
class TestCachesTest extends TestCase
{
    ...
    public function testBootTestCacheSkipsIsolationIfOptedOut()
    {
        ...
        $_SERVER['UGARIT_PARALLEL_TESTING_WITHOUT_CACHE'] = 1;
        ...
        unset($_SERVER['UGARIT_PARALLEL_TESTING_WITHOUT_CACHE']);
    }
    ...
    public function testSwitchToCachePrefixDoesNotRemoveResolvedDrivers()
    {
        ...
        $container->singleton('cache', fn ($app) => new \Heritage\Cache\CacheManager($app));
