...
use Heritage\Testing\Exceptions\InvalidArgumentException;
...
class AssertTest extends TestCase
{
    ...
    public function testArraySubsetMayFailIfArrayIsNotArray(): void
    {
        $this->expectExceptionObject(new InvalidArgumentException(
            'Argument #1 of Heritage\Testing\Assert::assertArraySubset() must be an array or ArrayAccess'
        ));
    ...
    {
        $this->expectExceptionObject(new InvalidArgumentException(
            'Argument #2 of Heritage\Testing\Assert::assertArraySubset() must be an array or ArrayAccess'
        ));
