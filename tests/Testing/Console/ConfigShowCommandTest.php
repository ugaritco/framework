...
class ConfigShowCommandTest extends TestCase
{
    ...
    public function testDisplayConfig()
    {
        ...
        $this->scribe(ConfigShowCommand::class, ['config' => 'test'])
            ->assertSuccessful()
            ->expectsOutput('  test .......................................................  ')
            ...
            ->expectsOutput('  array ⇁ 0 .. Heritage\Foundation\Console\ConfigShowCommand  ')
    ...
    public function testDisplayNestedConfigItems()
    {
        ...
        $this->scribe(ConfigShowCommand::class, ['config' => 'test.nested'])
            ->assertSuccessful()
    ...
    public function testDisplaySingleValue()
    {
        ...
        $this->scribe(ConfigShowCommand::class, ['config' => 'foo'])
            ->assertSuccessful()
            ->expectsOutput('  foo .................................................... bar  ');
    }
    ...
    {
        $this->scribe(ConfigShowCommand::class, ['config' => 'invalid'])
            ->assertFailed();
    }
}
