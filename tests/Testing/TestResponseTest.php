...
use Heritage\Cookie\CookieValuePrefix;
...
class TestResponseTest extends TestCase
{
    ...
    {
        $response = $this->makeMockResponse([
            'render' => 'ugarit &amp; php &amp; friends',
        ]);

        $response->assertSee('ugarit & php');
        $response->assertSee(['php & friends', 'ugarit & php']);
    }
    ...
    public function testAssertSeeTextEscaped(): void
    {
        ...
        $response->assertSeeText('ugarit & php');
        $response->assertSeeText(['php & friends', 'ugarit & php']);
    }
...
EOT
        ...
        $response->assertSeeText('Hello, ugarit & php & friends');
    }
    ...
    {
        $response = $this->makeMockResponse([
            'render' => '<strong>ugarit &amp; php</strong> <i>phpstorm &gt; sublime</i>',
        ]);

        $response->assertSeeTextInOrder(['ugarit & php', 'phpstorm > sublime']);
    }
...
EOT
        ...
        $response->assertSeeTextInOrder(['Hello', 'ugarit & php', 'friends']);
    }
    ...
    public function testAssertDontSeeEscapedCanFail(): void
    {
        ...
        $response->assertDontSee('ugarit & php');
        $response->assertDontSee(['php & friends', 'ugarit & php']);
    }
    ...
    public function testAssertDontSeeHtml(): void
    {
        ...
        $response->assertDontSeeHtml('<li>ugarit</li>');
    ...
    public function testAssertDontSeeText(): void
    {
        ...
        $response->assertDontSeeText('ugaritphp');
        $response->assertDontSeeText(['phpfriends', 'ugaritphp']);
    }
    ...
    public function testAssertDontSeeTextEscapedCanFail(): void
    {
        ...
        $response->assertDontSeeText('ugarit & php');
        $response->assertDontSeeText(['php & friends', 'ugarit & php']);
    }
