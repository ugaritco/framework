...
use Heritage\Tests\Routing\Fixtures\CategoryEnum;
...
class RoutingUrlGeneratorTest extends TestCase
{
    ...
    public function testBasicGenerationWithRequestBaseUrlWithSubfolder()
    {
        ...
        $request->server->set('SCRIPT_FILENAME', '/var/www/ugarit-project/public/subfolder/index.php');
    ...
    public function testBasicGenerationWithRequestBaseUrlWithFileSuffix()
    {
        ...
        $request->server->set('SCRIPT_FILENAME', '/var/www/ugarit-project/public/other.php');
