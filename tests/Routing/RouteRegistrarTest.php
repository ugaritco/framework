...
use Heritage\Routing\RouteRegistrar;
use Heritage\Tests\Routing\Fixtures\CategoryBackedEnum;
use Heritage\Tests\Routing\Fixtures\IntegerEnum;
use Heritage\Tests\Routing\Fixtures\RouteDomainEnum;
...
class RouteRegistrarTest extends TestCase
{
    ...
    public function testResourceWithTrashed()
    {
        ...
        /** @var \Heritage\Routing\Route $route */
    ...
    public function testCanRegisterGroupWithNamespace()
    {
        ...
        $this->assertSame(
            '\Heritage\Routing\RedirectController@__invoke',
            $this->getRoute()->getAction()['uses']
        );
    }
    ...
    public function testRouteGroupChaining()
    {
        ...
        $this->assertInstanceOf(\Heritage\Routing\Route::class, $routeCollection->match(Request::create('foo', 'GET')));
        $this->assertInstanceOf(\Heritage\Routing\Route::class, $routeCollection->match(Request::create('bar', 'GET')));
    }

    public function testRegisteringNonApprovedAttributesThrows()
    {
        $this->expectExceptionObject(new BadMethodCallException('Method Heritage\Routing\RouteRegistrar::unsupportedMethod does not exist.'));
