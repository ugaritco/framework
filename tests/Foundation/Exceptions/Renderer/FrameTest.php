...
namespace Heritage\Tests\Foundation\Exceptions\Renderer;

use Heritage\Foundation\Exceptions\Renderer\Frame;
use Mockery;
...
class FrameTest extends TestCase
{
    ...
    {
        yield 'vendor file' => [
            ['file' => '/path/to/your-app/vendor/ugarit/framework/src/File.php', 'line' => 10],
            '/path/to/your-app',
            true,
        ];
        yield 'app file' => [
    ...
    {
        yield 'vendor file' => [
            ['file' => 'C:\path\to\your-app\vendor\ugarit\framework\src\File.php', 'line' => 10],
            'C:\path\to\your-app',
            true,
        ];
        yield 'app file' => [
