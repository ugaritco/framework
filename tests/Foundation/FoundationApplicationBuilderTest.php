...
use Heritage\Foundation\Http\Kernel as HttpKernel;
...
class FoundationApplicationBuilderTest extends TestCase
{
    ...
    {
        unset($_ENV['APP_BASE_PATH'], $_ENV['UGARIT_STORAGE_PATH'], $_SERVER['UGARIT_STORAGE_PATH']);
    }
    ...
    {
        $_ENV['UGARIT_STORAGE_PATH'] = __DIR__.'/env-storage';
    ...
    {
        $_SERVER['UGARIT_STORAGE_PATH'] = __DIR__.'/server-storage';
