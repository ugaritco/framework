...
class KernelTest extends TestCase
{
    ...
    public function testFindCommandDoesNotResolveOtherLazilyRegisteredCommands()
    {
        ...
        $kernel = $this->makeKernel();
        $scribe = $this->getScribe($kernel);
        $scribe->resolveCommands([KernelTestLazyCommand::class]);
    ...
    protected function getScribe(Kernel $kernel)
    {
        $method = (new ReflectionClass($kernel))->getMethod('getScribe');
