...
class RouteListCommandTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        $this->app = new Application(
            $ugarit = new \Heritage\Foundation\Application(__DIR__),
            new \Heritage\Events\Dispatcher($ugarit),
            'testing',
        );

        $router = new Router(new \Heritage\Events\Dispatcher($ugarit));

        $kernel = new class($ugarit, $router) extends Kernel
        {
        ...
        $ugarit->instance(Kernel::class, $kernel);
