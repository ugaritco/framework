...
use Heritage\Foundation\Bootstrap\RegisterFacades;
...
class FoundationApplicationTest extends TestCase
{
    ...
    public function testMethodAfterLoadingEnvironmentAddsClosure()
    {
        ...
        $this->assertArrayHasKey(0, $app['events']->getListeners('bootstrapped: Heritage\Foundation\Bootstrap\LoadEnvironmentVariables'));
    }
    ...
    public function testBeforeBootstrappingAddsClosure()
    {
        ...
        $this->assertArrayHasKey(0, $app['events']->getListeners('bootstrapping: Heritage\Foundation\Bootstrap\RegisterFacades'));
    }
    ...
    public function testAfterBootstrappingAddsClosure()
    {
        ...
        $this->assertArrayHasKey(0, $app['events']->getListeners('bootstrapped: Heritage\Foundation\Bootstrap\RegisterFacades'));
    }
    ...
    {
        $app1 = new Application(realpath(__DIR__.'/Fixtures/ugarit1'));
        $app2 = new Application(realpath(__DIR__.'/Fixtures/ugarit2'));

        $this->assertSame('Ugarit\\One\\', $app1->getNamespace());
        $this->assertSame('Ugarit\\Two\\', $app2->getNamespace());
    }
    ...
    public function testUseConfigPath(): void
    {
        ...
        $app->bootstrapWith([\Heritage\Foundation\Bootstrap\LoadConfiguration::class]);
    ...
    public function testCoreContainerAliasesAreRegisteredByDefault(): void
    {
        ...
        $this->assertTrue($app->isAlias(\Heritage\Contracts\Translation\Translator::class));
        $this->assertSame('translator', $app->getAlias(\Heritage\Contracts\Translation\Translator::class));
        $this->assertTrue($app->isAlias(\Heritage\Contracts\Auth\PasswordBrokerFactory::class));
        $this->assertSame('auth.password', $app->getAlias(\Heritage\Contracts\Auth\PasswordBrokerFactory::class));
        $this->assertTrue($app->isAlias(\Heritage\Contracts\Auth\PasswordBroker::class));
        $this->assertSame('auth.password.broker', $app->getAlias(\Heritage\Contracts\Auth\PasswordBroker::class));
    }
}
