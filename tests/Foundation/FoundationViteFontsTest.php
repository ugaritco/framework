...
use Heritage\Foundation\ViteException;
use Heritage\Foundation\ViteFonts;
...
class FoundationViteFontsTest extends TestCase
{
    ...
    public function testFontsRendersInHotMode()
    {
        ...
        $this->assertStringContainsString(
            '<link rel="preload" as="font" href="http://localhost:3000/__ugarit_vite_plugin__/fonts/inter.woff2" type="font/woff2" crossorigin="anonymous" />',
            $result->toHtml()
        );
        $this->assertStringContainsString(
    ...
    public function testFontsRendersUtilityClassInHotMode()
    {
        ...
        $this->makeHotFontsManifest([
            ...
            'preloads' => [
                ['alias' => 'sans', 'family' => 'Inter', 'weight' => 400, 'style' => 'normal', 'url' => 'http://localhost:3000/__ugarit_vite_plugin__/fonts/inter.woff2', 'as' => 'font', 'type' => 'font/woff2', 'crossorigin' => 'anonymous'],
            ],
            'families' => [
                'sans' => ['family' => 'Inter', 'variable' => '--font-sans'],
            ],
        ...
        return [
            ...
            'preloads' => [
                [
                    ...
                    'weight' => 400,
                    'style' => 'normal',
                    'url' => 'http://localhost:3000/__ugarit_vite_plugin__/fonts/inter.woff2',
                    'as' => 'font',
                    'type' => 'font/woff2',
                    'crossorigin' => 'anonymous',
                ],
