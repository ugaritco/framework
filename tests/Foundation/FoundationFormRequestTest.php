...
use Heritage\Contracts\Validation\Factory as ValidationFactoryContract;
use Heritage\Contracts\Validation\Validator;
...
use Heritage\Translation\Translator as TranslatorConcrete;
use Heritage\Validation\Factory as ValidationFactory;
...
class FoundationFormRequestTest extends TestCase
{
    ...
    public function testAfterMethod()
    {
        ...
        $container->instance(\Heritage\Contracts\Validation\Factory::class, (new \Heritage\Validation\Factory(
            new \Heritage\Translation\Translator(new \Heritage\Translation\ArrayLoader(), 'en')
     ...
     * @param  array  $payload
     * @param  string  $class
     * @return \Heritage\Foundation\Http\FormRequest
     */
     ...
     * @return \Heritage\Validation\Factory
     */
     ...
     * @return \Heritage\Routing\Redirector
     */
     ...
     *
     * @return \Heritage\Routing\UrlGenerator
     */
