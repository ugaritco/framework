...
use Heritage\Contracts\Config\Repository;
...
class FoundationHelpersTest extends TestCase
{
    ...
    {
        $path = $this->makeHotModuleReloadFile('https://ugarit.com/docs');

        $result = mix('unversioned.css');

        $this->assertSame('//ugarit.com/docs/unversioned.css', $result->toHtml());
    ...
    {
        $path = $this->makeHotModuleReloadFile('http://ugarit.com/docs');
    ...
    {
        mkdir($directory = __DIR__.'/mix');
        $path = $this->makeHotModuleReloadFile('https://ugarit.com/docs', 'mix');
    ...
    {
        mkdir($directory = __DIR__.'/mix');
        $path = $this->makeHotModuleReloadFile('http://ugarit.com/docs', 'mix');
    ...
    protected function makeHotModuleReloadFile($url, $directory = '')
    {
        ...
        // Ugarit mix when run 'hot' has a new line after the
    ...
    protected function makeManifest($directory = '')
    {
        ...
        // Ugarit mix prints JSON pretty and with escaped
