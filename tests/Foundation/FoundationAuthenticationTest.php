...
use Heritage\Foundation\Testing\Concerns\InteractsWithAuthentication;
use Mockery;
...
class FoundationAuthenticationTest extends TestCase
{
    ...
    protected $credentials = [
        'email' => 'someone@ugarit.com',
        'password' => 'secret_password',
    ];

    /**
     * @return \Heritage\Contracts\Auth\Guard|\Mockery\LegacyMockInterface|\Mockery\MockInterface
     */
