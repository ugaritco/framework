...
class EventTest extends TestCase
{
    ...
    public function testBuildCommandInBackgroundUsingUnix()
    {
        ...
        $this->assertSame("(php -i > '/dev/null' 2>&1 ; '".php_binary()."' 'scribe' schedule:finish {$scheduleId} \"$?\") > '/dev/null' 2>&1 &", $event->buildCommand());
    }
    ...
    public function testBuildCommandInBackgroundUsingWindows()
    {
        ...
        $this->assertSame('start /b cmd /v:on /c "(php -i & '.php_binary().' scribe schedule:finish '.$scheduleId.' ^!ERRORLEVEL^!) > "NUL" 2>&1"', $event->buildCommand());
    }
    ...
    public function testBuildCommandInBackgroundWithUserUsingUnix()
    {
        ...
        $background = "(php -i > '/dev/null' 2>&1 ; '".php_binary()."' 'scribe' schedule:finish {$scheduleId} \"$?\") > '/dev/null' 2>&1 &";
