...
use Heritage\View\Compilers\CompilerInterface;
use Heritage\View\Engines\CompilerEngine;
use Heritage\View\Engines\EngineResolver;
...
class ViewFactoryTest extends TestCase
{
    ...
    public function testComponentHandling()
    {
        ...
        $factory->slot('title');
        $factory->slot('website', 'ugarit.com', []);
        echo 'title<hr>';
        $factory->endSlot();
        echo 'component';
        $contents = $factory->renderComponent();
        $this->assertSame('title<hr> component Taylor ugarit.com', $contents);
    }
    ...
    {
        $factory = $this->getFactory();
        $factory->startComponent(new HtmlString('ugarit.com'));
        $contents = $factory->renderComponent();
        $this->assertSame('ugarit.com', $contents);
    }
