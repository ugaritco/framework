...
class BladePropsTest extends AbstractBladeTestCase
{
    ...
    {
        $this->assertSame('<?php $attributes ??= new \Heritage\View\ComponentAttributeBag;

$__newAttributes = [];
$__propNames = \Heritage\View\ComponentAttributeBag::extractPropNames(([\'one\' => true, \'two\' => \'string\']));
