...
use Heritage\Queue\Console\Concerns\ParsesQueue;
use Heritage\Queue\Events\QueuePaused;
use Heritage\Queue\Events\QueueResumed;
...
class QueuePauseResumeTest extends TestCase
{
    ...
    public function testPauseChecksDoNotBatchTheGlobalKeyWithQueueKeys()
    {
        $store = new class extends ArrayStore
        {
            ...
            {
                if (count($keys) > 1 && in_array('heritage:queues:paused', $keys)) {
