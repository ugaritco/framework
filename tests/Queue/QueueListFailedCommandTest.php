...
use Heritage\Queue\Failed\FailedJobProviderInterface;
use Mockery;
...
class QueueListFailedCommandTest extends TestCase
{
    ...
    {
        // CallQueuedListener is the wrapper class Ugarit uses to dispatch
        ...
        $output = $this->runListFailedCommandWith([
            $this->fakeFailedJob([
                ...
                'data' => [
                    'commandName' => 'Heritage\\Events\\CallQueuedListener',
                    'command' => 'O:42:"Heritage\\Events\\CallQueuedListener":3:{s:5:"class";s:43:"App\\Listeners\\HandleStripeWebhookHandled";s:6:"method";s:6:"handle";s:4:"data";a:0:{}}',
                ],
            ]),
        ]);
    ...
    public function testEncryptedJobShowsUnderlyingClass()
    {
        ...
        $output = $this->runListFailedCommandWith([
            $this->fakeFailedJob([
                ...
                'data' => [
                    'commandName' => 'Heritage\\Queue\\CallEncryptedQueuedHandler',
