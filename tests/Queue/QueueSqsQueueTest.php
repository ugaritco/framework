...
use Heritage\Contracts\Bus\Dispatcher as DispatcherContract;
...
use Heritage\Tests\Queue\Fixtures\FakeSqsJob;
use Heritage\Tests\Queue\Fixtures\FakeSqsJobWithDeduplication;
use Heritage\Tests\Queue\Fixtures\FakeSqsJobWithDelayAttribute;
use Heritage\Tests\Queue\Fixtures\FakeSqsJobWithMessageGroup;
...
class QueueSqsQueueTest extends TestCase
{
    ...
    public function testPushRawStoresPayloadToCacheWhenExceedingThreshold()
    {
        ...
        $expectedPath = 'ugarit:sqs-payloads:'.$uuid;
    ...
    {
        $events = Mockery::mock(\Heritage\Contracts\Events\Dispatcher::class);
        $dispatched = [];
        ...
        $queueingEvents = array_filter($dispatched, fn ($e) => $e instanceof \Heritage\Queue\Events\JobQueueing);
        $queuedEvents = array_filter($dispatched, fn ($e) => $e instanceof \Heritage\Queue\Events\JobQueued);
    ...
    public function testBulkDefersAfterCommitJobsUntilTheTransactionCommits()
    {
        ...
        $transactions = Mockery::mock(\Heritage\Database\DatabaseTransactionsManager::class);
    ...
    public function testBulkComputesQueueableOptionsBeforeApplyingOverflow()
    {
        ...
        $this->assertStringStartsWith('{"@pointer":"ugarit:sqs-payloads:', $captured['Entries'][0]['MessageBody']);
    }
