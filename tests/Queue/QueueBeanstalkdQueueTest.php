...
use Heritage\Queue\BeanstalkdQueue;
use Heritage\Queue\Jobs\BeanstalkdJob;
...
{
    /**
     * @var \Heritage\Queue\BeanstalkdQueue
     */
    private $queue;

    /**
     * @var \Heritage\Container\Container|\Mockery\LegacyMockInterface|\Mockery\MockInterface
     */
    private $container;
