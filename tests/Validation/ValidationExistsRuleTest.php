...
use Heritage\Validation\DatabasePresenceVerifier;
...
class ValidationExistsRuleTest extends TestCase
{
    ...
    public function testItCorrectlyFormatsAStringVersionOfTheRule()
    {
        ...
        $rule = new Exists('Heritage\Tests\Validation\User', 'column');
        $rule->where('foo', 'bar');
        $this->assertSame('exists:users,column,foo,"bar"', (string) $rule);
     ...
     *
     * @return \Heritage\Database\ConnectionResolverInterface
     */
