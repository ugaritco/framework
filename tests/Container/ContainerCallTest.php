...
class ContainerCallTest extends TestCase
{
    ...
    {
        $container = new Container;
        $result = $container->call('Heritage\Tests\Container\ContainerStaticMethodStub::inject');
        $this->assertInstanceOf(ContainerCallConcreteStub::class, $result[0]);
        $this->assertSame('taylor', $result[1]);
    }
    ...
    {
        $container = new Container;
        $result = $container->call('Heritage\Tests\Container\containerTestInject');
        $this->assertInstanceOf(ContainerCallConcreteStub::class, $result[0]);
        $this->assertSame('taylor', $result[1]);
    }
    ...
    {
        $this->expectExceptionObject(new BindingResolutionException('Unable to resolve dependency [Parameter #0 [ <required> $foo ]] in class Heritage\Tests\Container\ContainerTestCallStub'));
    ...
    {
        $this->expectExceptionObject(new BindingResolutionException('Unable to resolve dependency [Parameter #0 [ <required> $foo ]] in class Heritage\Tests\Container\ContainerCallTest'));
