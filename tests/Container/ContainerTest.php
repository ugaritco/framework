...
namespace Heritage\Tests\Container;
...
use Heritage\Container\EntryNotFoundException;
use Heritage\Contracts\Container\BindingResolutionException;
use Heritage\Contracts\Container\ContextualAttribute;
use Heritage\Contracts\Container\SelfBuilding;
use Heritage\Tests\Container\Fixtures\BindBeforeBindWhenInterface;
use Heritage\Tests\Container\Fixtures\BindBeforeConcrete;
use Heritage\Tests\Container\Fixtures\BindFallbackConcrete;
use Heritage\Tests\Container\Fixtures\BindWhenAndBindInterface;
use Heritage\Tests\Container\Fixtures\BindWhenCondition;
use Heritage\Tests\Container\Fixtures\BindWhenConditionalConcrete;
use Heritage\Tests\Container\Fixtures\BindWhenConditionalInterface;
use Heritage\Tests\Container\Fixtures\BindWhenFallbackInterface;
use Heritage\Tests\Container\Fixtures\BindWhenInterface;
use Heritage\Tests\Container\Fixtures\BindWhenNoMatchInterface;
use Heritage\Tests\Container\Fixtures\BindWhenSingletonConcrete;
use Heritage\Tests\Container\Fixtures\BindWhenSingletonInterface;
use Heritage\Tests\Container\Fixtures\BindWhenTrueConcrete;
use Heritage\Tests\Container\Fixtures\BindWhenWinsConcrete;
use LogicException;
...
class ContainerTest extends TestCase
{
    ...
    {
        $this->expectExceptionObject(new BindingResolutionException('Unresolvable dependency resolving [Parameter #0 [ <required> $first ]] in class Heritage\Tests\Container\ContainerMixedPrimitiveStub'));
    ...
    {
        $this->expectExceptionObject(new BindingResolutionException('Target [Heritage\Tests\Container\IContainerContractStub] is not instantiable.'));
    ...
    {
        $this->expectExceptionObject(new BindingResolutionException('Target [Heritage\Tests\Container\IContainerContractStub] is not instantiable while building [Heritage\Tests\Container\ContainerDependentStub].'));
    ...
    {
        $container = new Container;
        $_SERVER['__withFactory.email'] = 'taylor@ugarit.com';
        ...
        $this->assertSame('taylor@ugarit.com', $r->email);
    }

    // public function testContainerCanCatchCircularDependency()
    // {
    //     $this->expectException(\Heritage\Contracts\Container\CircularDependencyException::class);
