...
use Heritage\Auth\Access\HandlesAuthorization;
use Heritage\Auth\Access\Response;
use Heritage\Container\Container;
use Heritage\Tests\Auth\Fixtures\AbilitiesEnum;
...
class AuthAccessGateTest extends TestCase
{
    ...
    {
        unset($_SERVER['__ugarit.testBefore']);
        ...
        $this->assertTrue($_SERVER['__ugarit.testBefore']);
    ...
    {
        $_SERVER['__ugarit.testBefore'] = false;
        ...
        $this->assertTrue($gate->check('edit', new AccessGateTestDummy));
        $this->assertFalse($gate->check('update', new AccessGateTestDummy));
        $this->assertFalse($_SERVER['__ugarit.testBefore']);
    ...
    {
        $_SERVER['__ugarit.gateBefore'] = false;
        $_SERVER['__ugarit.gateBefore2'] = false;
        $_SERVER['__ugarit.gateAfter'] = false;
        $_SERVER['__ugarit.gateAfter2'] = false;
        ...
        $gate->before(function (?stdClass $user) {
            $_SERVER['__ugarit.gateBefore'] = true;
        });

        $gate->after(function (?stdClass $user) {
            $_SERVER['__ugarit.gateAfter'] = true;
        });

        $gate->before(function (stdClass $user) {
            $_SERVER['__ugarit.gateBefore2'] = true;
        });

        $gate->after(function (stdClass $user) {
            $_SERVER['__ugarit.gateAfter2'] = true;
        });
        ...
        $this->assertTrue($_SERVER['__ugarit.gateBefore']);
        $this->assertFalse($_SERVER['__ugarit.gateBefore2']);
        $this->assertTrue($_SERVER['__ugarit.gateAfter']);
        $this->assertFalse($_SERVER['__ugarit.gateAfter2']);

        unset(
            $_SERVER['__ugarit.gateBefore'],
            $_SERVER['__ugarit.gateBefore2'],
            $_SERVER['__ugarit.gateAfter'],
            $_SERVER['__ugarit.gateAfter2']
        );
    }
...
class AccessGateTestPolicyThatAllowsGuests
{
    ...
    {
        $_SERVER['__ugarit.testBefore'] = true;
    }
