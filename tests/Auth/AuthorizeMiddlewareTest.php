...
class AuthorizeMiddlewareTest extends TestCase
{
    ...
    public function testItCanGenerateDefinitionViaStaticMethod()
    {
        ...
        $this->assertSame('Heritage\Auth\Middleware\Authorize:ability', $signature);

        $signature = Authorize::using('ability', 'model');
        $this->assertSame('Heritage\Auth\Middleware\Authorize:ability,model', $signature);

        $signature = Authorize::using('ability', 'model', \App\Models\Comment::class);
        $this->assertSame('Heritage\Auth\Middleware\Authorize:ability,model,App\Models\Comment', $signature);
    }
