...
namespace Heritage\Tests\Image;
...
use Heritage\Image\ImageException;
use Heritage\Image\ImageManager;
use Heritage\Image\ImageOutputOptions;
use Heritage\Image\ImagePipeline;
use Heritage\Image\Transformations\Blur;
use Heritage\Image\Transformations\Contain;
use Heritage\Image\Transformations\Cover;
use Heritage\Image\Transformations\Crop;
use Heritage\Image\Transformations\FlipHorizontally;
use Heritage\Image\Transformations\FlipVertically;
use Heritage\Image\Transformations\Grayscale;
use Heritage\Image\Transformations\Orient;
use Heritage\Image\Transformations\Resize;
use Heritage\Image\Transformations\Rotate;
use Heritage\Image\Transformations\Scale;
use Heritage\Image\Transformations\Sharpen;
...
class ImageTest extends TestCase
{
    ...
    public function test_implements_responsable()
    {
        ...
        $this->assertInstanceOf(\Heritage\Contracts\Support\Responsable::class, $image);
    }
    ...
    public function test_to_response_returns_response_with_image_bytes()
    {
        ...
        $response = $image->toResponse(new \Heritage\Http\Request);

        $this->assertInstanceOf(\Heritage\Http\Response::class, $response);
