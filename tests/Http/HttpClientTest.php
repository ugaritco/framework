...
use Heritage\Http\Client\BatchInProgressException;
use Heritage\Http\Client\ConnectionException;
use Heritage\Http\Client\Events\RequestSending;
use Heritage\Http\Client\Events\ResponseReceived;
...
use Heritage\Http\Client\ResponseSequence;
...
{
    /**
     * @var \Heritage\Http\Client\Factory
     */
    protected $factory;
    ...
    public function testStubbedResponsesAreReturnedAfterFaking()
    {
        ...
        $response = $this->factory->post('http://ugarit.com/test-missing-page');
    ...
    {
        $this->factory->fake([
            'vapor.ugarit.com' => $this->factory::response('', HttpResponse::HTTP_CREATED),
            'forge.ugarit.com' => $this->factory::response('', HttpResponse::HTTP_OK),
        ]);

        $response = $this->factory->post('http://vapor.ugarit.com');
        $this->assertTrue($response->created());

        $response = $this->factory->post('http://forge.ugarit.com');
    ...
    public function testFakeResponseHeaderValuesAreSerialized()
    {
        $response = $this->factory::response('OK', 200, [
            ...
            'X-False' => false,
            'X-Empty' => [],
            'X-Ugarit-Stringable' => new Stringable('ugarit stringable'),
        ...
        $this->assertSame(['ugarit stringable'], $response->getHeader('X-Ugarit-Stringable'));
    ...
    {
        $this->expectExceptionObject(new InvalidArgumentException('HTTP fake response header values must be scalar, null, Ugarit Stringable, or arrays of scalar, null, or Ugarit Stringable values.'));
    ...
    {
        $this->factory->fake([
            'forge.ugarit.com' => 204,
            'vapor.ugarit.com' => HttpResponse::HTTP_CREATED,
        ]);
    ...
    {
        $this->factory->fake([
            'vapor.ugarit.com' => $this->factory::response('', HttpResponse::HTTP_ACCEPTED),
            'forge.ugarit.com' => $this->factory::response('', HttpResponse::HTTP_OK),
        ]);
    ...
    {
        $this->factory->fake([
            'vapor.ugarit.com' => $this->factory::response('', HttpResponse::HTTP_MOVED_PERMANENTLY),
            'forge.ugarit.com' => $this->factory::response('', HttpResponse::HTTP_OK),
        ]);
    ...
    {
        $this->factory->fake([
            'vapor.ugarit.com' => $this->factory::response('', HttpResponse::HTTP_NO_CONTENT),
            'forge.ugarit.com' => $this->factory::response('', HttpResponse::HTTP_OK),
        ]);
    ...
    {
        $this->factory->fake([
            'vapor.ugarit.com' => $this->factory::response('', HttpResponse::HTTP_FOUND),
            'forge.ugarit.com' => $this->factory::response('', HttpResponse::HTTP_OK),
        ]);
    ...
    {
        $this->factory->fake([
            'vapor.ugarit.com' => $this->factory::response('', HttpResponse::HTTP_NOT_MODIFIED),
            'forge.ugarit.com' => $this->factory::response('', HttpResponse::HTTP_OK),
        ]);

        $response = $this->factory->post('https://vapor.ugarit.com');
        $this->assertTrue($response->notModified());

        $response = $this->factory->post('https://forge.ugarit.com');
    ...
    {
        $this->factory->fake([
            'vapor.ugarit.com' => $this->factory::response('', HttpResponse::HTTP_BAD_REQUEST),
            'forge.ugarit.com' => $this->factory::response('', HttpResponse::HTTP_OK),
        ]);
    ...
    {
        $this->factory->fake([
            'vapor.ugarit.com' => $this->factory::response('', HttpResponse::HTTP_PAYMENT_REQUIRED),
            'forge.ugarit.com' => $this->factory::response('', HttpResponse::HTTP_OK),
        ]);
    ...
    {
        $this->factory->fake([
            'vapor.ugarit.com' => $this->factory::response('', HttpResponse::HTTP_REQUEST_TIMEOUT),
            'forge.ugarit.com' => $this->factory::response('', HttpResponse::HTTP_OK),
        ]);
    ...
    {
        $this->factory->fake([
            'vapor.ugarit.com' => $this->factory::response('', HttpResponse::HTTP_CONFLICT),
            'forge.ugarit.com' => $this->factory::response('', HttpResponse::HTTP_OK),
        ]);
    ...
    {
        $this->factory->fake([
            'vapor.ugarit.com' => $this->factory::response('', HttpResponse::HTTP_UNPROCESSABLE_ENTITY),
            'forge.ugarit.com' => $this->factory::response('', HttpResponse::HTTP_OK),
        ]);
    ...
    {
        $this->factory->fake([
            'vapor.ugarit.com' => $this->factory::response('', HttpResponse::HTTP_TOO_MANY_REQUESTS),
            'forge.ugarit.com' => $this->factory::response('', HttpResponse::HTTP_OK),
        ]);
    ...
    {
        $this->factory->fake([
            'ugarit.com' => $this->factory::response('', 401),
        ]);

        $response = $this->factory->post('http://ugarit.com');
    ...
    {
        $this->factory->fake([
            'ugarit.com' => $this->factory::response('', 403),
        ]);
    ...
    {
        $this->factory->fake([
            'ugarit.com' => $this->factory::response('', 404),
        ]);
    ...
    public function testQueryParametersNormalizeNonFiniteFloats()
    {
        ...
        $this->factory->get('https://ugarit.com/search', [
            'nan' => NAN,
            'inf' => INF,
            'negative_inf' => -INF,
            'nested' => ['value' => NAN],
        ...
        $this->factory->assertSent(function (Request $request) {
            return $request->url() === 'https://ugarit.com/search?nan=NAN&inf=INF&negative_inf=-INF&nested%5Bvalue%5D=NAN';
        });
    }
    ...
    public function testHeaderValuesAreSerialized()
    {
        ...
        $this->factory->assertSent(function (Request $request) {
            return $request->hasHeader('X-Int', '123')
                ...
                && $request->hasHeader('X-Ugarit-Stringable', 'ugarit stringable')
    ...
    public function testInvalidHeaderValuesAreRejected($value)
    {
        ...
        $this->expectExceptionObject(new InvalidArgumentException('HTTP header values must be scalar, null, Ugarit Stringable, or arrays of scalar, null, or Ugarit Stringable values.'));
    ...
    public function testMultipartHeaderValuesAreSerialized()
    {
        ...
        $this->factory->assertSent(function (Request $request) {
            return $request[0]['headers']['X-Part'] === '123'
                ...
                && $request[0]['headers']['X-Ugarit-Stringable'] === 'ugarit stringable';
        });
    }
    ...
    public function testInvalidMultipartHeaderValuesAreRejected($value)
    {
        ...
        $this->expectExceptionObject(new InvalidArgumentException('Multipart header values must be scalar, null, or Ugarit Stringable.'));
    ...
    public function testItCanSendUserAgent()
    {
        ...
        $this->factory->withUserAgent('Ugarit')->post('http://foo.com/json');

        $this->factory->assertSent(function (Request $request) {
            return $request->url() === 'http://foo.com/json' &&
                $request->hasHeader('User-Agent', 'Ugarit');
        });
    }
    ...
    public function testItOnlySendsOneUserAgentHeader()
    {
        ...
        $this->factory->withUserAgent('Ugarit')
    ...
    public function testSequenceBuilderCanKeepGoingWhenEmpty()
    {
        ...
        $response = $this->factory->get('https://ugarit.com');
        $this->assertSame('Ok', $response->body());

        // The sequence is empty, but it should not fail.
        $this->factory->get('https://ugarit.com');
    }
    ...
    public function testWithCookies()
    {
        ...
        $this->assertSame('https://ugarit.com', $responseCookie['Domain']);
    }
    ...
    public function testWithQueryParameters()
    {
        ...
        $this->factory->assertSent(function (Request $request) {
            return $request->url() === 'https://ugarit.com?foo=bar';
        });
    }
    ...
    public function testWithArrayQueryParameters()
    {
        ...
        $this->factory->assertSent(function (Request $request) {
            return $request->url() === 'https://ugarit.com?foo%5B0%5D=bar&foo%5B1%5D=baz';
        });
    }
    ...
    public function testWithQueryParametersAllowsAddingMoreOnRequest()
    {
        ...
        $this->factory->assertSent(function (Request $request) {
            return $request->url() === 'https://ugarit.com?foo=bar&baz=qux';
        });
    }
    ...
    public function testGetWithArrayQueryParamEncodes()
    {
        ...
        $this->factory->get('http://foo.com/get', ['foo;bar; space test' => 'ugarit']);

        $this->factory->assertSent(function (Request $request) {
            return $request->url() === 'http://foo.com/get?foo%3Bbar%3B%20space%20test=ugarit'
                && $request['foo;bar; space test'] === 'ugarit';
        });
    }
    ...
    public function testOnErrorDoesntCallClosureOnInformational()
    {
        ...
        $client = $this->factory->fake([
            'ugarit.com' => $this->factory::response('', 101),
        ]);

        $response = $client->get('ugarit.com')
    ...
    public function testOnErrorDoesntCallClosureOnSuccess()
    {
        $status = 0;
        $client = $this->factory->fake([
            'ugarit.com' => $this->factory::response('', 201),
        ]);
    ...
    public function testOnErrorDoesntCallClosureOnRedirection()
    {
        $status = 0;
        $client = $this->factory->fake([
            'ugarit.com' => $this->factory::response('', 301),
        ]);
    ...
    public function testOnErrorCallsClosureOnServerError()
    {
        $status = 0;
        $client = $this->factory->fake([
            'ugarit.com' => $this->factory::response('', 501),
        ]);
    ...
    public function testGlobalConfigurationCanBeDisabledForRequestsCreatedWithinCallback()
    {
        ...
        $request->get('http://ugarit.com/agent');

        $this->factory->createPendingRequest()->get('http://ugarit.com/global');

        $this->assertArrayNotHasKey('force_ip_resolve', $request->getOptions());
        $this->factory->assertSent(fn (Request $request) => $request->url() === 'http://ugarit.com/agent' && ! $request->hasHeader('X-Global'));
        $this->factory->assertSent(fn (Request $request) => $request->url() === 'http://ugarit.com/global' && $request->hasHeader('X-Global'));
    }
    ...
    public function testMiddlewareRunsInPool()
    {
        ...
        $responses = $this->factory->pool(fn (Pool $pool) => [
            $pool->withMiddleware($middleware)->post('https://example.com', ['hyped-for' => 'ugarit-movie']),
        ]);
        ...
        $this->assertSame(['hyped-for' => 'ugarit-movie'], json_decode(tap($history[0]['request']->getBody())->rewind()->getContents(), true));
    }
    ...
    public function testMiddlewareRunsWhenFaked()
    {
        ...
        $response = $pendingRequest->post('https://example.com', ['hyped-for' => 'ugarit-movie']);
    ...
    public function testMiddlewareRunsAndCanChangeRequestOnAssertSent()
    {
        ...
        $pendingRequest->post('https://ugarit.example', ['ugarit' => 'framework']);

        $this->factory->assertSent(function (Request $request) {
            return
                $request->url() === 'https://ugarit.example' &&
    ...
    public function testSslCertificateErrorsConvertedToConnectionException()
    {
        $this->factory->fake(function () {
            $request = new GuzzleRequest('HEAD', 'https://ssl-error.ugarit.example');
        ...
        $this->factory->head('https://ssl-error.ugarit.example');
    }
    ...
    public function testConnectExceptionIsConvertedToConnectionExceptionEvenWhenWithoutFactory()
    {
        ...
        $pendingRequest->setHandler(function () {
            throw new ConnectException(
                'cURL error 60: SSL certificate problem: unable to get local issuer certificate',
                new GuzzleRequest('HEAD', 'https://ssl-error.ugarit.example')
            );
        });

        $pendingRequest->head('https://ssl-error.ugarit.example');
    }
    ...
    public function testRequestExceptionWithoutResponseIsConvertedToConnectionExceptionEvenWhenWithoutFactory()
    {
        ...
        $pendingRequest->setHandler(function () {
            throw new GuzzleRequestException(
                ...
                new GuzzleRequest('GET', 'https://timeout-ugarit.example')
            );
        });

        $pendingRequest->get('https://timeout-ugarit.example');
    }
    ...
    public function testRequestExceptionWithResponseIsConvertedToConnectionExceptionEvenWhenWithoutFactory()
    {
        ...
        $pendingRequest->setHandler(function () {
            ...
            $request = new GuzzleRequest('GET', 'https://timeout-ugarit.example');
    ...
    public function testTooManyRedirectsExceptionIsConvertedToConnectionExceptionEvenWhenWithoutFactory()
    {
        ...
        $pendingRequest->setHandler(function () {
            throw new TooManyRedirectsException(
                ...
                new GuzzleRequest('GET', 'https://redirect.ugarit.example'),
                new Psr7Response(301)
            );
        });

        $pendingRequest->maxRedirects(5)->get('https://redirect.ugarit.example');
    }

    public function testTooManyRedirectsExceptionConvertedToConnectionException()
    {
        $this->factory->fake(function () {
            $request = new GuzzleRequest('GET', 'https://redirect.ugarit.example');
            $response = new Psr7Response(301, ['Location' => 'https://redirect2.ugarit.example']);
        ...
        $this->factory->maxRedirects(5)->get('https://redirect.ugarit.example');
    }
    ...
    public function testItCanEnforceFaking()
    {
        ...
        $this->factory->fake(['https://vapor.ugarit.com' => Factory::response('ok', 200)]);
        $this->factory->fake(['https://forge.ugarit.com' => Factory::response('ok', 200)]);

        $responses = [];
        $responses[] = $this->factory->get('https://vapor.ugarit.com')->body();
        $responses[] = $this->factory->get('https://forge.ugarit.com')->body();
        $this->assertSame(['ok', 'ok'], $responses);

        $this->expectExceptionObject(new StrayRequestException('https://ugarit.com'));
    ...
    public function testItCanEnforceFakingInThePool()
    {
        ...
        $responses = $this->factory->pool(function (Pool $pool) {
            return [
                $pool->get('https://vapor.ugarit.com'),
                $pool->get('https://forge.ugarit.com'),
            ];
        });
        ...
        [$exception] = $this->factory->pool(function (Pool $pool) {
            return [
                $pool->get('https://ugarit.com'),
            ];
        });

        $this->assertInstanceOf(StrayRequestException::class, $exception);
        $this->assertSame('Attempted request to [https://ugarit.com] without a matching fake.', $exception->getMessage());
    }
    ...
    public function testItCanSubstituteUrlParams(): void
    {
        ...
        $this->factory->assertSent(function (Request $request) {
            return $request->url() === 'https://ugarit.com/docs/9.x/validation';
        });
    }
    ...
    public function testItCanAddGlobalMiddleware()
    {
        ...
        $this->factory->globalMiddleware(Middleware::mapRequest(function ($request) {
            ...
            return $request->withHeader('User-Agent', 'Ugarit Framework/1.0')
        ...
        $responses[] = $this->factory->post('http://forge.ugarit.com');
        $responses[] = $this->factory->withHeader('shared', 'local')->post('http://vapor.ugarit.com');

        $this->assertCount(2, $requests);
        $this->assertCount(2, $responses);

        $this->assertSame(['Ugarit Framework/1.0'], $requests[0]->header('User-Agent'));
        ...
        $this->assertSame(['Ugarit Framework/1.0'], $requests[1]->header('User-Agent'));
    ...
    public function testItCanAddGlobalRequestMiddleware()
    {
        ...
        $this->factory->post('http://forge.ugarit.com');
        $this->factory->post('http://ugarit.com');
    ...
    public function testItCanAddGlobalResponseMiddleware()
    {
        ...
        $responses[] = $this->factory->post('http://forge.ugarit.com');
        $responses[] = $this->factory->post('http://ugarit.com');
    ...
    public function testItReturnsResponse(): void
    {
        ...
        $response = $this->factory->get('http://ugarit.com');
    ...
    public function testItCanReturnCustomResponseClass(): void
    {
        ...
        $response = $factory->get('http://ugarit.fake');
    ...
    public function testNetworkExceptionIsConvertedToConnectionException()
    {
        ...
        $pendingRequest->setHandler(function () {
            throw new NetworkException(
                'Network error',
                new GuzzleRequest('GET', 'https://network-error.ugarit.example')
            );
        });

        $pendingRequest->get('https://network-error.ugarit.example');
    }
    ...
    public function testUrlsWithoutTemplateExpressionsAreNotExpanded()
    {
        ...
        $this->factory->withUrlParameters(['page' => 'docs'])->get('https://ugarit.com/docs');

        $this->factory->assertSent(function (Request $request) {
            return $request->url() === 'https://ugarit.com/docs';
        });
    }
