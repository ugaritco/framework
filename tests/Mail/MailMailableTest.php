...
class MailMailableTest extends TestCase
{
    public function testMailableSetsRecipientsCorrectly(): void
    {
        ...
        $mailable->to('taylor@ugarit.com');
        $this->assertEquals([['name' => null, 'address' => 'taylor@ugarit.com']], $mailable->to);
        $this->assertTrue($mailable->hasTo('taylor@ugarit.com'));
        $mailable->assertHasTo('taylor@ugarit.com');
        $mailable->to('taylor@ugarit.com', 'Taylor Otwell');
        ...
        $mailable->assertHasTo('taylor@ugarit.com', 'Taylor Otwell');

        $mailable = new WelcomeMailableStub;
        $mailable->to('taylor@ugarit.com', 'Taylor Otwell');
        $this->assertEquals([['name' => 'Taylor Otwell', 'address' => 'taylor@ugarit.com']], $mailable->to);
        $this->assertTrue($mailable->hasTo('taylor@ugarit.com', 'Taylor Otwell'));
        $this->assertTrue($mailable->hasTo('taylor@ugarit.com'));
        $mailable->assertHasTo('taylor@ugarit.com', 'Taylor Otwell');
        $mailable->assertHasTo('taylor@ugarit.com');
        ...
        $this->assertEquals([['name' => null, 'address' => 'taylor@ugarit.com']], $mailable->to);
        $this->assertTrue($mailable->hasTo('taylor@ugarit.com'));
        $this->assertFalse($mailable->hasTo('taylor@ugarit.com', 'Taylor Otwell'));
        $mailable->assertHasTo('taylor@ugarit.com');
        try {
            $mailable->assertHasTo('taylor@ugarit.com', 'Taylor Otwell');
            $this->fail();
        } catch (AssertionFailedError $e) {
            $this->assertSame("Did not see expected recipient in email 'to' recipients.\nExpected: [taylor@ugarit.com (Taylor Otwell)]\nActual: [taylor@ugarit.com]\nFailed asserting that false is true.", $e->getMessage());
        }

        $mailable = new WelcomeMailableStub;
        $mailable->to([['name' => 'Taylor Otwell', 'email' => 'taylor@ugarit.com']]);
        $this->assertEquals([['name' => 'Taylor Otwell', 'address' => 'taylor@ugarit.com']], $mailable->to);
        $this->assertTrue($mailable->hasTo('taylor@ugarit.com', 'Taylor Otwell'));
        $this->assertTrue($mailable->hasTo('taylor@ugarit.com'));
        $mailable->assertHasTo('taylor@ugarit.com');
        ...
        $this->assertEquals([
            ['name' => 'Taylor Otwell', 'address' => 'taylor@ugarit.com'],
            ['name' => 'Ugarit Framework', 'address' => 'contact@ugarit.com'],
        ], $mailable->to);
        $this->assertTrue($mailable->hasTo(new MailableTestUserStub));
        $this->assertTrue($mailable->hasTo('taylor@ugarit.com'));
        $mailable->assertHasTo('taylor@ugarit.com');
    ...
    public function testMailableSetsCcRecipientsCorrectly(): void
    {
        ...
        $mailable = new WelcomeMailableStub;
        $mailable->cc('taylor@ugarit.com');
        $this->assertEquals([['name' => null, 'address' => 'taylor@ugarit.com']], $mailable->cc);
        $this->assertTrue($mailable->hasCc('taylor@ugarit.com'));
        $mailable->assertHasCc('taylor@ugarit.com');

        $mailable = new WelcomeMailableStub;
        $mailable->cc('taylor@ugarit.com', 'Taylor Otwell');
        $this->assertEquals([['name' => 'Taylor Otwell', 'address' => 'taylor@ugarit.com']], $mailable->cc);
        $this->assertTrue($mailable->hasCc('taylor@ugarit.com', 'Taylor Otwell'));
        $this->assertTrue($mailable->hasCc('taylor@ugarit.com'));
        $mailable->assertHasCc('taylor@ugarit.com', 'Taylor Otwell');
        $mailable->assertHasCc('taylor@ugarit.com');
        ...
        $this->assertEquals([['name' => null, 'address' => 'taylor@ugarit.com']], $mailable->cc);
        $this->assertTrue($mailable->hasCc('taylor@ugarit.com'));
        $this->assertFalse($mailable->hasCc('taylor@ugarit.com', 'Taylor Otwell'));
        $mailable->assertHasCc('taylor@ugarit.com');
        try {
            $mailable->assertHasCc('taylor@ugarit.com', 'Taylor Otwell');
            $this->fail();
        ...
        $mailable = new WelcomeMailableStub;
        $mailable->cc([['name' => 'Taylor Otwell', 'email' => 'taylor@ugarit.com']]);
        $this->assertEquals([['name' => 'Taylor Otwell', 'address' => 'taylor@ugarit.com']], $mailable->cc);
        $this->assertTrue($mailable->hasCc('taylor@ugarit.com', 'Taylor Otwell'));
        $this->assertTrue($mailable->hasCc('taylor@ugarit.com'));
        $mailable->assertHasCc('taylor@ugarit.com', 'Taylor Otwell');
        ...
        $mailable = new WelcomeMailableStub;
        $mailable->cc(['taylor@ugarit.com', 'not-taylor@ugarit.com']);
        $this->assertEquals([
            ['name' => null, 'address' => 'taylor@ugarit.com'],
            ['name' => null, 'address' => 'not-taylor@ugarit.com'],
        ], $mailable->cc);
        $this->assertTrue($mailable->hasCc('taylor@ugarit.com'));
        $this->assertTrue($mailable->hasCc('not-taylor@ugarit.com'));
        $mailable->assertHasCc('taylor@ugarit.com');
        $mailable->assertHasCc('not-taylor@ugarit.com');
    ...
    public function testMailableSetsBccRecipientsCorrectly(): void
    {
        ...
        $mailable = new WelcomeMailableStub;
        $mailable->bcc('taylor@ugarit.com');
        $this->assertEquals([['name' => null, 'address' => 'taylor@ugarit.com']], $mailable->bcc);
        $this->assertTrue($mailable->hasBcc('taylor@ugarit.com'));
        $mailable->assertHasBcc('taylor@ugarit.com');

        $mailable = new WelcomeMailableStub;
        $mailable->bcc('taylor@ugarit.com', 'Taylor Otwell');
        $this->assertEquals([['name' => 'Taylor Otwell', 'address' => 'taylor@ugarit.com']], $mailable->bcc);
        $this->assertTrue($mailable->hasBcc('taylor@ugarit.com', 'Taylor Otwell'));
        $this->assertTrue($mailable->hasBcc('taylor@ugarit.com'));
        $mailable->assertHasBcc('taylor@ugarit.com', 'Taylor Otwell');
        $mailable->assertHasBcc('taylor@ugarit.com');
        ...
        $this->assertEquals([['name' => null, 'address' => 'taylor@ugarit.com']], $mailable->bcc);
        $this->assertTrue($mailable->hasBcc('taylor@ugarit.com'));
        $this->assertFalse($mailable->hasBcc('taylor@ugarit.com', 'Taylor Otwell'));
        $mailable->assertHasBcc('taylor@ugarit.com');
        try {
            $mailable->assertHasBcc('taylor@ugarit.com', 'Taylor Otwell');
            $this->fail();
        ...
        $mailable = new WelcomeMailableStub;
        $mailable->bcc([['name' => 'Taylor Otwell', 'email' => 'taylor@ugarit.com']]);
        $this->assertEquals([['name' => 'Taylor Otwell', 'address' => 'taylor@ugarit.com']], $mailable->bcc);
        $this->assertTrue($mailable->hasBcc('taylor@ugarit.com', 'Taylor Otwell'));
        $this->assertTrue($mailable->hasBcc('taylor@ugarit.com'));
        $mailable->assertHasBcc('taylor@ugarit.com', 'Taylor Otwell');
        ...
        $mailable = new WelcomeMailableStub;
        $mailable->bcc(['taylor@ugarit.com', 'not-taylor@ugarit.com']);
        $this->assertEquals([
            ['name' => null, 'address' => 'taylor@ugarit.com'],
            ['name' => null, 'address' => 'not-taylor@ugarit.com'],
        ], $mailable->bcc);
        $this->assertTrue($mailable->hasBcc('taylor@ugarit.com'));
        $this->assertTrue($mailable->hasBcc('not-taylor@ugarit.com'));
        $mailable->assertHasBcc('taylor@ugarit.com');
        $mailable->assertHasBcc('not-taylor@ugarit.com');
    ...
    public function testMailableSetsReplyToCorrectly(): void
    {
        ...
        $mailable = new WelcomeMailableStub;
        $mailable->replyTo('taylor@ugarit.com');
        $this->assertEquals([['name' => null, 'address' => 'taylor@ugarit.com']], $mailable->replyTo);
        $this->assertTrue($mailable->hasReplyTo('taylor@ugarit.com'));
        $mailable->assertHasReplyTo('taylor@ugarit.com');

        $mailable = new WelcomeMailableStub;
        $mailable->replyTo('taylor@ugarit.com', 'Taylor Otwell');
        $this->assertEquals([['name' => 'Taylor Otwell', 'address' => 'taylor@ugarit.com']], $mailable->replyTo);
        $this->assertTrue($mailable->hasReplyTo('taylor@ugarit.com', 'Taylor Otwell'));
        $this->assertTrue($mailable->hasReplyTo('taylor@ugarit.com'));
        $mailable->assertHasReplyTo('taylor@ugarit.com', 'Taylor Otwell');
        $mailable->assertHasReplyTo('taylor@ugarit.com');
        ...
        $this->assertEquals([['name' => null, 'address' => 'taylor@ugarit.com']], $mailable->replyTo);
        $this->assertTrue($mailable->hasReplyTo('taylor@ugarit.com'));
        $this->assertFalse($mailable->hasReplyTo('taylor@ugarit.com', 'Taylor Otwell'));
        $mailable->assertHasReplyTo('taylor@ugarit.com');
        try {
            $mailable->assertHasReplyTo('taylor@ugarit.com', 'Taylor Otwell');
            $this->fail();
        ...
        $mailable = new WelcomeMailableStub;
        $mailable->replyTo([['name' => 'Taylor Otwell', 'email' => 'taylor@ugarit.com']]);
        $this->assertEquals([['name' => 'Taylor Otwell', 'address' => 'taylor@ugarit.com']], $mailable->replyTo);
        $this->assertTrue($mailable->hasReplyTo('taylor@ugarit.com', 'Taylor Otwell'));
        $this->assertTrue($mailable->hasReplyTo('taylor@ugarit.com'));
        $mailable->assertHasReplyTo('taylor@ugarit.com');
    ...
    public function testMailableSetsFromCorrectly(): void
    {
        ...
        $mailable = new WelcomeMailableStub;
        $mailable->from('taylor@ugarit.com');
        $this->assertEquals([['name' => null, 'address' => 'taylor@ugarit.com']], $mailable->from);
        $this->assertTrue($mailable->hasFrom('taylor@ugarit.com'));
        $mailable->assertFrom('taylor@ugarit.com');

        $mailable = new WelcomeMailableStub;
        $mailable->from('taylor@ugarit.com', 'Taylor Otwell');
        $this->assertEquals([['name' => 'Taylor Otwell', 'address' => 'taylor@ugarit.com']], $mailable->from);
        $this->assertTrue($mailable->hasFrom('taylor@ugarit.com', 'Taylor Otwell'));
        $this->assertTrue($mailable->hasFrom('taylor@ugarit.com'));
        $mailable->assertFrom('taylor@ugarit.com', 'Taylor Otwell');
        $mailable->assertFrom('taylor@ugarit.com');
        ...
        $this->assertEquals([['name' => null, 'address' => 'taylor@ugarit.com']], $mailable->from);
        $this->assertTrue($mailable->hasFrom('taylor@ugarit.com'));
        $this->assertFalse($mailable->hasFrom('taylor@ugarit.com', 'Taylor Otwell'));
        $mailable->assertFrom('taylor@ugarit.com');
        try {
            $mailable->assertFrom('taylor@ugarit.com', 'Taylor Otwell');
            $this->fail();
        ...
        $mailable = new WelcomeMailableStub;
        $mailable->from([['name' => 'Taylor Otwell', 'email' => 'taylor@ugarit.com']]);
        $this->assertEquals([['name' => 'Taylor Otwell', 'address' => 'taylor@ugarit.com']], $mailable->from);
        $this->assertTrue($mailable->hasFrom('taylor@ugarit.com', 'Taylor Otwell'));
        $this->assertTrue($mailable->hasFrom('taylor@ugarit.com'));
        $mailable->assertFrom('taylor@ugarit.com', 'Taylor Otwell');
    ...
    public function testMailableBuildsViewData(): void
    {
        ...
        $expected = [
            ...
            'lastName' => 'Otwell',
            'framework' => 'Ugarit',
            '__ugarit_mailable' => get_class($mailable),
        ];
    ...
    public function testMailablePriorityGetsSent(): void
    {
        ...
        $this->assertSame('hello@ugarit.com', $sentMessage->getEnvelope()->getRecipients()[0]->getAddress());
    ...
    public function testMailableAttributesInBuild(): void
    {
        ...
        $mailable = new class() extends Mailable
        {
            public function build()
            {
                $this
                    ->to('hello@ugarit.com')
                    ->replyTo('taylor@ugarit.com')
                    ->cc('cc@ugarit.com', 'Taylor Otwell')
                    ->bcc('bcc@ugarit.com', 'Taylor Otwell')
                    ->tag('test-tag')
        ...
        $mailable->assertTo('hello@ugarit.com');
        $mailable->assertHasReplyTo('taylor@ugarit.com');
        $mailable->assertHasCc('cc@ugarit.com', 'Taylor Otwell');
        $mailable->assertHasBcc('bcc@ugarit.com', 'Taylor Otwell');
    ...
    public function testMailablesCanBeTapped(): void
    {
        ...
        $mail->tap(fn ($mailable) => $mailable->to('taylor@ugarit.com', 'Taylor Otwell'));
        $mail->tap(fn ($mailable) => $mailable->subject('Test Subject!'));

        $mail->tap(function ($mailable) {
            $mailable->assertTo('taylor@ugarit.com')
...
class MailableTestUserStub
{
    ...
    public $email = 'taylor@ugarit.com';
}

class MailableTestUserStub2
{
    public $name = 'Ugarit Framework';
    public $email = 'contact@ugarit.com';
}
