...
use Heritage\Cache\FileStore;
use Heritage\Cache\Lock;
use Heritage\Cache\MemcachedStore;
use Heritage\Cache\RedisStore;
use Heritage\Cache\Repository;
use Heritage\Cache\TaggableStore;
use Heritage\Cache\TaggedCache;
