...
class DatabaseEloquentBuilderTest extends TestCase
{
    ...
    {
        $this->expectExceptionObject(new BadMethodCallException('Call to undefined method Heritage\Database\Eloquent\Builder::missingMacro()'));
    ...
    public function testWithMinOnSelfRelated()
    {
        ...
        $aliasRegex = '/\b(ugarit_reserved_\d)(\b|$)/i';
