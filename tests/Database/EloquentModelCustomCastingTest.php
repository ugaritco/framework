...
use Heritage\Contracts\Database\Eloquent\ComparesCastableAttributes;
use Heritage\Contracts\Database\Eloquent\SerializesCastableAttributes;
...
class EloquentModelCustomCastingTest extends TestCase
{
    ...
    {
        /** @var \Heritage\Tests\Integration\Database\CustomCasts $model */
        ...
        /** @var \Heritage\Tests\Integration\Database\CustomCasts $another_model */
...
class AddressCast implements CastsAttributes
{
     ...
     * @return \Heritage\Tests\Integration\Database\AddressModel
     */
