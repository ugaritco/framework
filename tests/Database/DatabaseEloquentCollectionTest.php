...
class DatabaseEloquentCollectionTest extends TestCase
{
    ...
    public function testFindOrFailFindsManyModelsById()
    {
        ...
        $this->expectExceptionObject(new ModelNotFoundException('No query results for model [Heritage\Tests\Database\TestEloquentCollectionModel] 3'));
    ...
    public function testFindOrFailThrowsExceptionWithMessageWhenOtherModelsArePresent()
    {
        ...
        $this->expectExceptionObject(new ModelNotFoundException('No query results for model [Heritage\Tests\Database\TestEloquentCollectionModel] 2'));
