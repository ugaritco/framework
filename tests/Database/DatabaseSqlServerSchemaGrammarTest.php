...
use Heritage\Database\Schema\Grammars\SqlServerGrammar;
use Heritage\Database\Schema\SqlServerBuilder;
...
class DatabaseSqlServerSchemaGrammarTest extends TestCase
{
    ...
    public function testAddingForeignID()
    {
        ...
        $this->assertSame([
            ...
            'alter table "users" add "ugarit_idea_id" bigint not null',
    ...
    public function testAddingForeignUuid()
    {
        ...
        $this->assertSame([
            ...
            'alter table "users" add constraint "users_company_id_foreign" foreign key ("company_id") references "companies" ("id")',
            'alter table "users" add "ugarit_idea_id" uniqueidentifier not null',
            'alter table "users" add constraint "users_ugarit_idea_id_foreign" foreign key ("ugarit_idea_id") references "ugarit_ideas" ("id")',
