...
use Heritage\Database\Schema\Builder;
use Heritage\Database\Schema\ForeignIdColumnDefinition;
use Heritage\Database\Schema\Grammars\PostgresGrammar;
use Heritage\Database\Schema\PostgresBuilder;
...
class DatabasePostgresSchemaGrammarTest extends TestCase
{
    ...
    public function testAddingForeignID()
    {
        ...
        $this->assertSame([
            ...
            'alter table "users" add column "ugarit_idea_id" bigint not null',
            'alter table "users" add constraint "users_ugarit_idea_id_foreign" foreign key ("ugarit_idea_id") references "ugarit_ideas" ("id")',
    ...
    public function testAddingForeignUuid()
    {
        ...
        $this->assertSame([
            ...
            'alter table "users" add constraint "users_company_id_foreign" foreign key ("company_id") references "companies" ("id")',
            'alter table "users" add column "ugarit_idea_id" uuid not null',
            'alter table "users" add constraint "users_ugarit_idea_id_foreign" foreign key ("ugarit_idea_id") references "ugarit_ideas" ("id")',
