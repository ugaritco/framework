...
use Heritage\Database\Eloquent\Factories\CrossJoinSequence;
...
class DatabaseEloquentFactoryTest extends TestCase
{
    ...
    {
        $app = Mockery::mock(Application::class);
        $app->shouldReceive('getNamespace')->andReturn('Heritage\\Tests\\Database\\Fixtures\\');
        Container::getInstance()->instance(Application::class, $app);

        Factory::useNamespace('Heritage\\Tests\\Database\\Fixtures\\Factories\\');
