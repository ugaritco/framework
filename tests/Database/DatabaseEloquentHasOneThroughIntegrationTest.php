...
class DatabaseEloquentHasOneThroughIntegrationTest extends TestCase
{
    ...
    {
        $this->expectExceptionObject(new ModelNotFoundException('No query results for model [Heritage\Tests\Database\HasOneThroughTestContract].'));
    ...
    public function testChunkReturnsCorrectModels()
    {
        ...
        $position->contract()->chunk(10, function ($contractsChunk) {
            ...
            $this->assertEquals([
                ...
                'created_at',
                'updated_at',
                'ugarit_through_key', ], array_keys($contract->getAttributes()));
        });
    }
    ...
    /**
     * Migrate tables for classes with a Ugarit "default" HasOneThrough setup.
     */
