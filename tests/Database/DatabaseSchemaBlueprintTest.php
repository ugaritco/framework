...
use Heritage\Tests\Database\Fixtures\Models\User;
use Mockery;
...
class DatabaseSchemaBlueprintTest extends TestCase
{
    ...
    public function testGenerateRelationshipColumnWithIncrementalModel()
    {
        $getSql = function ($grammar) {
            return $this->getBlueprint($grammar, 'posts', function ($table) {
                $table->foreignIdFor('Heritage\Foundation\Auth\User');
            })->toSql();
        };
    ...
    public function testGenerateRelationshipConstrainedColumn()
    {
        $getSql = function ($grammar) {
            return $this->getBlueprint($grammar, 'posts', function ($table) {
                $table->foreignIdFor('Heritage\Foundation\Auth\User')->constrained();
            })->toSql();
        };
    ...
    public function testDropRelationshipColumnWithIncrementalModel()
    {
        $getSql = function ($grammar) {
            return $this->getBlueprint($grammar, 'posts', function ($table) {
                $table->dropForeignIdFor('Heritage\Foundation\Auth\User');
            })->toSql();
        };
    ...
    public function testDropConstrainedRelationshipColumnWithIncrementalModel()
    {
        $getSql = function ($grammar) {
            return $this->getBlueprint($grammar, 'posts', function ($table) {
                $table->dropConstrainedForeignIdFor('Heritage\Foundation\Auth\User');
            })->toSql();
        };
    ...
    protected function getConnection(?string $grammar = null, string $prefix = '')
    {
        ...
        $grammar ??= 'MySql';
        $grammarClass = 'Heritage\Database\Schema\Grammars\\'.$grammar.'Grammar';
        $builderClass = 'Heritage\Database\Schema\\'.$grammar.'Builder';
