...
class DatabaseEloquentHasManyThroughIntegrationTest extends TestCase
{
    ...
    {
        $this->expectExceptionObject(new ModelNotFoundException('No query results for model [Heritage\Tests\Database\HasManyThroughTestPost].'));
    ...
    {
        $this->expectExceptionObject(new ModelNotFoundException('No query results for model [Heritage\Tests\Database\HasManyThroughTestPost] 1'));
    ...
    {
        $this->expectExceptionObject(new ModelNotFoundException('No query results for model [Heritage\Tests\Database\HasManyThroughTestPost] 1, 2'));
    ...
    /**
     * Migrate tables for classes with a Ugarit "default" HasManyThrough setup.
     */
