...
class DatabaseEloquentSoftDeletesIntegrationTest extends TestCase
{
    ...
    public function testUpdateModelAfterSoftDeleting()
    {
        ...
        /** @var \Heritage\Tests\Database\SoftDeletesTestUser $userModel */
    ...
    public function testHasOneRelationshipCanBeSoftDeleted()
    {
        ...
        $abigail->address()->create(['address' => 'Ugarit avenue 43']);
        ...
        $this->assertSame('Ugarit avenue 43', $abigail->address()->withTrashed()->first()->address);
        ...
        $this->assertSame('Ugarit avenue 43', $abigail->address->address);
    ...
    {
        // https://github.com/ugarit/framework/issues/42075
     ...
     * Helpers...
     *
     * @return \Heritage\Tests\Database\SoftDeletesTestUser[]
     */
