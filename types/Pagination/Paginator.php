...
assertType('Heritage\Pagination\Paginator<int, Post>', $paginator->fragment('foo'));
...
assertType('Heritage\Pagination\CursorPaginator<int, Post>', $cursorPaginator->fragment('foo'));
...
assertType('Heritage\Pagination\CursorPaginator<int, array{id: int, post: Post}>', $throughPaginator);
