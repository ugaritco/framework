...
assertType('Heritage\Support\Optional', optional());
...
assertType('Heritage\Support\Stringable', str('foo'));

assertType('User', tap(new User(), function ($user) {
    assertType('User', $user);
}));
assertType('Heritage\Support\HigherOrderTapProxy<User>', tap(new User()));
